...
namespace g{struct GlobalPot_UnoUXStringConcatOperator_Right_Property;}
...
struct GlobalPot_UnoUXStringConcatOperator_Right_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Uno::UX::StringConcatOperator*> _obj;

    void ctor_2(::g::Uno::UX::StringConcatOperator* obj, ::g::Uno::UX::Selector name);
    static GlobalPot_UnoUXStringConcatOperator_Right_Property* New1(::g::Uno::UX::StringConcatOperator* obj, ::g::Uno::UX::Selector name);
};
// }
