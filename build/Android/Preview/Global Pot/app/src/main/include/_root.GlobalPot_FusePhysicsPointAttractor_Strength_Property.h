...
namespace g{struct GlobalPot_FusePhysicsPointAttractor_Strength_Property;}
...
struct GlobalPot_FusePhysicsPointAttractor_Strength_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Physics::PointAttractor*> _obj;

    void ctor_2(::g::Fuse::Physics::PointAttractor* obj, ::g::Uno::UX::Selector name);
    static GlobalPot_FusePhysicsPointAttractor_Strength_Property* New1(::g::Fuse::Physics::PointAttractor* obj, ::g::Uno::UX::Selector name);
};
// }
