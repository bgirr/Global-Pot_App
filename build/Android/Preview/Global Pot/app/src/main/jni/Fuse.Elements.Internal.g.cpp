...
// internal sealed class ElementDraw :343
// {
// static ElementDraw() :343
...
// public generated ElementDraw() :343
void ElementDraw__ctor__fn(ElementDraw* __this)
{
    __this->ctor_();
}

// private generated void init_DrawCalls() :343
void ElementDraw__init_DrawCalls_fn(ElementDraw* __this)
{
    __this->init_DrawCalls();
}

// public generated ElementDraw New() :343
void ElementDraw__New1_fn(ElementDraw** __retval)
{
    *__retval = ElementDraw::New1();
}

// public void Rectangle(Fuse.DrawContext dc, Fuse.Elements.Element element, float2 offset, float2 size, float4 color) :347
...
// public generated ElementDraw() [instance] :343
void ElementDraw::ctor_()
{
    init_DrawCalls();
}

// private generated void init_DrawCalls() [instance] :343
void ElementDraw::init_DrawCalls()
{
    ...
    _draw_4071f44d = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseElements_bundle::ElementDraw14d18f42());
}

// public void Rectangle(Fuse.DrawContext dc, Fuse.Elements.Element element, float2 offset, float2 size, float4 color) [instance] :347
...
// public generated ElementDraw New() [static] :343
...
// internal sealed class Scale9Rectangle :368
// {
// static Scale9Rectangle() :368
...
static void Scale9Rectangle_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[2/*ushort[]*/], offsetof(::g::Fuse::Elements::Internal::Scale9Rectangle, Draw_indices_59d4592_1_2_13), 0,
...
// public generated Scale9Rectangle() :368
void Scale9Rectangle__ctor__fn(Scale9Rectangle* __this)
{
    __this->ctor_();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 size, float2 scaleTextureSize, texture2D tex, float4 color, float4 margin) :372
...
// private generated void init_DrawCalls() :368
void Scale9Rectangle__init_DrawCalls_fn(Scale9Rectangle* __this)
{
    __this->init_DrawCalls();
}

// public generated Scale9Rectangle New() :368
...
// public generated Scale9Rectangle() [instance] :368
void Scale9Rectangle::ctor_()
{
    init_DrawCalls();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 size, float2 scaleTextureSize, texture2D tex, float4 color, float4 margin) [instance] :372
...
// private generated void init_DrawCalls() [instance] :368
void Scale9Rectangle::init_DrawCalls()
{
    uStackFrame __("Fuse.Elements.Internal.Scale9Rectangle", "init_DrawCalls()");
    uArray* indices_59d4592_1_2_1 = uArray::Init<int>(::TYPES[2/*ushort[]*/], 54, 0, 4, 5, 0, 5, 1, 1, 5, 6, 1, 6, 2, 2, 6, 7, 2, 7, 3, 4, 8, 9, 4, 9, 5, 5, 9, 10, 5, 10, 6, 6, 10, 11, 6, 11, 7, 8, 12, 13, 8, 13, 9, 9, 13, 14, 9, 14, 10, 10, 14, 15, 10, 15, 11);
...
// public generated Scale9Rectangle New() [static] :368
