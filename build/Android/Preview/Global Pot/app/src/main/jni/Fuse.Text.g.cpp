...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Text\0.42.4\$.uno
// -------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Text\0.42.4\implementation\$.uno
// ----------------------------------------------------------------------------------------------
...
static void FallingBackFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Text\\0.42.4\\$.uno");
...
void FallingBackFont__Shape_fn(FallingBackFont* __this, ::g::Fuse::Text::Substring* text, int* fontIndex, int* dir, uArray** __retval)
{
    ...
    int dir_ = *dir;
    ::g::Uno::Diagnostics::Debug::Assert(fontIndex_ == 0, ::STRINGS[2/*"fontIndex =...*/], ::STRINGS[1/*"C:\\Users\\...*/], 911, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), fontIndex_), uBox<int>(::g::Uno::Int_typeof(), 0)));
...
void FallingBackFont::ctor_1(uArray* fonts)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[0/*"fonts.Lengt...*/], ::STRINGS[1/*"C:\\Users\\...*/], 880, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
    Fonts = fonts;
}
...
void FallingBackFontFace::ctor_1(uArray* fontFaces)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[3/*"fontFaces.L...*/], ::STRINGS[1/*"C:\\Users\\...*/], 848, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
    FontFaces = fontFaces;
}
...
void Font__GetCachedGlyphTexture_fn(Font* __this, ::g::Fuse::Text::Glyph* glyph, ::g::Fuse::Text::GlyphAtlas* atlas, int* currentVersion, ::g::Fuse::Text::GlyphTexture* __retval)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"Error loadi...*/], uBox<uint32_t>(::g::Uno::UInt_typeof(), glyph_.Index)), ::STRINGS[6/*" "*/]), uPtr(e)->Message()), NULL, ::STRINGS[1/*"C:\\Users\\...*/], 1166, ::STRINGS[7/*"GetCachedGl...*/]);
    }
...
::g::Fuse::Text::SubTexture GlyphAtlas::Add(::g::Uno::Content::Images::Bitmap* bitmap)
{
    ...
    assert1 = format == 1;
    assert2 = format == 3;
    ::g::Uno::Diagnostics::Debug::Assert(assert1 || assert2, ::STRINGS[8/*"(format == ...*/], ::STRINGS[1/*"C:\\Users\\...*/], 1223, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox(::g::Uno::Bool_typeof(), assert1), uBox(::g::Uno::Bool_typeof(), assert2)));
...
static void Renderer_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(::g::Fuse::Text::Renderer, _draw_406bb96d), 0,
...
void Renderer::Draw(::g::Uno::Float4 color, ::g::Uno::Float4x4 pixelToClipSpaceMatrix)
{
...

    {
        ...
        for (::g::Uno::Collections::List__Enumerator< ::g::Fuse::Text::Batch> enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(batches), &ret9), ret9); enum2.MoveNext(::TYPES[18/*Uno.Collections.List<Fuse.Text.Batch>.Enumerator*/]); )
        {
            ...
            _draw_406bb96d.BlendEnabled(true);
            _draw_406bb96d.CullFace(0);
            _draw_406bb96d.BlendSrcAlpha(7);
            _draw_406bb96d.BlendDstRgb(3);
            _draw_406bb96d.Const(0, grayScale);
            _draw_406bb96d.Use();
            _draw_406bb96d.Attrib1(1, 2, batch.VertexBuffer, 12, 0);
            _draw_406bb96d.Attrib1(2, 14, batch.VertexBuffer, 12, 8);
            _draw_406bb96d.Uniform12(3, pixelToClipSpaceMatrix);
            _draw_406bb96d.Uniform10(4, color);
            _draw_406bb96d.Sampler3(5, texture, ::g::Uno::Graphics::SamplerState__LinearClamp());
            _draw_406bb96d.Draw(batch.QuadCount * 6, 2, indexBuffer);
        }
    }
}
...
void Renderer::init_DrawCalls()
{
    ...
    _draw_406bb96d = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseText_bundle::Rendererf7d1bb01());
}
...
::g::Fuse::Text::Substring* SubstringExtensions::InclusiveRange(::g::Fuse::Text::Substring* s, int start, int end)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(!assert1, ::STRINGS[16/*"!Fuse.Text....*/], ::STRINGS[1/*"C:\\Users\\...*/], 2278, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 1, uBox(::g::Uno::Bool_typeof(), assert1)));

    if (SubstringExtensions::IsLeadingSurrogate(s->Item(end)))
        ++end;

    ::g::Uno::Diagnostics::Debug::Assert(end < s->Length, ::STRINGS[17/*"end < s.Len...*/], ::STRINGS[1/*"C:\\Users\\...*/], 2281, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), end), uBox<int>(::g::Uno::Int_typeof(), s->Length)));
...
::g::Fuse::Text::SubTexture TextureAtlas::Add(::g::Uno::Content::Images::Bitmap* bitmap)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == _format, ::STRINGS[19/*"bitmap.Form...*/], ::STRINGS[1/*"C:\\Users\\...*/], 2416, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Graphics::Format_typeof(), assert1), uBox<int>(::g::Uno::Graphics::Format_typeof(), _format)));
...
void TextureAtlas::Blit(::g::Uno::Content::Images::Bitmap* dst, ::g::Uno::Content::Images::Bitmap* src, ::g::Uno::Int2 dstPos)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(::g::Uno::Recti__New2(::g::Uno::Int2__New1(0), uPtr(dst)->Size()).Contains1(assert2), ::STRINGS[21/*"(&new Uno.R...*/], ::STRINGS[1/*"C:\\Users\\...*/], 2462, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 1, uBox(::g::Uno::Recti_typeof(), assert2)));
    assert3 = src->Format();
    assert4 = dst->Format();
    ::g::Uno::Diagnostics::Debug::Assert(assert3 == assert4, ::STRINGS[22/*"src.Format ...*/], ::STRINGS[1/*"C:\\Users\\...*/], 2463, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Graphics::Format_typeof(), assert3), uBox<int>(::g::Uno::Graphics::Format_typeof(), assert4)));
