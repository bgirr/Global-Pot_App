...
void SolidRectangle::DrawElement(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* element, ::g::Fuse::Drawing::Brush* brush, float opacity)
{
    ...
    if (uIs(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))
    {
        ...
        ::g::Fuse::Drawing::ImageFill__DrawParams DP_c993343d_14_8_9 = uPtr(uAs< ::g::Fuse::Drawing::ImageFill*>(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))->GetDrawParams(dc, element->ActualSize());
        ...
        _draw_c993343d.Const(0, DP_c993343d_14_8_9.NeedFract);
        _draw_c993343d.Const(1, DP_c993343d_14_8_9.Texture == NULL);
        _draw_c993343d.Use();
        ...
        _draw_c993343d.Uniform2(5, DP_c993343d_14_8_9.Origin);
        _draw_c993343d.Uniform2(6, DP_c993343d_14_8_9.Size);
        _draw_c993343d.Uniform2(7, ::g::Uno::Float2__op_Subtraction2((ind1 = DP_c993343d_14_8_9.UVClip, ::g::Uno::Float2__New2(ind1.Z, ind1.W)), (ind2 = DP_c993343d_14_8_9.UVClip, ::g::Uno::Float2__New2(ind2.X, ind2.Y))));
        _draw_c993343d.Uniform2(8, (ind3 = DP_c993343d_14_8_9.UVClip, ::g::Uno::Float2__New2(ind3.X, ind3.Y)));
        _draw_c993343d.Uniform2(9, DP_c993343d_14_8_9.TexCoordScale1);
        _draw_c993343d.Uniform2(10, DP_c993343d_14_8_9.TexCoordBias1);
        _draw_c993343d.Uniform2(11, DP_c993343d_14_8_9.TexCoordScale2);
        _draw_c993343d.Uniform2(12, DP_c993343d_14_8_9.TexCoordBias2);
        ...
        _draw_c993343d.Sampler3(17, DP_c993343d_14_8_9.Texture, DP_c993343d_14_8_9.SamplerState);
    ...
    else if (uIs(brush, ::TYPES[2/*Fuse.Drawing.SolidColor*/]))
    {
        ...
        _draw_c930343d.BlendSrcRgb(::g::Fuse::Drawing::BlendModeHelpers::GetSrcRgb(uPtr(uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[2/*Fuse.Drawing.SolidColor*/]))->BlendMode()));
        _draw_c930343d.BlendSrcAlpha(::g::Fuse::Drawing::BlendModeHelpers::GetSrcAlpha(uPtr(uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[2/*Fuse.Drawing.SolidColor*/]))->BlendMode()));
        _draw_c930343d.BlendDstRgb(::g::Fuse::Drawing::BlendModeHelpers::GetDstRgb(uPtr(uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[2/*Fuse.Drawing.SolidColor*/]))->BlendMode()));
        _draw_c930343d.BlendDstAlpha(::g::Fuse::Drawing::BlendModeHelpers::GetDstAlpha(uPtr(uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[2/*Fuse.Drawing.SolidColor*/]))->BlendMode()));
        _draw_c930343d.Use();
    ...
    else if (uIs(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))
    {
        ...
        ::g::Uno::Float2 angleSlope_c951343d_14_18_8 = ::g::Uno::Float2__New2(::g::Uno::Math::Cos1(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->Angle()), ::g::Uno::Math::Sin1(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->Angle()));
        ...
        _draw_c951343d.BlendSrcRgb(::g::Fuse::Drawing::BlendModeHelpers::GetSrcRgb(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->BlendMode()));
        _draw_c951343d.BlendSrcAlpha(::g::Fuse::Drawing::BlendModeHelpers::GetSrcAlpha(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->BlendMode()));
        _draw_c951343d.BlendDstRgb(::g::Fuse::Drawing::BlendModeHelpers::GetDstRgb(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->BlendMode()));
        _draw_c951343d.BlendDstAlpha(::g::Fuse::Drawing::BlendModeHelpers::GetDstAlpha(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->BlendMode()));
        _draw_c951343d.Use();
        ...
        _draw_c951343d.Uniform2(3, uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->HasAngle() ? ::g::Uno::Float2__op_Subtraction2(::g::Uno::Float2__op_Division1(element->ActualSize(), 2.0f), ::g::Uno::Float2__op_Division1(::g::Uno::Float2__op_Multiply1(angleSlope_c951343d_14_18_8, angleLen_c951343d_14_17_9), 2.0f)) : ::g::Uno::Float2__op_Multiply2(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->StartPoint(), element->ActualSize()));
        ...
        _draw_c951343d.Uniform2(8, uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->HasAngle() ? angleSlope_c951343d_14_18_8 : ::g::Uno::Vector::Normalize(::g::Uno::Float2__op_Multiply2(::g::Uno::Float2__op_Subtraction2(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->EndPoint(), uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->StartPoint()), element->ActualSize())));
        _draw_c951343d.Uniform(9, uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->HasAngle() ? angleLen_c951343d_14_17_9 : ::g::Uno::Vector::Length(::g::Uno::Float2__op_Multiply2(::g::Uno::Float2__op_Subtraction2(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->EndPoint(), uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->StartPoint()), element->ActualSize())));
        _draw_c951343d.Sampler2(10, uPtr(uPtr(uAs< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))->_gradientBuffer)->ColorBuffer());
