...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Navigation\0.42.4\$.uno
// -------------------------------------------------------------------------------------
...
static void BackForwardNavigationTriggerAction_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.42.4\\$.uno");
...
void BackForwardNavigationTriggerAction__Perform_fn(BackForwardNavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (nav != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"No Navigati...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4157, ::STRINGS[2/*"Perform"*/]);
}
...
void NavigateToggle__Perform1_fn(NavigateToggle* __this, uObject* ctx, ::g::Fuse::Node* n)
{
    ...
    if (page != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"No Page was...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4138, ::STRINGS[2/*"Perform"*/]);
}
...
uObject* Navigation::TryFindBaseNavigation1(::g::Fuse::Node* node, ::g::Fuse::Visual** parent)
{
    ...
    *parent = NULL;
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"TryFindBase...*/], node, ::STRINGS[1/*"C:\\Users\\...*/], 888, ::STRINGS[13/*"TryFindBase...*/]);
        return NULL;
    }
...
::g::Fuse::Visual* Navigation::TryFindPage(::g::Fuse::Node* node, uObject** nav, ::g::Fuse::Visual** pageBind)
{
    ...
    *pageBind = NULL;
    ...
    if (!uPtr(node)->IsRootingStarted())
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"TryFindPage...*/], node, ::STRINGS[1/*"C:\\Users\\...*/], 949, ::STRINGS[15/*"TryFindPage"*/]);
        return NULL;
    }
                ...
                *pageBind = v;
                ...
                if (uPtr(p)->IsRootingStarted())
                {
                    *nav = Navigation::TryFind(p);
                    ...
                    if (*nav == NULL)
                    {
                        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[16/*"`Page` set ...*/], p, ::STRINGS[1/*"C:\\Users\\...*/], 970, ::STRINGS[15/*"TryFindPage"*/]);
                        return NULL;
                    }
                }
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Got an unde...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1100, ::STRINGS[18/*"OnPageRooti...*/]);
        return;
    }
...
void NavigationPageProxy::Rooted(::g::Fuse::Visual* source)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[19/*"Attempting ...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1063, ::STRINGS[20/*"Rooted"*/]);
        return;
    }
    ...
    if (Page() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[21/*"Unable to l...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1070, ::STRINGS[20/*"Rooted"*/]);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"Something w...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1087, ::STRINGS[20/*"Rooted"*/]);
        return;
    }
...
void NavigationTriggerAction__Perform_fn(NavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (ctx == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"No navigati...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4034, ::STRINGS[2/*"Perform"*/]);
        return;
    }
...
Route* Route::SubDepth(int count)
{
    ...
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[29/*"count can't...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1920, ::STRINGS[30/*"SubDepth"*/]);
        return NULL;
    }
...
void Router::Modify(int how, ::g::Fuse::Navigation::Route* route, int mode)
{
    ...
    switch (how)
    {
        ...
        {
            if (route != NULL)
                ::g::Fuse::Diagnostics::UserWarning(::STRINGS[58/*"PrepareBack...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2624, ::STRINGS[59/*"Modify"*/]);

            if (uPtr(_history)->Count() == 0)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[60/*"There is no...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2628, ::STRINGS[59/*"Modify"*/]);
                return;
            }
...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[66/*"Cannot pop(...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2706, ::STRINGS[67/*"Pop"*/]);
        return;
    }
...
void Router::SetPrepareProgress(double value)
{
    ...
    if ((pc == NULL) || (pn == NULL))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[68/*"Invalid out...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2780, ::STRINGS[69/*"SetPrepareP...*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        ...
        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"C:\\Users\\...*/], 2802, ::STRINGS[71/*"SetRoute"*/]);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"C:\\Users\\...*/], 2804, ::STRINGS[71/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation, uObject** majorChange)
{
    ...
    *majorChange = NULL;
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[72/*"No router o...*/], r), this, ::STRINGS[1/*"C:\\Users\\...*/], 2823, ::STRINGS[73/*"SetRouteImpl"*/]);
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[74/*"SubRoute re...*/], r), this, ::STRINGS[1/*"C:\\Users\\...*/], 2848, ::STRINGS[73/*"SetRouteImpl"*/]);
            return NULL;
        }
        else
        {
...
void Router::Bookmark(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"`Router.boo...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2211, ::STRINGS[40/*"Bookmark"*/]);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[41/*"`Router.boo...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2218, ::STRINGS[40/*"Bookmark"*/]);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[42/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Could not f...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2242, ::STRINGS[40/*"Bookmark"*/]);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[44/*"path"*/]))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"`path` shou...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2251, ::STRINGS[40/*"Bookmark"*/]);
                return;
            }
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[46/*"Unrecognize...*/], p), r, ::STRINGS[1/*"C:\\Users\\...*/], 2259, ::STRINGS[40/*"Bookmark"*/]);
            return;
        }
    }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"A `name` is...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2272, ::STRINGS[40/*"Bookmark"*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::GetRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[48/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2035, ::STRINGS[49/*"GetRelative"*/]);
        return NULL;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[50/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2043, ::STRINGS[49/*"GetRelative"*/]);
        return NULL;
    }
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"Router.getR...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2364, ::STRINGS[52/*"GetRoute"*/]);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[53/*"Router.getR...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2370, ::STRINGS[52/*"GetRoute"*/]);
        return;
    }
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Router.goBa...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2090, ::STRINGS[55/*"GoBack"*/]);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 1982, ::STRINGS[57/*"Goto"*/]);
}
...
void Router::Modify1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[61/*"`Router.mod...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2130, ::STRINGS[59/*"Modify"*/]);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[62/*"`Router.mod...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2137, ::STRINGS[59/*"Modify"*/]);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[44/*"path"*/]))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"`path` shou...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2160, ::STRINGS[59/*"Modify"*/]);
                return;
            }
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[42/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Could not f...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2172, ::STRINGS[59/*"Modify"*/]);
                return;
            }
        }
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[31/*"bookmark"*/]))
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[65/*"Unknown boo...*/], bk), r, ::STRINGS[1/*"C:\\Users\\...*/], 2185, ::STRINGS[59/*"Modify"*/]);
                return;
            }
        }
        else
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[46/*"Unrecognize...*/], p), r, ::STRINGS[1/*"C:\\Users\\...*/], 2191, ::STRINGS[59/*"Modify"*/]);
            return;
        }
    }
...
bool Router::ValidateParameter(::g::Fuse::Scripting::Context* c, uObject* arg, int depth)
{
    ...
    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[75/*"Route param...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2283, ::STRINGS[76/*"ValidatePar...*/]);
        return false;
    }
    ...
    if (uIs(arg, ::TYPES[41/*Fuse.Scripting.Object*/]))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[77/*"Route param...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2292, ::STRINGS[76/*"ValidatePar...*/]);
            return false;
        }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[78/*"Route param...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2315, ::STRINGS[76/*"ValidatePar...*/]);
        return false;
    }
...
void RouterModify__Perform_fn(RouterModify* __this, ::g::Fuse::Node* n)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[79/*"Router not ...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 3034, ::STRINGS[2/*"Perform"*/]);
        return;
    }
    ...
    if (::g::Uno::String::op_Inequality(__this->Bookmark(), NULL))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[65/*"Unknown boo...*/], __this->Bookmark()), __this, ::STRINGS[1/*"C:\\Users\\...*/], 3044, ::STRINGS[2/*"Perform"*/]);
            return;
        }
    }
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[80/*"Seek being ...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 3463, ::STRINGS[81/*"Fuse.Naviga...*/]);
        return;
    }
...
void StructuredNavigation::Duration(double value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[86/*"Use a `Navi...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3363, ::STRINGS[87/*"set_Duration"*/]);
}
...
void StructuredNavigation::Easing(::g::Fuse::Animations::Easing* value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[88/*"Use a `Navi...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3354, ::STRINGS[89/*"set_Easing"*/]);
}
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[82/*"Attempting ...*/], element, ::STRINGS[1/*"C:\\Users\\...*/], 3168, ::STRINGS[83/*"GotoImpl"*/]);
        SetActive(NULL);
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[90/*"Motion shou...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3099, ::STRINGS[91/*"set_Motion"*/]);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[84/*"Updated cal...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3261, ::STRINGS[85/*"OnUpdated"*/]);
        return;
    }
...
void SwipeNavigate::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (_currentNavigation == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[92/*"SwipeNaviga...*/], 1, ::STRINGS[1/*"C:\\Users\\...*/], 3810);
        return;
    }
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[94/*"Navigation....*/], nav, ::STRINGS[1/*"C:\\Users\\...*/], 4270, ::STRINGS[95/*"gotoNode"*/]);
}
// }
...
void WhileHistoryTrigger__OnRooted_fn(WhileHistoryTrigger* __this)
{
    ...
    if (__this->NavigationContext() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[96/*"WhileHistor...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4524, ::STRINGS[7/*"OnRooted"*/]);
        return;
    }
...
void WhileNavigating__OnRooted_fn(WhileNavigating* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[97/*"WhileNaviga...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4605, ::STRINGS[7/*"OnRooted"*/]);
        return;
    }
