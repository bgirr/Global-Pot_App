...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Scripting.V8\0.42.4\$.uno
// ---------------------------------------------------------------------------------------
...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.V8\\0.42.4\\$.uno");
...
void Debugger__Connected::ctor_(::g::Fuse::Scripting::V8::Debugger* parent, ::g::Uno::Net::Sockets::Socket* socket, ::g::Uno::IO::TextReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DEBUG_V8: C...*/], 1, ::STRINGS[1/*"C:\\Users\\...*/], 571);
    _parent = parent;
    _socket = socket;
    _reader = reader;
}
...
uObject* Debugger::Connect(Debugger* parent)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[16/*"DEBUG_V8: W...*/], uBox<int>(::TYPES[17/*int*/], parent->_port)), ::STRINGS[17/*"..."*/]), 1, ::STRINGS[1/*"C:\\Users\\...*/], 419);
