...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseReactive_bundle::setTimeoutffdf5b0f())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseReactive_bundle::es6promiseminb590c71c())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Observabledd9ef4b6()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
void Http__Evaluate_fn(Http* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uPtr(uPtr(result)->Object)->Item(::STRINGS[33/*"exports"*/], Http__FunctionClosure::New1(c, uDelegate::New(::TYPES[23/*Uno.Func<Fuse.Scripting.Context, object[], object>*/], (void*)Http__CreateClient_fn, __this))->Callback());
}
...
uString* HttpHeaders::GetValue(uString* key)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_headers), ::g::Uno::String::ToLower(uPtr(key)), (void**)(&list), &ret6), ret6))
        return ::g::Uno::String::Join(::STRINGS[34/*", "*/], (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[26/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], list));
...
{
    ::STRINGS[0] = uString::Const("FuseJS/Timer");
    ::STRINGS[36] = uString::Const("create");
    ::STRINGS[37] = uString::Const("delete");
    ::STRINGS[38] = uString::Const("create(): requires at least three arguments");
    ::STRINGS[39] = uString::Const("create(): first argument must be a function");
    ::STRINGS[40] = uString::Const("delete(): requires one argument");
...
void TimerModule::ctor_2()
{
    ...
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[36/*"create"*/], uDelegate::New(::TYPES[32/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Create_fn, this)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[37/*"delete"*/], uDelegate::New(::TYPES[32/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Delete_fn, this)));
...
uObject* TimerModule::Create(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    if (uPtr(args)->Length() < 3)
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[38/*"create(): r...*/]));

    if (!uIs((uObject*)uPtr(args)->Strong<uObject*>(0), ::TYPES[2/*Fuse.Scripting.Function*/]))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[39/*"create(): f...*/]));
...
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    if (uPtr(args)->Length() < 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[40/*"delete(): r...*/]));
