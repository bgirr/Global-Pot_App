...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\UnoCore\0.44.5\source\uno\graphics\$.uno
// -------------------------------------------------------------------------------------------------
...
// public Texture2D(int2 size, Uno.Graphics.Format format, bool mipmap) :991
void Texture2D__ctor__fn(Texture2D* __this, ::g::Uno::Int2* size, int* format, bool* mipmap)
{
    __this->ctor_(*size, *format, *mipmap);
}

// public extern Texture2D(OpenGL.GLTextureHandle handle, int2 size, int mipCount, Uno.Graphics.Format format) :981
...
// public extern Texture2D New(OpenGL.GLTextureHandle handle, int2 size, int mipCount, Uno.Graphics.Format format) :981
...
// public bool get_SupportsMipmap() :1137
void Texture2D__get_SupportsMipmap_fn(Texture2D* __this, bool* __retval)
{
    *__retval = __this->SupportsMipmap();
}

// public void Update(Uno.Buffer mip0) :1057
...
// public Texture2D(int2 size, Uno.Graphics.Format format, bool mipmap) [instance] :991
...
// public extern Texture2D(OpenGL.GLTextureHandle handle, int2 size, int mipCount, Uno.Graphics.Format format) [instance] :981
...
// public void Dispose() [instance] :1013
...
// public generated Uno.Graphics.Format get_Format() [instance] :971
int Texture2D::Format()
{
    return _Format;
}

// private generated void set_Format(Uno.Graphics.Format value) [instance] :972
void Texture2D::Format(int value)
{
    _Format = value;
}

// public void GenerateMipmap() [instance] :1140
...
// public generated extern OpenGL.GLTextureHandle get_GLTextureHandle() [instance] :977
uint32_t Texture2D::GLTextureHandle()
{
    return _GLTextureHandle;
}

// private generated extern void set_GLTextureHandle(OpenGL.GLTextureHandle value) [instance] :978
void Texture2D::GLTextureHandle(uint32_t value)
{
    _GLTextureHandle = value;
}

// public generated bool get_IsDisposed() [instance] :1009
bool Texture2D::IsDisposed()
{
    return _IsDisposed;
}

// private generated void set_IsDisposed(bool value) [instance] :1010
void Texture2D::IsDisposed(bool value)
{
    _IsDisposed = value;
}

// public bool get_IsMipmap() [instance] :1131
bool Texture2D::IsMipmap()
{
    return (MipCount() > 1) && IsPow2();
}

// public bool get_IsPow2() [instance] :1126
bool Texture2D::IsPow2()
{
    return ::g::Uno::Math::IsPow2(Size().X) && ::g::Uno::Math::IsPow2(Size().Y);
}

// public generated int get_MipCount() [instance] :965
int Texture2D::MipCount()
{
    return _MipCount;
}

// private generated void set_MipCount(int value) [instance] :966
...
// public bool get_SupportsMipmap() [instance] :1137
bool Texture2D::SupportsMipmap()
{
    return IsMipmap();
}

// public void Update(Uno.Buffer mip0) [instance] :1057
...
// public Texture2D New(int2 size, Uno.Graphics.Format format, bool mipmap) [static] :991
...
// public extern Texture2D New(OpenGL.GLTextureHandle handle, int2 size, int mipCount, Uno.Graphics.Format format) [static] :981
...
// public intrinsic sealed class TextureCube :1213
// {
static void TextureCube_build(uType* type)
{
    ::STRINGS[8] = uString::Const("TextureCube");
    type->SetInterfaces(
...
// public generated extern OpenGL.GLTextureHandle get_GLTextureHandle() [instance] :1316
uint32_t TextureCube::GLTextureHandle()
{
    return _GLTextureHandle;
}

// private generated extern void set_GLTextureHandle(OpenGL.GLTextureHandle value) [instance] :1317
void TextureCube::GLTextureHandle(uint32_t value)
{
    _GLTextureHandle = value;
}

// public generated bool get_IsDisposed() [instance] :1346
bool TextureCube::IsDisposed()
{
    return _IsDisposed;
}

// private generated void set_IsDisposed(bool value) [instance] :1347
void TextureCube::IsDisposed(bool value)
{
    _IsDisposed = value;
}

// public generated int get_Size() [instance] :1298
int TextureCube::Size()
{
    return _Size;
}

// private generated void set_Size(int value) [instance] :1299
...
// public static class TextureHelpers :1510
// {
...
// public static int2 GetMipSize(textureCube texture, int mip) :1531
...
// public static int GetMipCount(int2 size) [static] :1546
...
// public static int2 GetMipSize(texture2D texture, int mip) [static] :1512
...
// public static int2 GetMipSize(textureCube texture, int mip) [static] :1531
...
// public struct VertexAttributeInfo :1582
// {
...
// public static class VertexAttributeTypeHelpers :1604
// {
static void VertexAttributeTypeHelpers_build(uType* type)
{
    ::STRINGS[9] = uString::Const("Invalid VertexAttributeType <");
    ::STRINGS[2] = uString::Const(">");
    type->Reflection.SetFunctions(1,
...
// public static int GetStrideInBytes(Uno.Graphics.VertexAttributeType type) :1606
...
// public static int GetStrideInBytes(Uno.Graphics.VertexAttributeType type) [static] :1606
int VertexAttributeTypeHelpers::GetStrideInBytes(int type)
{
    ...
    switch (type)
    {
        ...
        case 20:
            return 4;
        default:
            U_THROW(::g::Uno::FormatException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[9/*"Invalid Ver...*/], uBox<int>(::g::Uno::Graphics::VertexAttributeType_typeof(), type)), ::STRINGS[2/*">"*/])));
    }
}
// }
...
// public sealed class VertexBuffer :1661
// {
...
// public VertexBuffer(Uno.Buffer data, Uno.Graphics.BufferUsage usage) [instance] :1681
...
// public VertexBuffer(Uno.Graphics.BufferUsage usage) [instance] :1663
...
// public VertexBuffer New(int sizeInBytes, Uno.Graphics.BufferUsage usage) [static] :1672
...
// public VertexBuffer New(Uno.Buffer data, Uno.Graphics.BufferUsage usage) [static] :1681
...
// public VertexBuffer New(Uno.Graphics.BufferUsage usage) [static] :1663
...
// public intrinsic sealed class VideoTexture :1737
// {
...
// public generated extern OpenGL.GLTextureHandle get_GLTextureHandle() [instance] :1747
uint32_t VideoTexture::GLTextureHandle()
{
    return _GLTextureHandle;
}

// private generated extern void set_GLTextureHandle(OpenGL.GLTextureHandle value) [instance] :1748
void VideoTexture::GLTextureHandle(uint32_t value)
{
    _GLTextureHandle = value;
}

// public generated bool get_IsDisposed() [instance] :1758
bool VideoTexture::IsDisposed()
{
    return _IsDisposed;
}

// private generated void set_IsDisposed(bool value) [instance] :1759
void VideoTexture::IsDisposed(bool value)
{
    _IsDisposed = value;
}

// public extern VideoTexture New(OpenGL.GLTextureHandle handle) [static] :1751
