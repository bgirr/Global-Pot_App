...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Reactive\0.42.4\subscription\$.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\FuseCore\0.42.4\reactive\$.uno
// ---------------------------------------------------------------------------------------
...
static void BindingTypes_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\FuseCore\\0.42.4\\reactive\\$.uno");
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Reactive\0.42.4\$.uno
// -----------------------------------------------------------------------------------
...
static void EventBinding__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive\\0.42.4\\$.uno");
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Reactive\0.42.4\fusejs\$.uno
// ------------------------------------------------------------------------------------------
...
{
    ::STRINGS[12] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive\\0.42.4\\fusejs\\$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[12/*"C:\\Users\\...*/], 131);
    return NULL;
}
...
uObject* Console::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"C:\\Users\\...*/], 117);
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if ((::g::Fuse::Scripting::Marshal__TryConvertTo1_fn(__types[1], newValue, &value, &ret2), ret2))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(uPtr(e)->ToString(), Target(), ::STRINGS[10/*"C:\\Users\\...*/], 388, ::STRINGS[30/*"TryPushAsMa...*/]);
        }
    }
}
...
uObject* DebugLog::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"C:\\Users\\...*/], 95);
...
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[35/*"Template co...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 1411, ::STRINGS[36/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[37/*"Limit canno...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 1027, ::STRINGS[38/*"set_Limit"*/]);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"Offset cann...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 979, ::STRINGS[40/*"set_Offset"*/]);
        value = 0;
    }
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[42/*"JavaScript ...*/], FileName()), ::STRINGS[43/*" fixed!"*/]), this, ::STRINGS[10/*"C:\\Users\\...*/], 1605, ::STRINGS[44/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[45/*"JavaScript ...*/], se, this, ::STRINGS[10/*"C:\\Users\\...*/], 1616, ::STRINGS[44/*"EvaluateMod...*/]);
...
{
    ctor_4();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[58/*"'Select' is...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 2646, ::STRINGS[59/*".ctor"*/]);
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[60/*"Skipped Exc...*/], next, this, ::STRINGS[10/*"C:\\Users\\...*/], 2263, ::STRINGS[61/*"CheckAndThrow"*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[62/*"ThreadWorke...*/], e, this, ::STRINGS[10/*"C:\\Users\\...*/], 2148, ::STRINGS[63/*"Run"*/]);
