...
{
    ::STRINGS[12] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive\\0.44.1\\fusejs\\$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[12/*"C:\\Users\\...*/], 135);
    return NULL;
}
...
uObject* Console::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"C:\\Users\\...*/], 121);
...
bool DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if ((::g::Fuse::Scripting::Marshal__TryConvertTo1_fn(__types[1], newValue, &value, &ret2), ret2))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[10/*"C:\\Users\\...*/], 439, ::STRINGS[31/*"TryPushAsMa...*/]);
        }
...
uObject* DebugLog::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"C:\\Users\\...*/], 99);
...
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[36/*"Template co...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 1465, ::STRINGS[37/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[38/*"Limit canno...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 1080, ::STRINGS[39/*"set_Limit"*/]);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[40/*"Offset cann...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 1032, ::STRINGS[41/*"set_Offset"*/]);
        value = 0;
    }
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[43/*"JavaScript ...*/], FileName()), ::STRINGS[44/*" fixed!"*/]), this, ::STRINGS[10/*"C:\\Users\\...*/], 1659, ::STRINGS[45/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[46/*"JavaScript ...*/], se, this, ::STRINGS[10/*"C:\\Users\\...*/], 1670, ::STRINGS[45/*"EvaluateMod...*/]);
...
{
    ctor_5();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[59/*"'Select' is...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 2772, ::STRINGS[60/*".ctor"*/]);
}
...
void ThreadWorker::ctor_()
{
    ...
    _thread = ::g::Uno::Threading::Thread::New1(uDelegate::New(::TYPES[57/*Uno.Threading.ThreadStart*/], (void*)ThreadWorker__Run_fn, this));
    uPtr(_thread)->Start();
    uPtr(_ready)->WaitOne();
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[61/*"Skipped Exc...*/], next, this, ::STRINGS[10/*"C:\\Users\\...*/], 2334, ::STRINGS[62/*"CheckAndThrow"*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[63/*"ThreadWorke...*/], e, this, ::STRINGS[10/*"C:\\Users\\...*/], 2210, ::STRINGS[64/*"Run"*/]);
