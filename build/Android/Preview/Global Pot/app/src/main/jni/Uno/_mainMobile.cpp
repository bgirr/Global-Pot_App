// This file was generated based on C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\UnoCore\0.44.5\backends\cplusplus\Uno\_mainMobile.cpp.
...
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* OverviewPage__Template_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* OverviewPage_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* RecipePage__Template__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* RecipePage__Template_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* RecipePage__Template1_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* RecipePage__Template2_typeof();}
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* RecipePage__Template3__Template4_typeof();}
...
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} ::g::Fuse::Controls::TextControl_type* WhiteText_typeof();}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::OverviewPage__Template_typeof,
        (uType*(*)())&::g::OverviewPage_typeof,
        (uType*(*)())&::g::RecipePage__Template__Template1_typeof,
        (uType*(*)())&::g::RecipePage__Template_typeof,
        (uType*(*)())&::g::RecipePage__Template1_typeof,
        (uType*(*)())&::g::RecipePage__Template2_typeof,
        (uType*(*)())&::g::RecipePage__Template3__Template4_typeof,
