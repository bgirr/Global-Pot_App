...
// private static int GetBuildVersion() [static] :652
int AndroidProperties::GetBuildVersion()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetBuildVersion335", "()I");
...
// public static int get_BuildVersion() [static] :643
...
// public override sealed Fuse.Visual get_ChildrenVisual() :593
...
// public Uno.Collections.IList<Uno.UX.Resource> get_Resources() :408
...
// public Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance] :408
...
// protected bool get_IsRooted() :449
...
// protected bool get_IsRooted() [instance] :449
...
// public bool get_HasValidContentIfPinned() :543
...
// public bool get_HasValidContentIfPinned() [instance] :543
...
// public sealed class Deferred :953
// {
static void Deferred_build(uType* type)
{
    ::STRINGS[8] = uString::Const("Duplicate call to Deferred.Perform");
    ::STRINGS[9] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\0.44.1\\$.uno");
...
// public generated Deferred() :953
void Deferred__ctor_3_fn(Deferred* __this)
{
    __this->ctor_3();
}

// private void Fuse.IDeferred.Perform() :1004
void Deferred__FuseIDeferredPerform_fn(Deferred* __this)
{
    ...
    if (__this->_added != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"Duplicate c...*/], __this, ::STRINGS[9/*"C:\\Users\\...*/], 1007, ::STRINGS[10/*"Fuse.IDefer...*/]);
...
// internal override sealed Fuse.Node GetLastNodeInGroup() :1025
...
// public generated Deferred New() :953
void Deferred__New2_fn(Deferred** __retval)
{
    *__retval = Deferred::New2();
}

// protected override sealed void OnRooted() :981
...
// protected override sealed void OnUnrooted() :988
...
// public float get_Priority() [instance] :976
float Deferred::Priority()
{
    return _priority;
}

// public void set_Priority(float value) [instance] :977
void Deferred::Priority(float value)
{
    _priority = value;
}

// public Uno.Collections.IList<Uno.UX.Template> get_Templates() [instance] :960
...
// public generated Deferred New() [static] :953
...
// internal static class DeferredManager :851
// {
// static DeferredManager() :851
...
// public static void AddPending(Fuse.IDeferred d, [float priority]) [static] :855
...
// private static void CheckUpdate() [static] :869
...
// private static void OnUpdate() [static] :895
...
// public static void RemovePending(Fuse.IDeferred d) [static] :861
...
// internal static bool get_HasPending() [static] :916
...
// public static void PerformanceWarning(string msg, [string filePath], [int lineNumber], [string memberName]) :821
...
// public static void PerformanceWarning(string msg, [string filePath], [int lineNumber], [string memberName]) [static] :821
...
// public void AddFlushListener(Fuse.IFlush f) :933
...
// public float2 get_GLViewportPointSize() :1194
...
// public void PopRenderTargetViewport() :1088
...
// public void PushCullFace(Uno.Graphics.PolygonFace cf) :1218
...
// public void PushRenderTargetViewport(framebuffer fb, Fuse.IRenderViewport viewport) :1076
...
// public void AddFlushListener(Fuse.IFlush f) [instance] :933
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 954, ::STRINGS[26/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1102, ::STRINGS[27/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1020, ::STRINGS[35/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1143, ::STRINGS[36/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1187, ::STRINGS[37/*"set_GLViewp...*/]);
}

// public float2 get_GLViewportPointSize() [instance] :1194
...
// public void PopCullFace() [instance] :1224
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1064, ::STRINGS[28/*"PopRenderTa...*/]);
...
// public void PopRenderTargetViewport() [instance] :1088
...
// public void PushCullFace(Uno.Graphics.PolygonFace cf) [instance] :1218
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 1049, ::STRINGS[29/*"PushRenderT...*/]);
    _renderTarget = rt;
...
// public void PushRenderTargetViewport(framebuffer fb, Fuse.IRenderViewport viewport) [instance] :1076
...
void DrawContext::ReleaseRootbuffer()
{
    ...
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[30/*"Unpopped Sc...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 980, ::STRINGS[31/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[32/*"Unpopped Cu...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 984, ::STRINGS[31/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[33/*"Unpopped Vi...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 988, ::STRINGS[31/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[34/*"Unpopped Re...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 992, ::STRINGS[31/*"ReleaseRoot...*/]);
...
static void DrawHelpers_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[37/*float2[]*/], offsetof(::g::Fuse::DrawHelpers, DrawLocalRect_Vertices_311c1aa8_1_1_4), 0,
...
// public void AppendTranslation(float3 offset) :2429
...
// public bool get_HasNonTranslation() :2279
...
// public void AppendTranslation(float3 offset) [instance] :2429
...
// public bool get_HasNonTranslation() [instance] :2279
...
// public FastProperty1Link New(Fuse.FastProperty1 p) :5755
...
// public FastProperty1Link New(Fuse.FastProperty1 p) [static] :5755
...
// public FastProperty2Link New(Fuse.FastProperty2 p) :5908
...
// public FastProperty2Link New(Fuse.FastProperty2 p) [static] :5908
...
// public float4x4 get_ProjectionTransform() :3270
...
// public float4x4 get_ProjectionTransformInverse() :3272
...
// public float3 get_ViewOrigin() :3282
...
// public float4x4 get_ViewProjectionTransformInverse() :3276
...
// public float4x4 get_ProjectionTransform() [instance] :3270
...
// public float4x4 get_ProjectionTransformInverse() [instance] :3272
...
// public float3 get_ViewOrigin() [instance] :3282
...
// public float4x4 get_ViewProjectionTransformInverse() [instance] :3276
...
// public float2 get_ViewRange() [instance] :3283
...
// public float4x4 get_ViewTransform() [instance] :3278
...
// public float4x4 get_ViewTransformInverse() [instance] :3280
...
// private float4x4 GetClipToVisualSpace(float2 size) :3231
...
// public float4x4 GetFlatWorldToVisualTransform(float2 size) :3241
...
// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum, Fuse.Visual where) :3248
...
// private float4x4 GetClipToVisualSpace(float2 size) [instance] :3231
...
// public float4x4 GetFlatWorldToVisualTransform(float2 size) [instance] :3241
...
// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum, Fuse.Visual where) [instance] :3248
...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[44/*"GraphicsWor...*/], e, a, ::STRINGS[3/*"C:\\Users\\...*/], 2951, ::STRINGS[45/*"Run"*/]);
...
void GraphicsWorker::Start()
{
    ...
    GraphicsWorker::_thread() = ::g::Uno::Threading::Thread::New1(uDelegate::New(::TYPES[46/*Uno.Threading.ThreadStart*/], (void*)GraphicsWorker__Run_fn));
...
// public void Hit(Fuse.Visual obj, float hitDistance) :3040
...
// public void PopWorldRay(Uno.Geometry.Ray o) :3019
...
// public Uno.Geometry.Ray get_WorldRay() :3010
...
// public void Hit(Fuse.Visual obj, float hitDistance) [instance] :3040
...
// public void PopWorldRay(Uno.Geometry.Ray o) [instance] :3019
...
// public Uno.Geometry.Ray get_WorldRay() [instance] :3010
...
// internal sealed class InheritViewport :3305
// {
...
// public InheritViewport(Fuse.IRenderViewport baseView, Fuse.FrustumViewport childView, Fuse.Visual child) :3311
...
// public InheritViewport New(Fuse.IRenderViewport baseView, Fuse.FrustumViewport childView, Fuse.Visual child) :3311
...
// public float2 get_PixelSize() [instance] :3322
...
// public float get_PixelsPerPoint() [instance] :3317
...
// public float4x4 get_ProjectionTransform() [instance] :3324
...
// public float2 get_Size() [instance] :3320
...
// public float3 get_ViewOrigin() [instance] :3334
...
// public float4x4 get_ViewProjectionTransform() [instance] :3327
...
// public float2 get_ViewRange() [instance] :3335
...
// public float4x4 get_ViewTransform() [instance] :3333
...
// public InheritViewport New(Fuse.IRenderViewport baseView, Fuse.FrustumViewport childView, Fuse.Visual child) [static] :3311
...
// public generated KeyboardBootstrapper() :3354
void KeyboardBootstrapper__ctor__fn(KeyboardBootstrapper* __this)
{
    __this->ctor_();
}

// public generated KeyboardBootstrapper New() :3354
...
// public static void OnTextInput(object sender, Uno.Platform.TextInputEventArgs args) :3385
...
// public generated KeyboardBootstrapper() [instance] :3354
void KeyboardBootstrapper::ctor_()
{
}

// public generated KeyboardBootstrapper New() [static] :3354
...
// public static void OnTextInput(object sender, Uno.Platform.TextInputEventArgs args) [static] :3385
...
// public void Copy(Fuse.LayoutParams o) :3540
...
// public Fuse.LayoutParams DeriveClone() :3523
...
// public float2 GetAvailableSize(bool& hasX, bool& hasY) :3780
...
// public bool get_HasMinSize() :3457
...
// public float2 get_RelativeSize() :3799
...
// public Fuse.LayoutParams TrueClone() :3494
...
// public void Copy(Fuse.LayoutParams o) [instance] :3540
...
// public Fuse.LayoutParams DeriveClone() [instance] :3523
LayoutParams LayoutParams::DeriveClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[47/*"Use CloneAn...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"C:\\Users\\...*/], 3528, ::STRINGS[48/*"DeriveClone"*/]);
...
// public float2 GetAvailableSize(bool& hasX, bool& hasY) [instance] :3780
...
// public bool get_HasMinSize() [instance] :3457
...
// public float2 get_RelativeSize() [instance] :3799
...
// public Fuse.LayoutParams TrueClone() [instance] :3494
LayoutParams LayoutParams::TrueClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[49/*"Use Clone i...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"C:\\Users\\...*/], 3499, ::STRINGS[50/*"TrueClone"*/]);
...
// public enum MarginBoxDependent :6590
...
// public generated MobileBootstrapping() :3894
...
// public generated MobileBootstrapping New() :3894
...
// public generated MobileBootstrapping() [instance] :3894
...
void MobileBootstrapping::Init()
{
    ...
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyDown(uDelegate::New(::TYPES[47/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyPressed_fn));
    ...
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyUp(uDelegate::New(::TYPES[47/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyReleased_fn));
}

// public generated MobileBootstrapping New() [static] :3894
...
// public static Uno.UX.Selector GetName(Fuse.Node obj) :9588
...
// public static Uno.UX.Selector GetName(Fuse.Node obj) [static] :9588
...
// private void IterPreserveRootFrame(Fuse.Node n) :4688
...
// internal virtual void OnPreserveRootFrame() :4693
...
// public virtual void OnSubtreeDataContextChanged() :4161
...
// internal void PreserveRootFrame() :4683
...
// public string SubtreeToString() :4893
void Node__SubtreeToString_fn(Node* __this, uString** __retval)
{
    *__retval = __this->SubtreeToString();
}

// protected virtual void SubtreeToString(Uno.Text.StringBuilder sb, int indent) :4900
...
// private void IterPreserveRootFrame(Fuse.Node n) [instance] :4688
...
// internal void PreserveRootFrame() [instance] :4683
...
// public string SubtreeToString() [instance] :4893
...
// public sealed class NodeGroup :4381
// {
...
// public bool get_IsActive() [instance] :4388
bool NodeGroup::IsActive()
{
    return UseContent();
}

// public void set_IsActive(bool value) [instance] :4389
void NodeGroup::IsActive(bool value)
{
    UseContent(value);
}

// public NodeGroup New() [static] :4392
...
// private void OnResourceAdded(Uno.UX.Resource r) :4262
void NodeGroupBase__OnResourceAdded_fn(NodeGroupBase* __this, ::g::Uno::UX::Resource* r)
{
    __this->OnResourceAdded(r);
}

// private void OnResourceRemoved(Uno.UX.Resource r) :4270
...
// public Uno.Collections.IList<Uno.UX.Resource> get_Resources() :4254
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[61/*"AddContent ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 4302, ::STRINGS[62/*"AddContent"*/]);
        return;
    }
    ...
    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[63/*"Could not l...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 4321, ::STRINGS[62/*"AddContent"*/]);
        return;
    }
...
// private void OnResourceAdded(Uno.UX.Resource r) [instance] :4262
...
// private void OnResourceRemoved(Uno.UX.Resource r) [instance] :4270
...
// public Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance] :4254
...
// public float2 GetDepthRange(Fuse.ICommonViewport viewport) :8317
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) :8312
...
// public float2 GetDepthRange(Fuse.ICommonViewport viewport) [instance] :8317
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) [instance] :8312
...
// public sealed class PerspectiveFrustum :8358
// {
...
// public float4x4 GetProjectionTransformInverse(Fuse.ICommonViewport viewport) [instance] :8375
...
// public float4x4 GetViewTransform(Fuse.ICommonViewport viewport) [instance] :8370
...
// public float4x4 GetViewTransformInverse(Fuse.ICommonViewport viewport) [instance] :8382
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) [instance] :8387
...
// public generated PerspectiveFrustum New() [static] :8358
...
// public object get_DefaultValue() :10323
...
// public object get_DefaultValue() [instance] :10323
...
// public void RemoveAllFromList(Fuse.PropertyHandle handle, object val) :8927
...
// public object[] ToArray(Fuse.PropertyHandle handle) :8932
...
// public void RemoveAllFromList(Fuse.PropertyHandle handle, object val) [instance] :8927
...
// public object[] ToArray(Fuse.PropertyHandle handle) [instance] :8932
...
// public sealed class RequiresRootedException :7720
// {
...
// public RootViewport(Uno.Platform.Window window, [float overridePixelsPerPoint]) :9160
...
// public RootViewport New(Uno.Platform.Window window, [float overridePixelsPerPoint]) :9160
...
// public float4x4 get_ProjectionTransform() :9354
void RootViewport__get_ProjectionTransform_fn(RootViewport* __this, ::g::Uno::Float4x4* __retval)
{
    *__retval = __this->ProjectionTransform();
}

// public float4x4 get_ProjectionTransformInverse() :9356
...
// public RootViewport(Uno.Platform.Window window, [float overridePixelsPerPoint]) [instance] :9160
...
// public float4x4 get_ProjectionTransform() [instance] :9354
...
// public float4x4 get_ProjectionTransformInverse() [instance] :9356
...
// public float3 get_ViewOrigin() [instance] :9365
...
// public float4x4 get_ViewProjectionTransform() [instance] :9358
...
// public float4x4 get_ViewProjectionTransformInverse() [instance] :9360
...
// public float2 get_ViewRange() [instance] :9366
...
// public float4x4 get_ViewTransform() [instance] :9364
...
// public float4x4 get_ViewTransformInverse() [instance] :9362
...
// public RootViewport New(Uno.Platform.Window window, [float overridePixelsPerPoint]) [static] :9160
...
// public float get_DegreesX() [instance] :10010
float Rotation::DegreesX()
{
    return ::g::Uno::Math::RadiansToDegrees1(_euler.X);
}

// public void set_DegreesX(float value) [instance] :10011
...
// public float get_DegreesY() [instance] :9996
float Rotation::DegreesY()
{
    return ::g::Uno::Math::RadiansToDegrees1(_euler.Y);
}

// public void set_DegreesY(float value) [instance] :9997
...
// public float3 get_EulerAngleDegrees() [instance] :9952
::g::Uno::Float3 Rotation::EulerAngleDegrees()
{
    return ::g::Uno::Math::RadiansToDegrees3(_euler);
}

// public void set_EulerAngleDegrees(float3 value) [instance] :9953
...
// public float get_Factor() [instance] :9437
float Scaling::Factor()
{
    return _vector.X;
}

// public void set_Factor(float value) [instance] :9438
...
// public float get_X() [instance] :9470
float Scaling::X()
{
    return Vector().X;
}

// public void set_X(float value) [instance] :9471
...
// public float get_Y() [instance] :9477
float Scaling::Y()
{
    return Vector().Y;
}

// public void set_Y(float value) [instance] :9478
...
// public float get_Z() [instance] :9484
float Scaling::Z()
{
    return Vector().Z;
}

// public void set_Z(float value) [instance] :9485
...
// public float2 get_Degrees() [instance] :10105
::g::Uno::Float2 Shear::Degrees()
{
    return ::g::Uno::Float2__New2(DegreesX(), DegreesY());
}

// public void set_Degrees(float2 value) [instance] :10106
...
// public float get_DegreesX() [instance] :10075
float Shear::DegreesX()
{
    return _vector.X;
}

// public void set_DegreesX(float value) [instance] :10076
...
// public float get_DegreesY() [instance] :10090
float Shear::DegreesY()
{
    return _vector.Y;
}

// public void set_DegreesY(float value) [instance] :10091
...
// public SystemFont(string family, [Fuse.SystemFont.Style style], [Fuse.SystemFont.Weight weight]) :9729
void SystemFont__ctor_2_fn(SystemFont* __this, uString* family, int* style, int* weight)
{
    __this->ctor_2(family, *style, *weight);
}

// public SystemFont New(string family, [Fuse.SystemFont.Style style], [Fuse.SystemFont.Weight weight]) :9729
...
// public SystemFont(string family, [Fuse.SystemFont.Style style], [Fuse.SystemFont.Weight weight]) [instance] :9729
...
// public SystemFont New(string family, [Fuse.SystemFont.Style style], [Fuse.SystemFont.Weight weight]) [static] :9729
...
// internal static class TestDeferredManager :920
// {
...
// public static float get_FrameIntervalFloat() :9864
...
// public static float get_FrameIntervalFloat() [static] :9864
...
// public sealed class Timer :9745
// {
...
// private void Start() [instance] :9761
void Timer::Start()
{
...
// private void Stop() [instance] :9768
void Timer::Stop()
{
...
// private void Update() [instance] :9774
void Timer::Update()
{
...
// private Timer New(double interval, Uno.Action callback) [static] :9753
...
// public static void Wait(double duration, Uno.Action callback) [static] :9795
...
// public sealed class Toast :9050
// {
// static Toast() :9050
...
// private Toast(Fuse.Visual visual, double duration) [instance] :9058
...
// public void Dismiss() [instance] :9089
void Toast::Dismiss()
{
...
// private static void DispatchNext() [static] :9064
...
// private Toast New(Fuse.Visual visual, double duration) [static] :9058
...
// public static void OnUnrooted(Fuse.Visual toast) [static] :9083
...
// public static Fuse.Toast Post(Fuse.Visual visual, [double duration]) [static] :9111
...
// public float2 get_XY() [instance] :10456
::g::Uno::Float2 Translation::XY()
{
    return ::g::Uno::Float2__New2(_x, _y);
}

// public void set_XY(float2 value) [instance] :10457
...
// public static void RemoveOnceAction(Uno.Action pu, [Fuse.UpdateStage stage]) :10752
...
// public static void RemoveOnceAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :10752
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[72] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\0.44.1\\$.uno");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[71/*"UserEvent r...*/], __this, ::STRINGS[72/*"C:\\Users\\...*/], 638, ::STRINGS[73/*"OnRooted"*/]);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    ...
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[76/*"Trying to R...*/], this, ::STRINGS[72/*"C:\\Users\\...*/], 685, ::STRINGS[77/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[74/*"Raise must ...*/], n, ::STRINGS[72/*"C:\\Users\\...*/], 421, ::STRINGS[70/*"raise"*/]);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[75/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[72/*"C:\\Users\\...*/], 428, ::STRINGS[70/*"raise"*/]);
        return;
    }
...
void UserEvent::RaiseEvent(::g::Fuse::Visual* from, ::g::Uno::UX::Selector name, ::g::Uno::Collections::Dictionary* args)
{
    ...
    if (ev == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::STRINGS[78/*"Unknown eve...*/], ::g::Uno::UX::Selector__op_Implicit1(name)), NULL, ::STRINGS[72/*"C:\\Users\\...*/], 698, ::STRINGS[79/*"RaiseEvent"*/]);
        return;
    }
...
// internal virtual bool CalcAreChildrenFlat() :6437
...
// public Fuse.Visual GetVisualChild(int index) :8028
...
// internal virtual Fuse.Visual.HitTestTransformMode get_HitTestTransform() :6046
...
// public Fuse.Visual get_LastVisualChild() :8047
...
// public float2 LocalToParent(float2 localPoint) :7920
...
// protected virtual void OnInvalidateWorldTransform() :7408
...
// public void OnIsSelectedChanged(bool isSelected) :7777
...
// public override sealed void OnSubtreeDataContextChanged() :7819
...
// internal virtual Fuse.FastMatrix get_ParentWorldTransformInternal() :7458
...
// internal void SetBit(Fuse.FastProperty2 p, bool value) :5974
...
// public void SetResource(string key, object value) :7091
...
// protected override sealed void SubtreeToString(Uno.Text.StringBuilder sb, int indent) :5350
...
// public Fuse.Visual GetVisualChild(int index) [instance] :8028
...
// internal bool get_IsFlat() [instance] :6451
bool Visual::IsFlat()
{
...
// public bool get_IsInteracting() [instance] :6197
...
// public Fuse.Visual get_LastVisualChild() [instance] :8047
...
// public float2 LocalToParent(float2 localPoint) [instance] :7920
...
// public void OnIsSelectedChanged(bool isSelected) [instance] :7777
...
// internal void SetBit(Fuse.FastProperty2 p, bool value) [instance] :5974
...
// public void SetResource(string key, object value) [instance] :7091
...
// public static Fuse.VisualBounds Point(float3 pt) :4958
...
// public Fuse.VisualBounds Transform(float4x4 matrix) :5067
...
// public Fuse.VisualBounds TransformFlatten(float4x4 matrix) :5077
...
// public Fuse.VisualBounds AddPoint(float2 pt) [instance] :5010
...
// public Fuse.VisualBounds AddPoint(float3 pt) [instance] :5005
...
// public Fuse.VisualBounds Transform(float4x4 matrix) [instance] :5067
...
// public Fuse.VisualBounds TransformFlatten(float4x4 matrix) [instance] :5077
...
// public static Fuse.VisualBounds Point(float3 pt) [static] :4958
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[88/*"Invalid Rai...*/], 1, ::STRINGS[3/*"C:\\Users\\...*/], 2181);
            return;
        }
    }
