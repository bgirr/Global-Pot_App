...
static void RecipePage__Template__Template1_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)RecipePage__Template__Template1__New2_fn, 0, true, type, 2, ::g::RecipePage__Template_typeof(), ::g::Fuse::Controls::Panel_typeof()));
}
...
{
    uStackFrame __("RecipePage.Template.Template1", "New()");
