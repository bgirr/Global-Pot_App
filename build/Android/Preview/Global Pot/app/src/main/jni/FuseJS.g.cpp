...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\FuseJS\0.42.4\$.uno
// ----------------------------------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[54] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\FuseJS\\0.42.4\\$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[53/*"Cannot find...*/], Name), this, ::STRINGS[54/*"C:\\Users\\...*/], 888, ::STRINGS[55/*"Raise"*/]);
        return;
    }
...
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[58/*"The FuseJS/...*/], context, ::STRINGS[54/*"C:\\Users\\...*/], 919, ::STRINGS[55/*"Raise"*/]);
