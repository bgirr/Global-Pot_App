...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Download1248", "(Ljava/lang/String;)Ljava/lang/Object;");
        uString* _uurl=url;
...
::g::Java::Object* ImageLoader::LoadFile(uString* filePath)
{
    ImageLoader_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "LoadFile249", "(Ljava/lang/String;)Ljava/lang/Object;");
...
::g::Java::Object* ImageLoader::LoadUri(uString* uri)
{
    ImageLoader_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "LoadUri250", "(Ljava/lang/String;)Ljava/lang/Object;");
        uString* _uuri=uri;
...
void ImageLoader::Release(::g::Java::Object* bitmap)
{
    ImageLoader_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Release251", "(Ljava/lang/Object;)V");
