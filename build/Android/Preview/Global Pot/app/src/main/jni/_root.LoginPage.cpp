...
void LoginPage::InitializeUX()
{
    ...
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::Recipes_APIeb7d723d()));
    ...
    temp6->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::logo_v026ae4f6da()));
