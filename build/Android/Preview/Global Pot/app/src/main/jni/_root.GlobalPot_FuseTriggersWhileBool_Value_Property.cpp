...
{
    uStackFrame __("GlobalPot_FuseTriggersWhileBool_Value_Property", "Get()");
...
{
    uStackFrame __("GlobalPot_FuseTriggersWhileBool_Value_Property", "Set(bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
