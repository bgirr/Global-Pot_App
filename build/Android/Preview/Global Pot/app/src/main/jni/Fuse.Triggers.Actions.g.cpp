...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Elements\0.44.1\triggers\actions\$.uno
// ----------------------------------------------------------------------------------------------------
...
// public sealed class EvaluateJS :923
// {
...
// private string PrepareScriptForEval(string js) :944
...
// public generated void add_Handler(Fuse.Triggers.Actions.JSEventHandler value) [instance] :929
...
// public generated void remove_Handler(Fuse.Triggers.Actions.JSEventHandler value) [instance] :929
...
// public string get_JavaScript() [instance] :939
uString* EvaluateJS::JavaScript()
{
    return _processedSource;
}

// public void set_JavaScript(string value) [instance] :940
...
// private string PrepareScriptForEval(string js) [instance] :944
...
// private void ResultHandler(string result) [instance] :972
...
// public Fuse.Controls.IWebView get_WebView() [instance] :932
uObject* EvaluateJS::WebView()
{
    return _target;
}

// public void set_WebView(Fuse.Controls.IWebView value) [instance] :933
void EvaluateJS::WebView(uObject* value)
{
    _target = value;
}

// public generated EvaluateJS New() [static] :923
...
// public sealed class JSEventArgs :828
// {
...
// public JSEventArgs(string resultJson) :831
void JSEventArgs__ctor_1_fn(JSEventArgs* __this, uString* resultJson)
{
    __this->ctor_1(resultJson);
}

// private void Fuse.Scripting.IScriptEvent.Serialize(Fuse.Scripting.IEventSerializer s) :836
...
// public JSEventArgs New(string resultJson) [static] :831
...
// public delegate void JSEventHandler(object sender, Fuse.Triggers.Actions.JSEventArgs args) :842
...
// public sealed class LoadHtml :720
// {
...
// public generated string get_Source() [instance] :724
uString* LoadHtml::Source()
{
    return _Source;
}

// public generated void set_Source(string value) [instance] :724
void LoadHtml::Source(uString* value)
{
    _Source = value;
}

// public generated LoadHtml New() [static] :720
...
// public sealed class LoadUrl :678
// {
...
// public generated LoadUrl() :678
void LoadUrl__ctor_3_fn(LoadUrl* __this)
{
    __this->ctor_3();
}

// private override sealed void Execute(Fuse.Controls.WebView webview) :683
...
// public generated LoadUrl New() :678
void LoadUrl__New2_fn(LoadUrl** __retval)
{
    *__retval = LoadUrl::New2();
}

// public generated string get_Url() :681
void LoadUrl__get_Url_fn(LoadUrl* __this, uString** __retval)
{
    *__retval = __this->Url();
}

// public generated void set_Url(string value) :681
void LoadUrl__set_Url_fn(LoadUrl* __this, uString* value)
{
    __this->Url(value);
}

// public generated LoadUrl() [instance] :678
void LoadUrl::ctor_3()
{
    ctor_2();
}

// public generated string get_Url() [instance] :681
uString* LoadUrl::Url()
{
    return _Url;
}

// public generated void set_Url(string value) [instance] :681
void LoadUrl::Url(uString* value)
{
    _Url = value;
}

// public generated LoadUrl New() [static] :678
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\0.44.1\\$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[7/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[8/*"C:\\Users\\...*/], 240, ::STRINGS[9/*"Perform"*/]);
    else
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\0.44.1\\$.uno");
    ::STRINGS[9] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"Requires a ...*/], __this, ::STRINGS[11/*"C:\\Users\\...*/], 285, ::STRINGS[9/*"Perform"*/]);
        return;
    }
...
// public sealed class Reload :654
// {
...
// public generated Reload() :654
void Reload__ctor_3_fn(Reload* __this)
{
    __this->ctor_3();
}

// private override sealed void Execute(Fuse.Controls.WebView webview) :656
...
// public generated Reload New() :654
void Reload__New2_fn(Reload** __retval)
{
    *__retval = Reload::New2();
}

// public generated Reload() [instance] :654
void Reload::ctor_3()
{
    ctor_2();
}

// public generated Reload New() [static] :654
Reload* Reload::New2()
{
...
// public sealed class StopLoading :666
// {
...
// public generated StopLoading() :666
void StopLoading__ctor_3_fn(StopLoading* __this)
{
    __this->ctor_3();
}

// private override sealed void Execute(Fuse.Controls.WebView webview) :668
...
// public generated StopLoading New() :666
void StopLoading__New2_fn(StopLoading** __retval)
{
    *__retval = StopLoading::New2();
}

// public generated StopLoading() [instance] :666
void StopLoading::ctor_3()
{
    ctor_2();
}

// public generated StopLoading New() [static] :666
...
static void TriggerAction_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\0.44.1\\actions\\$.uno");
...
{
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[13/*"Use `Trigge...*/], this, ::STRINGS[14/*"C:\\Users\\...*/], 853, ::STRINGS[15/*"set_Direction"*/]);
    When(value);
}
...
// public abstract class WebViewNavAction :632
// {
...
// internal WebViewNavAction() [instance] :634
