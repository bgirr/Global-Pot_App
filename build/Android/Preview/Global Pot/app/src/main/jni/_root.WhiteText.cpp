// This file was generated based on 'F:\Global Pot_App\build\Android\Preview\cache\ux11\WhiteText.g.uno'.
...
// public partial sealed class WhiteText :2
// {
// static WhiteText() :4
static void WhiteText__cctor_4_fn(uType* __type)
{
}

static void WhiteText_build(uType* type)
{
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)WhiteText__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* WhiteText_typeof()
{
    ...
    options.ObjectSize = sizeof(WhiteText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("WhiteText", options);
    type->fp_build_ = WhiteText_build;
    type->fp_ctor_ = (void*)WhiteText__New4_fn;
    type->fp_cctor_ = WhiteText__cctor_4_fn;
...
// public WhiteText() :8
void WhiteText__ctor_8_fn(WhiteText* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void WhiteText__InitializeUX_fn(WhiteText* __this)
{
    __this->InitializeUX();
}

// public WhiteText New() :8
void WhiteText__New4_fn(WhiteText** __retval)
{
    *__retval = WhiteText::New4();
}

// public WhiteText() [instance] :8
void WhiteText::ctor_8()
{
    ctor_7();
    InitializeUX();
}
...
void WhiteText::InitializeUX()
{
    uStackFrame __("WhiteText", "InitializeUX()");
    TextColor(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
}

// public WhiteText New() [static] :8
WhiteText* WhiteText::New4()
{
    WhiteText* obj1 = (WhiteText*)uNew(WhiteText_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
