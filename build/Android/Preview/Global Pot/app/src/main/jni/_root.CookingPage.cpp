...
static void CookingPage_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)CookingPage__New5_fn, 0, true, type, 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
// public CookingPage(Fuse.Navigation.Router router) :392
void CookingPage__ctor_8_fn(CookingPage* __this, ::g::Fuse::Navigation::Router* router1)
{
    __this->ctor_8(router1);
}

// private void InitializeUX() :398
void CookingPage__InitializeUX_fn(CookingPage* __this)
{
    __this->InitializeUX();
}

// public CookingPage New(Fuse.Navigation.Router router) :392
...
// public CookingPage(Fuse.Navigation.Router router) [instance] :392
void CookingPage::ctor_8(::g::Fuse::Navigation::Router* router1)
{
    uStackFrame __("CookingPage", ".ctor(Fuse.Navigation.Router)");
    ctor_7();
    router = router1;
    InitializeUX();
}

// private void InitializeUX() [instance] :398
void CookingPage::InitializeUX()
{
    uStackFrame __("CookingPage", "InitializeUX()");
    ...
    ::g::Fuse::Reactive::DataBinding* temp22 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[1/*Fuse.Reactive.DataBinding<object>*/], temp_Items_inst, ::STRINGS[9/*"recipe.steps"*/]);
    ...
    temp6->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::Recipes_APIeb7d723d()));
    ...
    temp11->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::leftarrowcb43f68b()));
    ...
    temp17->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::Recipe_API1e1be570()));
    ...
    temp27->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::Refreshee13cb15()));
    ...
    temp29->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::logo_v026ae4f6da()));
...
// public CookingPage New(Fuse.Navigation.Router router) [static] :392
