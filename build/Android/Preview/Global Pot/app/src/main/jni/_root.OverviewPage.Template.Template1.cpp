...
{
    OverviewPage__Template__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Url"*/]);
    OverviewPage__Template__Template1::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Right"*/]);
    OverviewPage__Template__Template1::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"__gen0"*/]);
}
...
static void OverviewPage__Template__Template1_build(uType* type)
{
    ...
    type->SetFields(2,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::OverviewPage__Template__Template1, __gen1_Right_inst1), 0,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::OverviewPage__Template__Template1, self_Url_inst), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::OverviewPage__Template__Template1::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::OverviewPage__Template__Template1::__selector1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::OverviewPage__Template__Template1::__selector2_, uFieldFlagsStatic);
...
void OverviewPage__Template__Template1__New1_fn(OverviewPage__Template__Template1* __this, uObject** __retval)
{
    ...
    __this->self_Url_inst = ::g::GlobalPot_FuseControlsImage_Url_Property::New1(self, OverviewPage__Template__Template1::__selector0());
    ::g::Uno::UX::StringConcatOperator* __gen11 = ::g::Uno::UX::StringConcatOperator::New2();
    __this->__gen1_Right_inst1 = ::g::GlobalPot_UnoUXStringConcatOperator_Right_Property::New1(__gen11, OverviewPage__Template__Template1::__selector1());
    ...
    self->Margin(::g::Uno::Float4__New2(5.0f, 0.0f, 0.0f, 0.0f));
    self->Name(OverviewPage__Template__Template1::__selector2());
...
::g::Uno::UX::Selector OverviewPage__Template__Template1::__selector1_;
::g::Uno::UX::Selector OverviewPage__Template__Template1::__selector2_;
