...
::g::Fuse::Text::SinglyLinkedList* Runs::GetVisual(::g::Fuse::Text::SinglyLinkedList* run)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert4 >= 1, ::STRINGS[0/*"ranges.Coun...*/], ::STRINGS[1/*"C:\\Users\\...*/], 111, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert4), uBox<int>(::g::Uno::Int_typeof(), 1)));
...
::g::Uno::Collections::List* Runs::GetVisual1(::g::Uno::Collections::List* runs)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == assert2, ::STRINGS[2/*"result.Coun...*/], ::STRINGS[1/*"C:\\Users\\...*/], 58, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), assert2)));
    return result;
}
...
void Runs::MergeRange(::g::Uno::Collections::Stack* ranges, Runs__Range* range)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert5 >= 1, ::STRINGS[0/*"ranges.Coun...*/], ::STRINGS[1/*"C:\\Users\\...*/], 131, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert5), uBox<int>(::g::Uno::Int_typeof(), 1)));
    Runs__Range* previous = (::g::Uno::Collections::Stack__Peek_fn(ranges, &ret12), ret12);
    ::g::Uno::Diagnostics::Debug::Assert(uPtr(previous)->Level < uPtr(range)->Level, ::STRINGS[3/*"previous.Le...*/], ::STRINGS[1/*"C:\\Users\\...*/], 135, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), uPtr(previous)->Level), uBox<int>(::g::Uno::Int_typeof(), uPtr(range)->Level)));
