...
{
    uStackFrame __("GlobalPot_FuseEffectsDropShadow_Distance_Property", "Get()");
...
{
    uStackFrame __("GlobalPot_FuseEffectsDropShadow_Distance_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
