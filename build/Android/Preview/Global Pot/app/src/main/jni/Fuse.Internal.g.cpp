...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\0.44.1\\internal\\$.uno");
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[2/*"ResampleMod...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 255, ::STRINGS[4/*"set_Resampl...*/]);
