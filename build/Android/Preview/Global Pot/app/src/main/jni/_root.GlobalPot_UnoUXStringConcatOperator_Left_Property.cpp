...
static void GlobalPot_UnoUXStringConcatOperator_Left_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::g::Uno::UX::StringConcatOperator_typeof(), offsetof(::g::GlobalPot_UnoUXStringConcatOperator_Left_Property, _obj), 0);
}
...
::g::Uno::UX::Property1_type* GlobalPot_UnoUXStringConcatOperator_Left_Property_typeof()
{
    ...
    options.ObjectSize = sizeof(GlobalPot_UnoUXStringConcatOperator_Left_Property);
    options.TypeSize = sizeof(::g::Uno::UX::Property1_type);
    type = (::g::Uno::UX::Property1_type*)uClassType::New("GlobalPot_UnoUXStringConcatOperator_Left_Property", options);
    type->fp_build_ = GlobalPot_UnoUXStringConcatOperator_Left_Property_build;
    type->fp_Get = (void(*)(::g::Uno::UX::Property1*, uTRef))GlobalPot_UnoUXStringConcatOperator_Left_Property__Get_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))GlobalPot_UnoUXStringConcatOperator_Left_Property__get_Object_fn;
    type->fp_Set = (void(*)(::g::Uno::UX::Property1*, void*, uObject*))GlobalPot_UnoUXStringConcatOperator_Left_Property__Set_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::Property*, bool*))GlobalPot_UnoUXStringConcatOperator_Left_Property__get_SupportsOriginSetter_fn;
    return type;
}
