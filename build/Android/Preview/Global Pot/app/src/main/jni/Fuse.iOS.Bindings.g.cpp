...
// internal sealed class Blitter :899
// {
// static Blitter() :899
...
// public generated Blitter() :899
void Blitter__ctor__fn(Blitter* __this)
{
    __this->ctor_();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Visual where, texture2D vt, float2 pos, float2 size) :903
...
// private generated void init_DrawCalls() :899
void Blitter__init_DrawCalls_fn(Blitter* __this)
{
    __this->init_DrawCalls();
}

// public generated Blitter New() :899
...
// public generated Blitter() [instance] :899
void Blitter::ctor_()
{
    init_DrawCalls();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Visual where, texture2D vt, float2 pos, float2 size) [instance] :903
...
// private generated void init_DrawCalls() [instance] :899
void Blitter::init_DrawCalls()
{
    ...
    _draw_f3eb9bce = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControls_bundle::Viewport78c30fd2());
}

// public generated Blitter New() [static] :899
