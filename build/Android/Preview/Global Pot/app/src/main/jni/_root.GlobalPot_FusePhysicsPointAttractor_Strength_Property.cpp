...
{
    uStackFrame __("GlobalPot_FusePhysicsPointAttractor_Strength_Property", "Get()");
...
{
    uStackFrame __("GlobalPot_FusePhysicsPointAttractor_Strength_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
