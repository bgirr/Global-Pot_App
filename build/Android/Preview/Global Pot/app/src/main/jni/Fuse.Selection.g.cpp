...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Selection\0.42.4\$.uno
// ------------------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\0.42.4\\$.uno");
...
{
    ::g::Fuse::Diagnostics::InternalError(message, __this, ::STRINGS[5/*"C:\\Users\\...*/], 889, ::STRINGS[21/*"Fuse.Script...*/]);
}
...
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"`Values` mu...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 796, ::STRINGS[32/*"set_Values"*/]);
        return;
    }
...
void SelectionEvent__OnRooted_fn(SelectionEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 237, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"Unable to l...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 953, ::STRINGS[36/*"Perform"*/]);
        return;
    }
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    if (!::g::Fuse::Selection::Selection::TryFindSelectable(__this->Parent(), &__this->_selectable, &__this->_selection))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 1002, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
