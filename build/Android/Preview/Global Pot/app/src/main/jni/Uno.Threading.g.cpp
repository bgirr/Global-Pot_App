...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Uno.Threading\0.44.5\$.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Uno.Threading\0.44.5\tasks\$.uno
// -----------------------------------------------------------------------------------------
...
// private sealed class ThreadPool.DefaultWorkItem :1055
// {
...
// public DefaultWorkItem New(Uno.Action action) :1059
...
// public DefaultWorkItem(Uno.Action action) [instance] :1059
...
// public DefaultWorkItem New(Uno.Action action) [static] :1059
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\UnoCore\0.44.5\source\uno\threading\$.uno
// --------------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Uno.Threading\0.44.5\implementation\cpp\$.uno
// ------------------------------------------------------------------------------------------------------
...
// private sealed class ThreadPool.ParameterizedWorkItem<TState> :1071
// {
...
// public override sealed void Invoke() :1082
...
// public sealed class Thread :958
// {
static void Thread_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction(".ctor", NULL, (void*)Thread__New1_fn, 0, true, type, 1, ::g::Uno::Threading::ThreadStart_typeof()),
...
// public Thread(Uno.Threading.ThreadStart start) :964
void Thread__ctor__fn(Thread* __this, uDelegate* start)
{
    __this->ctor_(start);
}

// public static Uno.Threading.Thread get_CurrentThread() :1015
void Thread__get_CurrentThread_fn(Thread** __retval)
{
    *__retval = Thread::CurrentThread();
}

// public void Join() :998
void Thread__Join_fn(Thread* __this)
{
    __this->Join();
}

// public Thread New(Uno.Threading.ThreadStart start) :964
void Thread__New1_fn(uDelegate* start, Thread** __retval)
{
    *__retval = Thread::New1(start);
}

// public static void Sleep(int millis) :1026
void Thread__Sleep_fn(int* millis)
{
    Thread::Sleep(*millis);
}

// public void Start() :983
void Thread__Start_fn(Thread* __this)
{
    __this->Start();
}

// public Thread(Uno.Threading.ThreadStart start) [instance] :964
void Thread::ctor_(uDelegate* start)
{
...
// public void Join() [instance] :998
void Thread::Join()
{
    uStackFrame __("Uno.Threading.Thread", "Join()");

    if (!_started)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[3/*"Thread has ...*/]));

    ::g::Uno::Threading::PthreadHelpers::JoinThread(_threadHandle);
}

// public void Start() [instance] :983
void Thread::Start()
{
    uStackFrame __("Uno.Threading.Thread", "Start()");

    if (_started)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[4/*"Thread is r...*/]));

    _threadHandle = ::g::Uno::Threading::PthreadHelpers::CreateThread(this);
    _started = true;
}

// public Thread New(Uno.Threading.ThreadStart start) [static] :964
Thread* Thread::New1(uDelegate* start)
{
...
// public static void Sleep(int millis) [static] :1026
void Thread::Sleep(int millis)
{
    ::g::Uno::Threading::PthreadHelpers::Sleep(millis);
}

// public static Uno.Threading.Thread get_CurrentThread() [static] :1015
Thread* Thread::CurrentThread()
{
    return ::g::Uno::Threading::PthreadHelpers::GetCurrentThread();
}
// }
...
// public sealed class ThreadPool :1047
// {
...
void ThreadPool::ctor_(int poolSize)
{
    ...
    {
        ::g::Uno::Threading::Thread* t = ::g::Uno::Threading::Thread::New1(uDelegate::New(::TYPES[21/*Uno.Threading.ThreadStart*/], (void*)ThreadPool__WorkerEntrypoint_fn, this));
        t->Start();
    }
}

// public void Dispose() [instance] :1153
...
// private bool DoTask() [instance] :1126
...
// public void QueueAction(Uno.Action action) [instance] :1137
...
// private void WorkerEntrypoint() [instance] :1113
...
// public ThreadPool New([int poolSize]) [static] :1098
...
// private abstract class ThreadPool.WorkItem :1050
// {
...
// protected generated WorkItem() :1050
void ThreadPool__WorkItem__ctor__fn(ThreadPool__WorkItem* __this)
{
    __this->ctor_();
}

// protected generated WorkItem() [instance] :1050
