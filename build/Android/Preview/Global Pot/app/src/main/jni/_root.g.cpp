...
#include <_root.FuseControlsScrollView_FuseControlsScrollViewBase_KeepFoc-71de0e8f.h>
#include <_root.FuseControlsScrollView_FuseControlsScrollViewBase_UserScr-4a0b4824.h>
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls\0.42.4\.uno\package
// ------------------------------------------------------------------------------------------
...
static void FuseControls_bundle__cctor__fn(uType* __type)
{
    ...
    FuseControls_bundle::SolidRectangle5953675f_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[15/*"uniform mat...*/], ::STRINGS[16/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[23/*"t"*/]));
    FuseControls_bundle::Viewport78c30fd2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[24/*"uniform mat...*/], ::STRINGS[25/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/]));
}
...
static void FuseControls_bundle_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("uniform mat4 q, d;\n"
        ...
        "}\n"
        "");
    ::STRINGS[16] = uString::Const("uniform vec2 m, l;\n"
        "uniform vec4 n;\n"
        "uniform float o, p;\n"
        "\n"
        "uniform sampler2D t;\n"
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseControls_bundle::Viewport78c30fd2_, uFieldFlagsStatic);
    type->Reflection.SetFields(4,
        new uField("SolidRectangle5950675f", 0),
        new uField("SolidRectangle5951675f", 1),
        new uField("SolidRectangle5953675f", 2),
        new uField("Viewport78c30fd2", 3));
}
...
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseControls_bundle::Viewport78c30fd2_;
// }

// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\0.42.4\.uno\package
// -------------------------------------------------------------------------------------------------
...
{
    FuseControlsNative_bundle::Blitter5bfe9814_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[26/*"uniform vec...*/], ::STRINGS[27/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"f"*/]));
}
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Navigation\0.42.4\.uno\ux11\$.uno
// --------------------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\0.42.4\.uno\package
// -----------------------------------------------------------------------------------------------------
...
{
    FuseControlsPrimitives_bundle::ImageElementDraw03922e21_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[28/*"uniform mat...*/], ::STRINGS[29/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
}
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\0.42.4\.uno\ux11\$.uno
// --------------------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\0.42.4\.uno\ux11\$.uno
// --------------------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\0.42.4\.uno\package
// ------------------------------------------------------------------------------------------------
...
{
    FuseControlsVideo_bundle::Scale9Rectanglef8978c7b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[30/*"uniform flo...*/], ::STRINGS[31/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[22/*"q"*/]));
    FuseControlsVideo_bundle::VideoDrawElementd0e853ae_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[32/*"uniform mat...*/], ::STRINGS[33/*"uniform sam...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
}
...
static void FuseControlsVideo_bundle_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseControlsVideo_bundle::VideoDrawElementd0e853ae_, uFieldFlagsStatic);
    type->Reflection.SetFields(2,
        new uField("Scale9Rectanglef8978c7b", 0),
        new uField("VideoDrawElementd0e853ae", 1));
}
...
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseControlsVideo_bundle::VideoDrawElementd0e853ae_;
// }

// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\FuseCore\0.42.4\.uno\package
// -------------------------------------------------------------------------------------
...
{
    FuseCore_bundle::DrawHelpers53a11bf4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[34/*"uniform vec...*/], ::STRINGS[35/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/]));
}
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Drawing\0.42.4\.uno\package
// -----------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Drawing.Polygons\0.42.4\.uno\package
// --------------------------------------------------------------------------------------------------
...
static void FuseDrawingPolygons_bundle__cctor__fn(uType* __type)
{
    ...
    FuseDrawingPolygons_bundle::Border102f669d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[42/*"uniform mat...*/], ::STRINGS[43/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[44/*"s"*/]));
    FuseDrawingPolygons_bundle::Border1032669d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[45/*"uniform mat...*/], ::STRINGS[46/*"varying vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawable91a038cd_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[47/*"uniform mat...*/], ::STRINGS[1/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawablea9a9dafc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[48/*"uniform mat...*/], ::STRINGS[49/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[50/*"r"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawableeef8c432_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[51/*"uniform mat...*/], ::STRINGS[52/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[13/*"j"*/]));
}
...
static void FuseDrawingPolygons_bundle_build(uType* type)
{
    ...
    ::STRINGS[45] = uString::Const("uniform mat4 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[46] = uString::Const("varying vec4 d;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = d;\n"
    ...
    ::STRINGS[1] = uString::Const("uniform vec4 c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[48] = uString::Const("uniform mat4 d;\n"
        "uniform vec2 e, f, g, h, i, k, j;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[49] = uString::Const("uniform vec2 m, l;\n"
        "uniform vec4 n;\n"
        "uniform float o;\n"
        "\n"
        "uniform sampler2D r;\n"
    ...
    ::STRINGS[51] = uString::Const("uniform mat4 b;\n"
        "uniform vec2 c, d, e, g;\n"
        "uniform float h;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[52] = uString::Const("uniform float f;\n"
        "\n"
        "uniform sampler2D j;\n"
        "\n"
        "varying float i;\n"
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Drawing.Primitives\0.42.4\.uno\package
// ----------------------------------------------------------------------------------------------------
...
{
    FuseDrawingPrimitives_bundle::Circle08de7d46_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[53/*"uniform vec...*/], ::STRINGS[54/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[21/*"p"*/]));
    FuseDrawingPrimitives_bundle::Circle0dcbf8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[55/*"uniform vec...*/], ::STRINGS[56/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 26, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[57/*"u"*/], ::STRINGS[58/*"v"*/], ::STRINGS[59/*"w"*/], ::STRINGS[60/*"x"*/], ::STRINGS[61/*"y"*/], ::STRINGS[62/*"C"*/]));
    FuseDrawingPrimitives_bundle::Circle205f8541_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[63/*"uniform vec...*/], ::STRINGS[64/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 21, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[60/*"x"*/]));
    FuseDrawingPrimitives_bundle::Circle3e0df8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[65/*"uniform vec...*/], ::STRINGS[66/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle54d7f8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[67/*"uniform vec...*/], ::STRINGS[68/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circle5628667c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[65/*"uniform vec...*/], ::STRINGS[69/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle65ae6e77_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[70/*"uniform vec...*/], ::STRINGS[71/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 24, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[57/*"u"*/], ::STRINGS[58/*"v"*/], ::STRINGS[59/*"w"*/], ::STRINGS[72/*"A"*/]));
    FuseDrawingPrimitives_bundle::Circle663708ab_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[73/*"uniform vec...*/], ::STRINGS[74/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[44/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle6b9cf8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[55/*"uniform vec...*/], ::STRINGS[75/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 26, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[57/*"u"*/], ::STRINGS[58/*"v"*/], ::STRINGS[59/*"w"*/], ::STRINGS[60/*"x"*/], ::STRINGS[61/*"y"*/], ::STRINGS[62/*"C"*/]));
    FuseDrawingPrimitives_bundle::Circle85b410a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[76/*"uniform vec...*/], ::STRINGS[77/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 10, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/]));
    FuseDrawingPrimitives_bundle::Circle940fd686_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[78/*"uniform vec...*/], ::STRINGS[79/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[50/*"r"*/]));
    FuseDrawingPrimitives_bundle::Circle940fd687_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[80/*"uniform vec...*/], ::STRINGS[81/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[57/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle9aeeb57e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[82/*"uniform vec...*/], ::STRINGS[83/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circleb380f1e1_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[65/*"uniform vec...*/], ::STRINGS[84/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circlec306f9dc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[70/*"uniform vec...*/], ::STRINGS[85/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 24, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[57/*"u"*/], ::STRINGS[58/*"v"*/], ::STRINGS[59/*"w"*/], ::STRINGS[72/*"A"*/]));
    FuseDrawingPrimitives_bundle::Circlec38f9410_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[73/*"uniform vec...*/], ::STRINGS[86/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[44/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circlec977f8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[80/*"uniform vec...*/], ::STRINGS[87/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[57/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circlee03cf8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[67/*"uniform vec...*/], ::STRINGS[88/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circleecb159f0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[89/*"uniform vec...*/], ::STRINGS[90/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circleecb259f0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[89/*"uniform vec...*/], ::STRINGS[91/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circleecb759f0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[92/*"uniform vec...*/], ::STRINGS[93/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/]));
    FuseDrawingPrimitives_bundle::Circlef701f8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[94/*"uniform vec...*/], ::STRINGS[95/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 23, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[57/*"u"*/], ::STRINGS[58/*"v"*/], ::STRINGS[96/*"z"*/]));
    FuseDrawingPrimitives_bundle::Circlef84740e3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[82/*"uniform vec...*/], ::STRINGS[97/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circlef8cfdb17_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[98/*"uniform vec...*/], ::STRINGS[99/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseDrawingPrimitives_bundle::Rectangle00651c5e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[100/*"uniform flo...*/], ::STRINGS[101/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/]));
    FuseDrawingPrimitives_bundle::Rectangle00751c56_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[100/*"uniform flo...*/], ::STRINGS[102/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/]));
    FuseDrawingPrimitives_bundle::Rectangle25324dea_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[103/*"uniform flo...*/], ::STRINGS[104/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/]));
    FuseDrawingPrimitives_bundle::Rectangle3a9f3720_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[105/*"uniform flo...*/], ::STRINGS[106/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[23/*"t"*/]));
    FuseDrawingPrimitives_bundle::Rectangle3d3bf019_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[103/*"uniform flo...*/], ::STRINGS[107/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/]));
    FuseDrawingPrimitives_bundle::Rectangle45b4058e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[108/*"uniform flo...*/], ::STRINGS[109/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[58/*"v"*/]));
    FuseDrawingPrimitives_bundle::Rectangle45b40595_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[108/*"uniform flo...*/], ::STRINGS[110/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[58/*"v"*/]));
    FuseDrawingPrimitives_bundle::Rectangle52a8d94f_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[105/*"uniform flo...*/], ::STRINGS[111/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[23/*"t"*/]));
    FuseDrawingPrimitives_bundle::Rectangle656cd6a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[112/*"uniform flo...*/], ::STRINGS[113/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/]));
    FuseDrawingPrimitives_bundle::Rectangle8b02eec5_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[114/*"uniform flo...*/], ::STRINGS[115/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/]));
    FuseDrawingPrimitives_bundle::Rectangle8b02eec6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[114/*"uniform flo...*/], ::STRINGS[116/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/]));
    FuseDrawingPrimitives_bundle::Rectanglea7edc285_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[112/*"uniform flo...*/], ::STRINGS[117/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/]));
    FuseDrawingPrimitives_bundle::Rectanglecfed64b4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[118/*"uniform flo...*/], ::STRINGS[119/*"uniform vec...*/], 3, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 23, ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[57/*"u"*/], ::STRINGS[58/*"v"*/], ::STRINGS[120/*"B"*/]));
    FuseDrawingPrimitives_bundle::Rectangled051d7f6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[121/*"uniform flo...*/], ::STRINGS[122/*"uniform vec...*/], 3, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 25, ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[57/*"u"*/], ::STRINGS[58/*"v"*/], ::STRINGS[59/*"w"*/], ::STRINGS[60/*"x"*/], ::STRINGS[123/*"D"*/]));
    FuseDrawingPrimitives_bundle::Rectangled051d7fd_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[121/*"uniform flo...*/], ::STRINGS[124/*"uniform vec...*/], 3, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 25, ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[57/*"u"*/], ::STRINGS[58/*"v"*/], ::STRINGS[59/*"w"*/], ::STRINGS[60/*"x"*/], ::STRINGS[123/*"D"*/]));
    FuseDrawingPrimitives_bundle::Rectanglee7f706e3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[118/*"uniform flo...*/], ::STRINGS[125/*"uniform vec...*/], 3, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 23, ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[22/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[23/*"t"*/], ::STRINGS[57/*"u"*/], ::STRINGS[58/*"v"*/], ::STRINGS[120/*"B"*/]));
}
...
static void FuseDrawingPrimitives_bundle_build(uType* type)
{
    ...
    ::STRINGS[18] = uString::Const("m");
    ::STRINGS[21] = uString::Const("p");
    ::STRINGS[55] = uString::Const("uniform vec2 d, e, g, h, i, j, k, m, l;\n"
        "uniform mat4 f;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[56] = uString::Const("uniform vec2 o, n, w, x, y;\n"
        "uniform vec4 p;\n"
    ...
    ::STRINGS[63] = uString::Const("uniform vec2 d, e, g, h, i, j, k, m, l;\n"
        ...
        "}\n"
        "");
    ::STRINGS[64] = uString::Const("uniform vec2 o, n;\n"
        "uniform vec4 p;\n"
    ...
    ::STRINGS[67] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[68] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        "uniform vec2 m, n, o;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 p;\n"
    ...
    ::STRINGS[77] = uString::Const("uniform float e, f, g, h, j;\n"
        ...
        "}\n"
        "");
    ::STRINGS[78] = uString::Const("uniform vec2 b, c, e, f, g, n;\n"
        "uniform mat4 d;\n"
        "uniform float o;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[79] = uString::Const("uniform float h, i, j, k, l, m;\n"
        "\n"
        "uniform sampler2D r;\n"
        "\n"
        "varying float p;\n"
    ...
    ::STRINGS[85] = uString::Const("uniform vec2 o, n, u, v, w;\n"
        ...
        "}\n"
        "");
    ::STRINGS[86] = uString::Const("uniform float h, i, j, k;\n"
        "uniform vec2 n, o, p;\n"
        "\n"
        "uniform sampler2D s;\n"
        "\n"
    ...
    ::STRINGS[87] = uString::Const("uniform float h, i, j, k, l, m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[88] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        "uniform vec2 m, n, o;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 p;\n"
    ...
    ::STRINGS[93] = uString::Const("uniform float e, f, g, h, i, j;\n"
        ...
        "}\n"
        "");
    ::STRINGS[94] = uString::Const("uniform vec2 d, e, g, h, i, j, k, m, l;\n"
        "uniform mat4 f;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[95] = uString::Const("uniform vec2 o, n;\n"
        "uniform vec4 p;\n"
        "uniform float q, r, s, t, u, v;\n"
        "\n"
        "uniform sampler2D z;\n"
        ...
        "}\n"
        "");
    ::STRINGS[96] = uString::Const("z");
    ::STRINGS[97] = uString::Const("uniform float e, f, g, h, j;\n"
        "uniform vec2 k, l, m;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 n;\n"
    ...
    ::STRINGS[100] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[101] = uString::Const("uniform float h, i, j, k, l;\n"
        "uniform vec3 m;\n"
        "\n"
        "varying float n;\n"
        "varying vec2 o, p;\n"
    ...
    ::STRINGS[104] = uString::Const("uniform float h, i, j, l;\n"
        ...
        "}\n"
        "");
    ::STRINGS[105] = uString::Const("uniform float e[d], o;\n"
        ...
        "}\n"
        "");
    ::STRINGS[106] = uString::Const("uniform float k, l, m;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying float p, q;\n"
    ...
    ::STRINGS[110] = uString::Const("uniform float k, l, m, n, o;\n"
        ...
        "}\n"
        "");
    ::STRINGS[111] = uString::Const("uniform float k, l, m;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying float p, q;\n"
    ...
    ::STRINGS[112] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[113] = uString::Const("uniform float h, i, j;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying float l;\n"
        "varying vec2 m, n;\n"
    ...
    ::STRINGS[114] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[115] = uString::Const("uniform float h, i, j, k, l, n;\n"
        "uniform vec3 m;\n"
        "\n"
        "varying float o;\n"
        "varying vec2 p, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[116] = uString::Const("uniform float h, i, j, k, l, n;\n"
        "uniform vec3 m;\n"
        "\n"
        "varying float o;\n"
        "varying vec2 p, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[117] = uString::Const("uniform float h, i, j;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying float l;\n"
        "varying vec2 m, n;\n"
    ...
    ::STRINGS[119] = uString::Const("uniform vec2 r, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[120] = uString::Const("B");
    ::STRINGS[121] = uString::Const("uniform float g[d];\n"
        "uniform vec2 h, j, k, l, m, n, p, o;\n"
        "uniform mat4 i;\n"
        "\n"
        "attribute vec4 a, b;\n"
    ...
    ::STRINGS[124] = uString::Const("uniform vec2 r, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[125] = uString::Const("uniform vec2 r, q;\n"
        "uniform vec4 s;\n"
        "uniform float t, u, v;\n"
        "\n"
        "uniform sampler2D B;\n"
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle00651c5e_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle00751c56_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle25324dea_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle3a9f3720_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle3d3bf019_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle45b4058e_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle45b40595_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle52a8d94f_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle656cd6a6_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle8b02eec5_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangle8b02eec6_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectanglea7edc285_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectanglecfed64b4_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangled051d7f6_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectangled051d7fd_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseDrawingPrimitives_bundle::Rectanglee7f706e3_, uFieldFlagsStatic);
    type->Reflection.SetFields(40,
        ...
        new uField("Rectangle00651c5e", 24),
        new uField("Rectangle00751c56", 25),
        new uField("Rectangle25324dea", 26),
        new uField("Rectangle3a9f3720", 27),
        new uField("Rectangle3d3bf019", 28),
        new uField("Rectangle45b4058e", 29),
        new uField("Rectangle45b40595", 30),
        new uField("Rectangle52a8d94f", 31),
        new uField("Rectangle656cd6a6", 32),
        new uField("Rectangle8b02eec5", 33),
        new uField("Rectangle8b02eec6", 34),
        new uField("Rectanglea7edc285", 35),
        new uField("Rectanglecfed64b4", 36),
        new uField("Rectangled051d7f6", 37),
        new uField("Rectangled051d7fd", 38),
        new uField("Rectanglee7f706e3", 39));
}
...
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle00651c5e_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle00751c56_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle25324dea_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle3a9f3720_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle3d3bf019_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle45b4058e_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle45b40595_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle52a8d94f_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle656cd6a6_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle8b02eec5_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangle8b02eec6_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectanglea7edc285_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectanglecfed64b4_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangled051d7f6_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectangled051d7fd_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseDrawingPrimitives_bundle::Rectanglee7f706e3_;
// }

// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Effects\0.42.4\.uno\package
// -----------------------------------------------------------------------------------------
...
{
    FuseEffects_bundle::Blitterec98f148_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[126/*"uniform mat...*/], ::STRINGS[127/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseEffects_bundle::Blur289a5370_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[24/*"uniform mat...*/], ::STRINGS[25/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/]));
    FuseEffects_bundle::Desaturate1f514108_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[128/*"uniform mat...*/], ::STRINGS[129/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"f"*/]));
    FuseEffects_bundle::EffectHelpers0ae20243_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[130/*"uniform vec...*/], ::STRINGS[131/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 8, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[18/*"m"*/]));
    FuseEffects_bundle::EffectHelpersa4726cf5_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[132/*"attribute v...*/], ::STRINGS[133/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseEffects_bundle::EffectHelpersf4e3f746_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[134/*"uniform vec...*/], ::STRINGS[135/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[23/*"t"*/]));
    FuseEffects_bundle::EffectHelpersf791727a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[136/*"attribute v...*/], ::STRINGS[137/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/]));
    FuseEffects_bundle::Halftone1ff68c3c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[138/*"uniform mat...*/], ::STRINGS[139/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[22/*"q"*/]));
    FuseEffects_bundle::Mask85b813a2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[140/*"uniform mat...*/], ::STRINGS[141/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseEffects_bundle::Maske38913a2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[140/*"uniform mat...*/], ::STRINGS[142/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseEffects_bundle::Maskfa5313a2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[140/*"uniform mat...*/], ::STRINGS[143/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
}
...
static void FuseEffects_bundle_build(uType* type)
{
    ...
    ::STRINGS[129] = uString::Const("uniform float c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[130] = uString::Const("uniform vec2 c, e, f, g;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[131] = uString::Const("uniform float b, d;\n"
        "\n"
        "uniform sampler2D m;\n"
        "\n"
        "varying vec2 h, i, j, k, l;\n"
    ...
    ::STRINGS[132] = uString::Const("attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[133] = uString::Const("uniform float e[b];\n"
        "uniform vec2 f[d];\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseEffects_bundle::Blur289a5370_, uFieldFlagsStatic,
    ...
    type->Reflection.SetFields(11,
        ...
        new uField("EffectHelpersf791727a", 6),
        new uField("Halftone1ff68c3c", 7),
        new uField("Mask85b813a2", 8),
        new uField("Maske38913a2", 9),
        new uField("Maskfa5313a2", 10));
}
...
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseEffects_bundle::Blur289a5370_;
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Elements\0.42.4\.uno\package
// ------------------------------------------------------------------------------------------
...
{
    FuseElements_bundle::CacheHelper6627cb47_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[144/*"uniform vec...*/], ::STRINGS[145/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[10/*"g"*/]));
    FuseElements_bundle::ElementBatch2ee7bdf7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[146/*"uniform mat...*/], ::STRINGS[147/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"f"*/]));
    FuseElements_bundle::ElementDraw14d18f42_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[0/*"uniform mat...*/], ::STRINGS[1/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/]));
    FuseElements_bundle::RepeatBaker259b1803_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[148/*"uniform vec...*/], ::STRINGS[149/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/]));
    FuseElements_bundle::Scale9Rectangle12a651af_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[150/*"uniform flo...*/], ::STRINGS[151/*"uniform vec...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[18/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[20/*"o"*/], ::STRINGS[21/*"p"*/], ::STRINGS[50/*"r"*/]));
}
...
static void FuseElements_bundle_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseElements_bundle::ElementDraw14d18f42_, uFieldFlagsStatic,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseElements_bundle::RepeatBaker259b1803_, uFieldFlagsStatic,
    ...
    type->Reflection.SetFields(5,
        ...
        new uField("RepeatBaker259b1803", 3),
        new uField("Scale9Rectangle12a651af", 4));
}
...
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseElements_bundle::ElementDraw14d18f42_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseElements_bundle::RepeatBaker259b1803_;
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseElements_bundle::Scale9Rectangle12a651af_;
// }

// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Reactive\0.42.4\.uno\package
// ------------------------------------------------------------------------------------------
...
{
    FuseReactive_bundle::es6promiseminb590c71c_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[152/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[153/*"es6-promise...*/]);
    FuseReactive_bundle::Observabledd9ef4b6_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[152/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[154/*"observable-...*/]);
    FuseReactive_bundle::setTimeoutffdf5b0f_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[152/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[155/*"settimeout-...*/]);
}

static void FuseReactive_bundle_build(uType* type)
{
    ::STRINGS[152] = uString::Const("Fuse.Reactive");
    ::STRINGS[153] = uString::Const("es6-promise.min-2f37680e.js");
    ::STRINGS[154] = uString::Const("observable-939c44fe.js");
    ::STRINGS[155] = uString::Const("settimeout-d1321edb.js");
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::es6promiseminb590c71c_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::Observabledd9ef4b6_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::setTimeoutffdf5b0f_, uFieldFlagsStatic);
    type->Reflection.SetFields(3,
        new uField("es6promiseminb590c71c", 0),
        new uField("Observabledd9ef4b6", 1),
        new uField("setTimeoutffdf5b0f", 2));
}
...
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::es6promiseminb590c71c_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::Observabledd9ef4b6_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::setTimeoutffdf5b0f_;
// }

// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Text\0.42.4\.uno\package
// --------------------------------------------------------------------------------------
...
{
    FuseText_bundle::Rendererf7d1bb01_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[156/*"uniform mat...*/], ::STRINGS[157/*"uniform vec...*/], 1, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[4/*"c"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[10/*"g"*/]));
}

static void FuseText_bundle_build(uType* type)
{
    ::STRINGS[156] = uString::Const("uniform mat4 d;\n"
        "\n"
        "attribute vec2 a, b;\n"
        "\n"
        "varying vec2 f;\n"
        ...
        "}\n"
        "");
    ::STRINGS[157] = uString::Const("uniform vec4 e;\n"
        "\n"
        "uniform sampler2D g;\n"
        "\n"
        "varying vec2 f;\n"
    ...
    ::TYPES[0] = ::g::Uno::String_typeof()->Array();
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof(), (uintptr_t)&::g::FuseText_bundle::Rendererf7d1bb01_, uFieldFlagsStatic);
    type->Reflection.SetFields(1,
        new uField("Rendererf7d1bb01", 0));
}
...
uSStrong< ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*> FuseText_bundle::Rendererf7d1bb01_;
// }

// C:\Users\EliteBook-User\AppData\Local\Fusetools\Fuse\App\app-0.31.2.9180\Packages\Outracks.Simulator.Client.Uno\0.1.0\$.uno
// ---------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Fuse\App\app-0.31.2.9180\Packages\Outracks.Simulator.Client.Uno\0.1.0\.uno\package
// ----------------------------------------------------------------------------------------------------------------------------------
...
{
    OutracksSimulatorClientUno_bundle::fight0deb2d7c_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[158/*"Outracks.Si...*/]))->GetFile(::STRINGS[159/*"fight-8c16f...*/]);
}

static void OutracksSimulatorClientUno_bundle_build(uType* type)
{
    ::STRINGS[158] = uString::Const("Outracks.Simulator.Client.Uno");
    ::STRINGS[159] = uString::Const("fight-8c16f395.png");
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::OutracksSimulatorClientUno_bundle::fight0deb2d7c_, uFieldFlagsStatic);
    type->Reflection.SetFields(1,
        new uField("fight0deb2d7c", 0));
}
...
uSStrong< ::g::Uno::IO::BundleFile*> OutracksSimulatorClientUno_bundle::fight0deb2d7c_;
// }

// C:\Users\EliteBook-User\AppData\Local\Fusetools\Fuse\App\app-0.31.2.9180\Packages\Outracks.Simulator.Client.Uno\0.1.0\.uno\ux11\$.uno
// -------------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\UnoCore\0.42.5\.uno\package
// ------------------------------------------------------------------------------------
...
{
    UnoCore_bundle::SdfFontShadere233cf94_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[160/*"uniform mat...*/], ::STRINGS[161/*"uniform flo...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[12/*"i"*/]));
    UnoCore_bundle::SpriteFontShaderf6f3aa43_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[162/*"uniform mat...*/], ::STRINGS[163/*"uniform sam...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[10/*"g"*/]));
}

static void UnoCore_bundle_build(uType* type)
{
    ::STRINGS[160] = uString::Const("uniform mat4 d;\n"
        "\n"
        "attribute vec2 a, b;\n"
        "attribute vec4 c;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[161] = uString::Const("uniform float e, f;\n"
        "\n"
        "uniform sampler2D i;\n"
        "\n"
        "varying vec2 g;\n"
