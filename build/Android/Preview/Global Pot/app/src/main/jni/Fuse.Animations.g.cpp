...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Animations\0.42.4\$.uno
// -------------------------------------------------------------------------------------
...
static void Attractor_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Animations\\0.42.4\\$.uno");
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Resize star...*/], r, ::STRINGS[2/*"C:\\Users\\...*/], 2717, ::STRINGS[18/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[19/*"Resize star...*/], r, ::STRINGS[2/*"C:\\Users\\...*/], 2725, ::STRINGS[18/*".ctor"*/]);
        _valid = false;
        return;
    }
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"Invalid seek"*/], 1, ::STRINGS[2/*"C:\\Users\\...*/], 2866);
        return *__retval = true, void();
    }
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if ((__this->mixHandle == NULL) || (__this->transform == NULL))
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"Invalid seek"*/], 1, ::STRINGS[2/*"C:\\Users\\...*/], 3636);
        return;
    }
