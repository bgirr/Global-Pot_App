...
void RecipePage::InitializeUX()
{
    ...
    temp8->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::Recipes_APIeb7d723d()));
    ...
    temp13->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::leftarrowcb43f68b()));
    ...
    temp16->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::Recipe_API1e1be570()));
