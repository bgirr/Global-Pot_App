...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\0.44.1\rangecontrols\$.uno
// ------------------------------------------------------------------------------------------------------------
...
static void CircularRangeBehavior_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\0.44.1\\rangecontrols\\$.uno");
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Gestures\0.44.1\$.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Gestures\0.44.1\internal\$.uno
// --------------------------------------------------------------------------------------------
...
// public sealed class EdgeSwipeAnimation :1703
// {
...
// protected override sealed void OnRooted() :1728
...
// protected override sealed void OnUnrooted() :1740
...
// public void Disable() [instance] :1757
...
// public Fuse.Gestures.Edge get_Edge() [instance] :1710
...
// public void set_Edge(Fuse.Gestures.Edge value) [instance] :1711
...
// public float get_EdgeThreshold() [instance] :1717
...
// public void set_EdgeThreshold(float value) [instance] :1718
...
// public void Enable() [instance] :1752
...
// public bool get_IsEnabled() [instance] :1764
...
// public void set_IsEnabled(bool value) [instance] :1765
...
// private void OnProgressChanged(object s, double progress) [instance] :1747
...
// public Fuse.Elements.Element get_Target() [instance] :1724
...
// public void set_Target(Fuse.Elements.Element value) [instance] :1725
...
// public generated EdgeSwipeAnimation New() [static] :1703
...
void LinearRangeBehavior__OnRooted_fn(LinearRangeBehavior* __this)
{
    ...
    if (__this->Control == NULL)
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[6/*"RangeControl"*/], __this->Parent(), __this, ::STRINGS[3/*"C:\\Users\\...*/], 418, ::STRINGS[4/*"OnRooted"*/]);
...
static void ScrollableGoto_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\0.44.1\\$.uno");
...
{
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[7/*"Use ScrollT...*/], this, ::STRINGS[8/*"C:\\Users\\...*/], 112, ::STRINGS[9/*".ctor"*/]);
}
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\0.44.1\\$.uno");
    ::STRINGS[4] = uString::Const("OnRooted");
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[13/*"Element"*/], __this->Parent(), __this, ::STRINGS[14/*"C:\\Users\\...*/], 1019, ::STRINGS[4/*"OnRooted"*/]);
        return;
    }
...
// public sealed class WhileHovering :1808
// {
...
// public generated WhileHovering() :1808
void WhileHovering__ctor_5_fn(WhileHovering* __this)
{
    __this->ctor_5();
}

// public generated WhileHovering New() :1808
void WhileHovering__New2_fn(WhileHovering** __retval)
{
    *__retval = WhileHovering::New2();
}

// private void OnIsContextEnabledChanged(object s, object a) :1837
...
// private void OnPointerEntered(object sender, object args) :1826
...
// protected override sealed void OnUnrooted() :1818
...
// public generated WhileHovering() [instance] :1808
void WhileHovering::ctor_5()
{
    ctor_4();
}

// private void OnIsContextEnabledChanged(object s, object a) [instance] :1837
...
// private void OnPointerEntered(object sender, object args) [instance] :1826
void WhileHovering::OnPointerEntered(uObject* sender, uObject* args)
{
    Activate(NULL);
}

// private void OnPointerLeft(object sender, object args) [instance] :1831
void WhileHovering::OnPointerLeft(uObject* sender, uObject* args)
{
    Deactivate();
}

// public generated WhileHovering New() [static] :1808
...
// public sealed class ZoomGesture :1881
// {
...
// protected override sealed void OnEnded() :1915
...
// protected override sealed void OnRooted() :1890
...
// protected override sealed void OnStarted() :1903
...
// protected override sealed void OnUnrooted() :1896
...
// protected override sealed void OnUpdate() :1931
...
// private void OnZoomed(float factor) :1921
void ZoomGesture__OnZoomed_fn(ZoomGesture* __this, float* factor)
{
    __this->OnZoomed(*factor);
}

// public ZoomGesture(Fuse.Elements.InteractiveTransform target) [instance] :1884
...
// public float get_Maximum() [instance] :1942
float ZoomGesture::Maximum()
{
    return _maximum;
}

// public void set_Maximum(float value) [instance] :1943
void ZoomGesture::Maximum(float value)
{
    _maximum = value;
}

// public float get_Minimum() [instance] :1952
float ZoomGesture::Minimum()
{
    return _minimum;
}

// public void set_Minimum(float value) [instance] :1953
void ZoomGesture::Minimum(float value)
{
    _minimum = value;
}

// private void OnZoomed(float factor) [instance] :1921
...
// public ZoomGesture New(Fuse.Elements.InteractiveTransform target) [static] :1884
