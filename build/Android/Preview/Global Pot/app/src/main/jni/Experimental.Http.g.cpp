...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Experimental.Http\0.44.1\$.uno
// ---------------------------------------------------------------------------------------
...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Experimental.Http\\0.44.1\\$.uno");
...
bool Loader::LoadCache(uObject* record)
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log2(e, 1, ::STRINGS[9/*"C:\\Users\\...*/], 853);
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[10/*"Failed load...*/], Uri), 1, ::STRINGS[9/*"C:\\Users\\...*/], 854);
