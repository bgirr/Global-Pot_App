...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/globalpot/GlobalPot");
    jclass entryPointsClass = env->FindClass("com/apps/globalpot/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/apps/globalpot/Display");
