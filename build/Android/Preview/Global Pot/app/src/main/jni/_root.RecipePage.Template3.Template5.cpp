...
void RecipePage__Template3__Template5__New1_fn(RecipePage__Template3__Template5* __this, uObject** __retval)
{
    ...
    ::g::Fuse::Reactive::DataBinding* temp2 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[0/*Fuse.Reactive.DataBinding<string>*/], __this->__gen12_Right_inst1, ::STRINGS[4/*"ingredient....*/]);
    ::g::Fuse::Controls::Panel* temp3 = ::g::Fuse::Controls::Panel::New3();
    ::g::Fuse::Reactive::DataBinding* temp4 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[0/*Fuse.Reactive.DataBinding<string>*/], __this->temp_Value_inst, ::STRINGS[5/*"usedStepLoc...*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__gen111->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp2);
    ...
    temp3->Margin(::g::Uno::Float4__New2(40.0f, 0.0f, 0.0f, 0.0f));
