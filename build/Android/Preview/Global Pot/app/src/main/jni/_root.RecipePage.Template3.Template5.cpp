...
// public partial sealed class RecipePage.Template3.Template5 :299
// {
// static Template5() :313
static void RecipePage__Template3__Template5__cctor__fn(uType* __type)
{
    ...
    RecipePage__Template3__Template5::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"__gen17"*/]);
}
...
static void RecipePage__Template3__Template5_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("__gen17");
    ...
    type->SetFields(2,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::RecipePage__Template3__Template5, __gen17_Url_inst1), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::RecipePage__Template3__Template5, __gen18_Right_inst1), 0,
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)RecipePage__Template3__Template5__New2_fn, 0, true, type, 2, ::g::RecipePage__Template3_typeof(), ::g::Fuse::Controls::Rectangle_typeof()));
}
...
// public Template5(RecipePage.Template3 parent, Fuse.Controls.Rectangle parentInstance) :303
...
// public override sealed object New() :316
void RecipePage__Template3__Template5__New1_fn(RecipePage__Template3__Template5* __this, uObject** __retval)
{
    uStackFrame __("RecipePage.Template3.Template5", "New()");
    ::g::Fuse::Controls::DockPanel* self = ::g::Fuse::Controls::DockPanel::New4();
    ::g::Fuse::Controls::Image* __gen171 = ::g::Fuse::Controls::Image::New3();
    __this->__gen17_Url_inst1 = ::g::GlobalPot_FuseControlsImage_Url_Property::New1(__gen171, RecipePage__Template3__Template5::__selector0());
    ::g::Uno::UX::StringConcatOperator* __gen181 = ::g::Uno::UX::StringConcatOperator::New2();
    __this->__gen18_Right_inst1 = ::g::GlobalPot_UnoUXStringConcatOperator_Right_Property::New1(__gen181, RecipePage__Template3__Template5::__selector1());
    ...
    ::g::Fuse::Reactive::DataBinding* temp5 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[0/*Fuse.Reactive.DataBinding<string>*/], __this->__gen18_Right_inst1, ::STRINGS[4/*"ingredient....*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), __gen171);
    __gen171->MaxWidth(::g::Uno::UX::Size__New1(30.0f, 1));
    __gen171->MaxHeight(::g::Uno::UX::Size__New1(30.0f, 1));
    __gen171->Margin(::g::Uno::Float4__New2(5.0f, 0.0f, 0.0f, 0.0f));
    __gen171->Name(RecipePage__Template3__Template5::__selector3());
    ::g::Fuse::Controls::DockPanel::SetDock(__gen171, 0);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__gen171->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp2);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__gen171->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp5);
    ...
    temp4->Width(1.0f);
    __gen181->Left(::STRINGS[6/*"https://coo...*/]);
    __gen181->Target(__this->__gen17_Url_inst1);
...
// public Template5 New(RecipePage.Template3 parent, Fuse.Controls.Rectangle parentInstance) :303
...
// public Template5(RecipePage.Template3 parent, Fuse.Controls.Rectangle parentInstance) [instance] :303
...
// public Template5 New(RecipePage.Template3 parent, Fuse.Controls.Rectangle parentInstance) [static] :303
