...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\0.42.4\triggers\$.uno
// -------------------------------------------------------------------------------------------------------
...
static void ContainingText_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\0.42.4\\triggers\\$.uno");
...
{
    ctor_5();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[4/*"Use the tri...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 79, ::STRINGS[6/*".ctor"*/]);
}
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\0.42.4\triggers\$.uno
// -------------------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Triggers\0.42.4\actions\$.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls\0.42.4\triggers\$.uno
// --------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Elements\0.42.4\triggers\$.uno
// --------------------------------------------------------------------------------------------
...
static void LayoutAnimation_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\0.42.4\\triggers\\$.uno");
...
void LayoutAnimation__OnRooted_fn(LayoutAnimation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[7/*"LayoutAnima...*/], __this, ::STRINGS[8/*"C:\\Users\\...*/], 228, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
...
static void OnUserEvent_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\0.42.4\\$.uno");
    ::STRINGS[9] = uString::Const("OnRooted");
...
void OnUserEvent__OnRooted_fn(OnUserEvent* __this)
{
    ...
    if (::g::Uno::String::op_Equality(::g::Uno::UX::Selector__op_Implicit1(__this->EventName()), NULL))
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"OnUserEvent...*/], __this, ::STRINGS[11/*"C:\\Users\\...*/], 99, ::STRINGS[9/*"OnRooted"*/]);
    else
    {
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\0.42.4\$.uno
// -------------------------------------------------------------------------------------------
...
static void PageBeginLoading_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.WebView\\0.42.4\\$.uno");
    ::STRINGS[9] = uString::Const("OnRooted");
...
void PageBeginLoading__OnRooted_fn(PageBeginLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[26/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[12/*"WebView"*/], __this->Parent(), __this, ::STRINGS[13/*"C:\\Users\\...*/], 985, ::STRINGS[9/*"OnRooted"*/]);
}
...
void PageLoaded__OnRooted_fn(PageLoaded* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[26/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[12/*"WebView"*/], __this->Parent(), __this, ::STRINGS[13/*"C:\\Users\\...*/], 1044, ::STRINGS[9/*"OnRooted"*/]);
}
...
static void RemovingAnimation_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\0.42.4\\$.uno");
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Double remo...*/], __this, ::STRINGS[15/*"C:\\Users\\...*/], 1306, ::STRINGS[16/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    ...
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Unexpected ...*/], this, ::STRINGS[15/*"C:\\Users\\...*/], 1319, ::STRINGS[18/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\0.42.4\\triggers\\$.uno");
...
void Scrolled__OnRooted_fn(Scrolled* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"Scrolled co...*/], __this, ::STRINGS[21/*"C:\\Users\\...*/], 288, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"reset takes...*/], s, ::STRINGS[21/*"C:\\Users\\...*/], 242, ::STRINGS[19/*"check"*/]);
        return;
    }
...
void State::Goto()
{
    ...
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[25/*"Cannot call...*/], NULL, ::STRINGS[15/*"C:\\Users\\...*/], 1726, ::STRINGS[26/*"Goto"*/]);
        return;
    }
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[28/*"StateGroup....*/], n, ::STRINGS[15/*"C:\\Users\\...*/], 1389, ::STRINGS[29/*"goto_"*/]);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[30/*"Unable to f...*/], name), n, ::STRINGS[15/*"C:\\Users\\...*/], 1369, ::STRINGS[31/*"gotoName"*/]);
        return;
    }
...
void TextInputActionTriggered__OnRooted_fn(TextInputActionTriggered* __this)
{
    ...
    if (__this->_textEdit == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[32/*"TextInputAc...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 126, ::STRINGS[9/*"OnRooted"*/]);
    else
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Timeline.se...*/], n, ::STRINGS[15/*"C:\\Users\\...*/], 2068, ::STRINGS[39/*"playTo"*/]);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Timeline.se...*/], n, ::STRINGS[15/*"C:\\Users\\...*/], 2117, ::STRINGS[41/*"seek"*/]);
        return;
    }
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Navigation\0.42.4\$.uno
// ----------------------------------------------------------------------------------------------
...
static void TransitionGroup_build(uType* type)
{
    ...
    ::STRINGS[47] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\0.42.4\\$.uno");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"Transition ...*/], t, ::STRINGS[47/*"C:\\Users\\...*/], 2202, ::STRINGS[48/*"Root"*/]);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Transition ...*/], t, ::STRINGS[47/*"C:\\Users\\...*/], 2209, ::STRINGS[48/*"Root"*/]);
        return NULL;
    }
...
void Trigger__FuseAnimationsIPlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[53/*"Trigger.OnP...*/], __this, ::STRINGS[15/*"C:\\Users\\...*/], 2517, ::STRINGS[54/*"Fuse.Animat...*/]);
        return;
    }
...
void Trigger::AddContent(::g::Fuse::Node* target)
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[50/*"AddContent ...*/], this, ::STRINGS[15/*"C:\\Users\\...*/], 2403, ::STRINGS[51/*"AddContent"*/]);
        return;
    }
    ...
    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[52/*"Could not l...*/], this), this, ::STRINGS[15/*"C:\\Users\\...*/], 2422, ::STRINGS[51/*"AddContent"*/]);
        return;
    }
...
void WhileContainsText__OnRooted_fn(WhileContainsText* __this)
{
    ...
    if (__this->_value != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"No TextInpu...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 51, ::STRINGS[9/*"OnRooted"*/]);
}
...
void WhilePageLoading__OnRooted_fn(WhilePageLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[26/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[12/*"WebView"*/], __this->Parent(), __this, ::STRINGS[13/*"C:\\Users\\...*/], 763, ::STRINGS[9/*"OnRooted"*/]);
}
...
void WhileScrolled__OnRooted_fn(WhileScrolled* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"Scrolled co...*/], __this, ::STRINGS[21/*"C:\\Users\\...*/], 802, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[58/*"`Pulse` on ...*/], this, ::STRINGS[15/*"C:\\Users\\...*/], 3885, ::STRINGS[59/*"Pulse"*/]);
...
void WhileVisibleInScrollView__OnRooted_fn(WhileVisibleInScrollView* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[60/*"Could not f...*/], __this, ::STRINGS[21/*"C:\\Users\\...*/], 907, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
    ...
    if (__this->_element == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[61/*"Parent must...*/], __this, ::STRINGS[21/*"C:\\Users\\...*/], 914, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }

    if (!uPtr(__this->_element)->HasLayoutIn(__this->_scrollable))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[62/*"Must have a...*/], __this, ::STRINGS[21/*"C:\\Users\\...*/], 920, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
