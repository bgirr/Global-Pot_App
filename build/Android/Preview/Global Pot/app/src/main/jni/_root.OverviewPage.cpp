...
static void OverviewPage_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("login_clicked");
    ::STRINGS[3] = uString::Const("recipes");
    ::STRINGS[4] = uString::Const("TopBar.ux");
    ::STRINGS[5] = uString::Const("Global Pot");
    ::STRINGS[6] = uString::Const("Back");
    ::STRINGS[7] = uString::Const("Overview.ux");
    ::STRINGS[8] = uString::Const("Rezepte");
    ...
    type->SetFields(93,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::OverviewPage, temp_eb1), 0,
...
// public OverviewPage(Fuse.Navigation.Router router) [instance] :98
...
// private void InitializeUX() [instance] :104
void OverviewPage::InitializeUX()
{
    ...
    ::g::Fuse::Controls::Button* temp10 = ::g::Fuse::Controls::Button::New5();
    temp_eb1 = ::g::Fuse::Reactive::EventBinding::New1(::STRINGS[2/*"login_clicked"*/]);
    ::g::Fuse::Drawing::StaticSolidColor* temp11 = ::g::Fuse::Drawing::StaticSolidColor::New2(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
    ::g::Fuse::Drawing::StaticSolidColor* temp12 = ::g::Fuse::Drawing::StaticSolidColor::New2(::g::Uno::Float4__New2(0.0f, 0.2313726f, 0.3490196f, 1.0f));
    ...
    OverviewPage__Template* temp19 = OverviewPage__Template::New2(this, this);
    ::g::Fuse::Reactive::DataBinding* temp20 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[1/*Fuse.Reactive.DataBinding<object>*/], temp_Items_inst, ::STRINGS[3/*"recipes"*/]);
    ::g::Fuse::Drawing::StaticSolidColor* temp21 = ::g::Fuse::Drawing::StaticSolidColor::New2(::g::Uno::Float4__New2(0.0f, 0.2313726f, 0.3490196f, 1.0f));
    ...
    temp5->LineNumber(2);
    temp5->FileName(::STRINGS[4/*"TopBar.ux"*/]);
    temp5->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::Login6d08c768()));
    ...
    temp8->Value(::STRINGS[5/*"Global Pot"*/]);
    ...
    temp10->Text(::STRINGS[6/*"Back"*/]);
    ::g::Fuse::Gestures::Clicked::AddHandler(temp10, uDelegate::New(::TYPES[3/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb1)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp10->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb1);
    temp13->LineNumber(8);
    temp13->FileName(::STRINGS[7/*"Overview.ux"*/]);
    temp13->File(::g::Uno::UX::BundleFileSource::New1(::g::GlobalPot_bundle::Recipes_APIeb7d723d()));
    ...
    temp16->Margin(::g::Uno::Float4__New2(0.0f, 50.0f, 0.0f, 0.0f));
    temp16->Opacity(10.0f);
    ...
    temp17->Value(::STRINGS[8/*"Rezepte"*/]);
    temp17->Color(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
    temp17->Margin(::g::Uno::Float4__New2(5.0f, 0.0f, 0.0f, 10.0f));
...
// public OverviewPage New(Fuse.Navigation.Router router) [static] :98
