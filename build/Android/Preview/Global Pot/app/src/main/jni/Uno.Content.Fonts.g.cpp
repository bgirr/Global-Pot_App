...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\UnoCore\0.44.5\source\uno\content\fonts\$.uno
// ------------------------------------------------------------------------------------------------------
...
static void DefaultTextTransform_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\UnoCore\\0.44.5\\source\\uno\\content\\fonts\\$.uno");
    type->SetFields(0,
...
{
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[1/*"DefaultText...*/], 1, ::STRINGS[2/*"C:\\Users\\...*/], 321);
    return *__retval = __this->_matrix, void();
}
