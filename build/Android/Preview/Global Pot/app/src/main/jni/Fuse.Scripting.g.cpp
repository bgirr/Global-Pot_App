...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Scripting\0.42.4\$.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\FuseCore\0.42.4\scripting\$.uno
// ----------------------------------------------------------------------------------------
...
static void Context_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\FuseCore\\0.42.4\\scripting\\$.uno");
...
double Marshal::ToDouble(uObject* o)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[58/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[7/*"C:\\Users\\...*/], 1024);
        return 0.0;
    }
}
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[76] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting\\0.42.4\\$.uno");
...
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[75/*"this.Contex...*/], ::STRINGS[76/*"C:\\Users\\...*/], 1023, uArray::New(::TYPES[5/*object[]*/], 0));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[110/*"JavaScript ...*/], path), ::STRINGS[111/*" was fixed!"*/]), this, ::STRINGS[76/*"C:\\Users\\...*/], 204, ::STRINGS[112/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[110/*"JavaScript ...*/], path), ::STRINGS[113/*" line "*/]), uBox<int>(::TYPES[38/*int*/], uPtr(e)->LineNumber())), ::STRINGS[114/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[76/*"C:\\Users\\...*/], 214, ::STRINGS[112/*"Require"*/]);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[121/*"Cannot call...*/], __this, ::STRINGS[7/*"C:\\Users\\...*/], 2182, ::STRINGS[122/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[136/*"Unexpected ...*/], this, ::STRINGS[7/*"C:\\Users\\...*/], 1505, ::STRINGS[137/*"SetExclusive"*/]);
        return;
    }
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[69/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[139/*"Failed to s...*/], ex, this, ::STRINGS[7/*"C:\\Users\\...*/], 1517, ::STRINGS[137/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
