...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\FuseCore\0.42.4\input\$.uno
// ------------------------------------------------------------------------------------
...
static void Pointer_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\FuseCore\\0.42.4\\input\\$.uno");
...
bool Pointer::HardCapture(int pointIndex, ::g::Fuse::Visual* node, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[9/*"HardCapture...*/], 1, ::STRINGS[10/*"C:\\Users\\...*/], 1191);
        return false;
    }
...
bool Pointer::SoftCapture(int pointIndex, ::g::Fuse::Visual* softCapturer, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[14/*"SoftCapture...*/], 1, ::STRINGS[10/*"C:\\Users\\...*/], 1100);
        return false;
    }
