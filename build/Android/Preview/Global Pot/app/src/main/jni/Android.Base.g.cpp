...
static void JNI_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\UnoCore\\0.44.5\\targets\\android\\uno\\base\\$.uno");
...
int64_t JNI::GetUnoRef(jobject obj)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"C:\\Users\\...*/], 318, uArray::New(::TYPES[1/*object[]*/], 0));
...
jclass JNI::LoadClass1(JNIEnv* jni, const char* name, bool systemClass)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"C:\\Users\\...*/], 131, uArray::New(::TYPES[1/*object[]*/], 0));
    jclass result;
