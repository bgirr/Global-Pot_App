...
// internal sealed class GlobalPot_UnoUXStringConcatOperator_Right_Property :10
// {
...
// public GlobalPot_UnoUXStringConcatOperator_Right_Property(Uno.UX.StringConcatOperator obj, Uno.UX.Selector name) :13
...
{
    uStackFrame __("GlobalPot_UnoUXStringConcatOperator_Right_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Right(), void();
}

// public GlobalPot_UnoUXStringConcatOperator_Right_Property New(Uno.UX.StringConcatOperator obj, Uno.UX.Selector name) :13
...
{
    uStackFrame __("GlobalPot_UnoUXStringConcatOperator_Right_Property", "Set(string,Uno.UX.IPropertyListener)");
...
// public GlobalPot_UnoUXStringConcatOperator_Right_Property(Uno.UX.StringConcatOperator obj, Uno.UX.Selector name) [instance] :13
...
// public GlobalPot_UnoUXStringConcatOperator_Right_Property New(Uno.UX.StringConcatOperator obj, Uno.UX.Selector name) [static] :13
