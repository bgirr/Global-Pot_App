...
static void Scale9Rectangle_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[9/*ushort[]*/], offsetof(::g::Fuse::Controls::VideoImpl::Scale9Rectangle, Draw_indices_6354424c_1_2_12), 0,
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Video\\0.44.1\\$.uno");
...
void VideoDiskCache::OnTerminating(int newState)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uString*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(VideoDiskCache::_files()), &ret4), ret4); enum1.MoveNext(::TYPES[15/*Uno.Collections.Dictionary<string, string>.Enumerator*/]); )
    {
        ...
        {
            ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[2/*"Deleting te...*/], pair.Value(::TYPES[16/*Uno.Collections.KeyValuePair<string, string>*/])), 1, ::STRINGS[3/*"C:\\Users\\...*/], 910);
...
static void VideoDrawElement_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::VideoDrawElement, _draw_f0526a66), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::VideoDrawElement, Draw_LocalTransform_f0526a66_3_9_2), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::VideoDrawElement, Draw_LocalTransform_f0526a66_3_9_3), 0,
        ::g::Uno::Graphics::VertexBuffer_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::VideoDrawElement, Draw_VertexData_f0526a66_6_2_1), 0,
...
void VideoDrawElement::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* element, ::g::Uno::Float2 offset, ::g::Uno::Float2 size, ::g::Uno::Float2 uvPosition, ::g::Uno::Float2 uvSize, ::g::Uno::Graphics::VideoTexture* tex, int rotation)
{
    ...
    ::g::Uno::Float4x4 LocalTransform_f0526a66_3_9_4 = ::g::Uno::Matrix::Mul10(Draw_LocalTransform_f0526a66_3_9_2, ::g::Uno::Matrix::Scaling1(size.X, size.Y, 1.0f), Draw_LocalTransform_f0526a66_3_9_3, ::g::Uno::Matrix::Translation(offset.X, offset.Y, 0.0f));
    _draw_f0526a66.BlendEnabled(true);
    _draw_f0526a66.DepthTestEnabled(false);
    _draw_f0526a66.CullFace(uPtr(dc)->CullFace());
    _draw_f0526a66.BlendSrcRgb(2);
    _draw_f0526a66.BlendDstRgb(3);
    _draw_f0526a66.BlendDstAlpha(3);
    _draw_f0526a66.Const1(0, rotation);
    _draw_f0526a66.Use();
    _draw_f0526a66.Attrib1(1, 2, Draw_VertexData_f0526a66_6_2_1, 8, 0);
    _draw_f0526a66.Uniform12(2, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[8/*Fuse.IRenderViewport*/])));
    _draw_f0526a66.Uniform2(3, uvSize);
    _draw_f0526a66.Uniform2(4, uvPosition);
    _draw_f0526a66.Uniform12(5, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_f0526a66_3_9_4, uPtr(element)->WorldTransform()) : LocalTransform_f0526a66_3_9_4);
    _draw_f0526a66.Sampler6(6, tex);
    _draw_f0526a66.DrawArrays(6);
}
...
void VideoDrawElement::init_DrawCalls()
{
    ...
    Draw_VertexData_f0526a66_6_2_1 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer3(uArray::Init< ::g::Uno::Float2>(::TYPES[17/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f))), 0);
    Draw_LocalTransform_f0526a66_3_9_2 = ::g::Uno::Matrix::Translation(-::g::Uno::Float2__New1(0.0f).X, -::g::Uno::Float2__New1(0.0f).Y, 0.0f);
    Draw_LocalTransform_f0526a66_3_9_3 = ::g::Uno::Matrix::RotationZ(0.0f);
    _draw_f0526a66 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControlsVideo_bundle::VideoDrawElementd0e853ae());
}
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[5/*"Video error"*/], e, __this, ::STRINGS[3/*"C:\\Users\\...*/], 1081, ::STRINGS[6/*"Fuse.Contro...*/]);
}
...
// private double Fuse.Triggers.IMediaPlayback.get_Duration() :1118
...
// private float Fuse.Triggers.IMediaPlayback.get_Volume() :1106
...
// private void Fuse.Triggers.IMediaPlayback.set_Volume(float value) :1107
...
// private void Fuse.Triggers.IPlayback.PlayTo(double progress) :1127
void VideoVisual__FuseTriggersIPlaybackPlayTo_fn(VideoVisual* __this, double* progress)
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[8/*"IPlayback.P...*/], __this, ::STRINGS[3/*"C:\\Users\\...*/], 1129, ::STRINGS[9/*"Fuse.Trigge...*/]);
}

// private double Fuse.Triggers.IPlayback.get_Progress() :1160
...
// private void Fuse.Triggers.IPlayback.set_Progress(double value) :1161
...
// private void Fuse.Triggers.IPlayback.Resume() :1143
...
// private double Fuse.Triggers.IProgress.get_Progress() :1155
...
// private void Fuse.Triggers.IProgress.add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1171
...
// private void Fuse.Triggers.IProgress.remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1172
...
// private void OnParamChanged(object sender, Uno.EventArgs args) :1201
...
// private void OnProgressChanged() :1176
void VideoVisual__OnProgressChanged_fn(VideoVisual* __this)
{
    __this->OnProgressChanged();
}

// private void OnRenderParamChanged(object sender, Uno.EventArgs args) :1192
...
// private void OnSourceChanged(object sender, Uno.EventArgs args) :1208
...
// private void OnUpdate() :1185
void VideoVisual__OnUpdate_fn(VideoVisual* __this)
{
    __this->OnUpdate();
}

// private generated void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1175
void VideoVisual__add_ProgressChanged_fn(VideoVisual* __this, uDelegate* value)
{
    __this->add_ProgressChanged(value);
}

// private generated void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1175
void VideoVisual__remove_ProgressChanged_fn(VideoVisual* __this, uDelegate* value)
{
    __this->remove_ProgressChanged(value);
}

// private void ResetTriggers() :1223
...
// private void OnParamChanged(object sender, Uno.EventArgs args) [instance] :1201
...
// private void OnProgressChanged() [instance] :1176
...
// private void OnRenderParamChanged(object sender, Uno.EventArgs args) [instance] :1192
...
// private void OnSourceChanged(object sender, Uno.EventArgs args) [instance] :1208
...
// private void OnUpdate() [instance] :1185
...
// private generated void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :1175
...
// private generated void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :1175
...
// private void ResetTriggers() [instance] :1223
