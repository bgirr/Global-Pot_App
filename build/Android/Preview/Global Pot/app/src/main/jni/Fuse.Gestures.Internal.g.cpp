...
static void Swiper_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\0.44.1\\internal\\$.uno");
...
void Swiper::CheckNeedUpdated(bool off)
{
    ...
    for (int i = 0; i < uPtr(_regions)->Count(); ++i)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"incomplete ...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1013, ::STRINGS[2/*"CheckNeedUp...*/]);
