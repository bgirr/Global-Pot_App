...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\0.42.4\textcontrols\fusetextrenderer\$.uno
// ----------------------------------------------------------------------------------------------------------------------------
...
static void TextRenderer_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\0.42.4\\textcontrols\\fusetextrenderer\\$.uno");
...
void TextRenderer::AsyncMeasurementsDone(::g::Fuse::Controls::FuseTextRenderer::CacheState* state)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(_cacheState == NULL, ::STRINGS[2/*"this._cache...*/], ::STRINGS[3/*"C:\\Users\\...*/], 593, uArray::New(::TYPES[7/*object[]*/], 0));
    _cacheState = state;
