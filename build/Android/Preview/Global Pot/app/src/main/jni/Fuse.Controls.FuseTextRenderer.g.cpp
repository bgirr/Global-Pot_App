...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\0.44.1\textcontrols\fusetextrenderer\$.uno
// ----------------------------------------------------------------------------------------------------------------------------
...
static void TextRenderer_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\0.44.1\\textcontrols\\fusetextrenderer\\$.uno");
...
void TextRenderer::AsyncMeasurementsDone(::g::Fuse::Controls::FuseTextRenderer::CacheState* state)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(_cacheState == NULL, ::STRINGS[3/*"this._cache...*/], ::STRINGS[4/*"C:\\Users\\...*/], 606, uArray::New(::TYPES[7/*object[]*/], 0));
    _cacheState = state;
