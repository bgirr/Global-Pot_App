...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\0.42.4\android\$.uno
// --------------------------------------------------------------------------------------------------
...
static void Shape_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Native\\0.42.4\\android\\$.uno");
...
void Shape::SetBrush(::g::Java::Object* shapeDrawable, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[1/*""*/], brush, ::STRINGS[2/*"C:\\Users\\...*/], 1629, ::STRINGS[3/*"SetBrush"*/]);
...
void View::Background(::g::Fuse::Drawing::Brush* value)
{
    ...
    if (value != NULL)
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::g::Uno::Object::ToString(this), value, ::STRINGS[2/*"C:\\Users\\...*/], 3154, ::STRINGS[5/*"set_Backgro...*/]);
    }
...
void View::Transform(::g::Uno::Float4x4 value)
{
    ...
    if (Parent() == NULL)
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition(this, ::STRINGS[6/*" is missing...*/]), 1, ::STRINGS[2/*"C:\\Users\\...*/], 3199);
    else
