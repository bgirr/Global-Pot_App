...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Uno.Net.Sockets\0.44.5\$.uno
// -------------------------------------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "JavaGetLocalAddresses55", "(Lcom/uno/UnoObject;)Z");
