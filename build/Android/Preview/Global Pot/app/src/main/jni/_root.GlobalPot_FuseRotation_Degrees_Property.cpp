...
// public GlobalPot_FuseRotation_Degrees_Property(Fuse.Rotation obj, Uno.UX.Selector name) :13
...
// public override sealed float Get() :15
void GlobalPot_FuseRotation_Degrees_Property__Get_fn(GlobalPot_FuseRotation_Degrees_Property* __this, float* __retval)
{
    uStackFrame __("GlobalPot_FuseRotation_Degrees_Property", "Get()");
    return *__retval = uPtr(__this->_obj)->Degrees(), void();
}

// public GlobalPot_FuseRotation_Degrees_Property New(Fuse.Rotation obj, Uno.UX.Selector name) :13
...
// public override sealed void Set(float v, Uno.UX.IPropertyListener origin) :16
...
{
    uStackFrame __("GlobalPot_FuseRotation_Degrees_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
...
// public GlobalPot_FuseRotation_Degrees_Property(Fuse.Rotation obj, Uno.UX.Selector name) [instance] :13
...
// public GlobalPot_FuseRotation_Degrees_Property New(Fuse.Rotation obj, Uno.UX.Selector name) [static] :13
