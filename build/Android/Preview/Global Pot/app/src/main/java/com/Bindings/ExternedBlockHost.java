...
public class ExternedBlockHost
{
    ...
    public static String GetGUID344()
    {
        return (String) com.foreign.Outracks.Simulator.DeviceInfo.GetGUID344();
    }
    
    public static String GetName345()
    {
        return (String) com.foreign.Outracks.Simulator.DeviceInfo.GetName345();
    }
