...
//    #endif
    {
        return com.apps.globalpot.GlobalPot.RootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.apps.globalpot.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.apps.globalpot.GlobalPot activity = (com.apps.globalpot.GlobalPot)getRootActivity();
