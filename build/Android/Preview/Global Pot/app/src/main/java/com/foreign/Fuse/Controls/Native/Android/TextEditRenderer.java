...
public class TextEditRenderer
{
    ...
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(com.apps.globalpot.GlobalPot.GetRootActivity());
    ...
    {
        android.widget.TextView tv = new android.widget.TextView(com.apps.globalpot.GlobalPot.GetRootActivity());
