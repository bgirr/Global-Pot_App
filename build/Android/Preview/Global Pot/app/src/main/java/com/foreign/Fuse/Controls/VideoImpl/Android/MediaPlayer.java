...
public class MediaPlayer
{
    ...
    {
        android.view.Window window = com.apps.globalpot.GlobalPot.GetRootActivity().getWindow();
        			...
        			try
        			{
        				android.content.pm.ActivityInfo info = com.apps.globalpot.GlobalPot.GetRootActivity().getPackageManager().getActivityInfo(com.apps.globalpot.GlobalPot.GetRootActivity().getComponentName(), 0);
    ...
    public static void LoadAsyncAsset217(final UnoObject _this, final Object handle,final String assetName)
    {
        android.media.MediaPlayer player = (android.media.MediaPlayer)handle;
        			...
        			try
        			{
        				afd = com.apps.globalpot.GlobalPot
        					.GetRootActivity()
        					.getAssets()
        					.openFd(assetName);
        			}
    ...
    public static void Pause1220(final Object handle)
    {
        android.media.MediaPlayer player = (android.media.MediaPlayer)handle;
        			if (player.isPlaying())
        			{
        				android.media.AudioManager am = (android.media.AudioManager)com.apps.globalpot.GlobalPot.GetRootActivity().getSystemService(android.content.Context.AUDIO_SERVICE);
