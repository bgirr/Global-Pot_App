...
//#else
public class GlobalPot extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
//#endif
{
...
//#endif
    ...
    {
    	GlobalPot activity = _appState.CurrentActivity;
...
//#endif
    ...
    public static GlobalPot RootActivity()
    {
        return _appState.CurrentActivity;
    }
