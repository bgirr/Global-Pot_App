...
//#endif
    ...
    public com.apps.globalpot.GlobalPot RootActivity;
    public boolean HasCreated = false;
    public final ActivityState activityState; // one per activity

    private App(com.apps.globalpot.GlobalPot activity)
    {
        activityState = new ActivityState(HasCreated);
        RootActivity = activity;
    }

    public static App Create(com.apps.globalpot.GlobalPot activity)
    {
