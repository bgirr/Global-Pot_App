...
public class ImageView
{
    ...
    public static Object Create78(final Object container)
    {
        android.widget.RelativeLayout relativeLayout = (android.widget.RelativeLayout)container;
        			android.widget.ImageView imageView = new android.widget.ImageView(com.apps.globalpot.GlobalPot.GetRootActivity());
    ...
    {
        android.widget.RelativeLayout relativeLayout = new android.widget.RelativeLayout(com.apps.globalpot.GlobalPot.GetRootActivity());
