...
{
    ::STRINGS[2] = uString::Const("Texture2D");
    ::STRINGS[3] = uString::Const("Texture is immutable and cannot be updated");
    type->SetInterfaces(
...
{
    if (IsDisposed())
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[2/*"Texture2D"*/]));
    else
...
{
    if (Format() == 0)
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[3/*"Texture is ...*/]));
    else
    {
