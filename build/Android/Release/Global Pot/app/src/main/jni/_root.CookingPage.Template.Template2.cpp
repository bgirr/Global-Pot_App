...
// public Template2(CookingPage.Template parent, Fuse.Controls.Panel parentInstance) :112
...
// public override sealed object New() :125
void CookingPage__Template__Template2__New1_fn(CookingPage__Template__Template2* __this, uObject** __retval)
{
    ...
    ::g::Fuse::Reactive::DataBinding* temp2 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[0/*Fuse.Reactive.DataBinding<string>*/], __this->__gen5_Right_inst1, ::STRINGS[4/*"ingredient....*/]);
    ...
    self->MaxWidth(::g::Uno::UX::Size__New1(99.0f, 4));
    temp1->MinWidth(::g::Uno::UX::Size__New1(40.0f, 1));
    temp1->MinHeight(::g::Uno::UX::Size__New1(30.0f, 1));
    temp1->Margin(::g::Uno::Float4__New2(10.0f, 5.0f, 5.0f, 5.0f));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__gen41->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp2);
    ...
    temp->Alignment(9);
    temp->Margin(::g::Uno::Float4__New2(0.0f, 5.0f, 0.0f, 0.0f));
...
// public Template2 New(CookingPage.Template parent, Fuse.Controls.Panel parentInstance) :112
...
// public Template2(CookingPage.Template parent, Fuse.Controls.Panel parentInstance) [instance] :112
...
// public Template2 New(CookingPage.Template parent, Fuse.Controls.Panel parentInstance) [static] :112
