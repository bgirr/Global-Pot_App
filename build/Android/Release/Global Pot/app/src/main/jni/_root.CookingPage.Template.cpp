...
static void CookingPage__Template_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("usedIngs");
...
void CookingPage__Template__New1_fn(CookingPage__Template* __this, uObject** __retval)
{
    ...
    ::g::Fuse::Reactive::DataBinding* temp11 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[2/*Fuse.Reactive.DataBinding<object>*/], __this->temp1_Items_inst, ::STRINGS[16/*"usedIngs"*/]);
