...
{
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"OverviewPage"*/]);
}

static void MainView__Template1_build(uType* type)
{
    ::STRINGS[0] = uString::Const("OverviewPage");
    type->SetFields(2,
...
{
    ::g::OverviewPage* self = ::g::OverviewPage::New5(uPtr(__this->__parent1)->MainRouter);
...
{
    ctor_(::STRINGS[0/*"OverviewPage"*/], false);
    __parent1 = parent;
