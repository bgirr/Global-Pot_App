...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\0.44.1\.uno\package
// -------------------------------------------------------------------------------------------------
...
{
    FuseReactive_bundle::Diagnostics5987d316_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[140/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[141/*"diagnostics...*/]);
    FuseReactive_bundle::es6promisemine43b36df_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[140/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[142/*"es6-promise...*/]);
    FuseReactive_bundle::Observable5d4d0737_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[140/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[143/*"observable-...*/]);
    FuseReactive_bundle::setTimeoutb6c12927_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[140/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[144/*"settimeout-...*/]);
}

static void FuseReactive_bundle_build(uType* type)
{
    ::STRINGS[140] = uString::Const("Fuse.Reactive");
    ::STRINGS[141] = uString::Const("diagnostics-c1dc0a33.js");
    ::STRINGS[142] = uString::Const("es6-promise.min-2da2c24c.js");
    ::STRINGS[143] = uString::Const("observable-48e1b932.js");
    ::STRINGS[144] = uString::Const("settimeout-a74449a4.js");
    type->SetFields(0,
