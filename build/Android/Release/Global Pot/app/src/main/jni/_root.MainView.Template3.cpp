...
{
    MainView__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"CookingPage"*/]);
}

static void MainView__Template3_build(uType* type)
{
    ::STRINGS[0] = uString::Const("CookingPage");
    type->SetFields(2,
...
{
    ::g::CookingPage* self = ::g::CookingPage::New5(uPtr(__this->__parent1)->MainRouter);
...
{
    ctor_(::STRINGS[0/*"CookingPage"*/], false);
    __parent1 = parent;
