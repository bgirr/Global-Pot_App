...
jboolean JNICALL callUno_Fuse_Controls_Native_Android_InputDispatch_OnTouch137(JNIEnv *env,jclass clazz,jobject view,jobject motionEvent,jlong viewPtr,jlong motionEventPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
jboolean JNICALL callUno_Fuse_Platform_SystemUI_firstSizingGet99(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jboolean __jresult;
...
jboolean JNICALL callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet82(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jboolean __jresult;
...
jboolean JNICALL callUno_Uno_Platform_AndroidDisplay__initializedGet52(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jboolean __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI__systemUIStateGet75(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet83(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_GetRealDisplayHeight71(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth90(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet98(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_realHeightGet65(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_realWidthGet64(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jobject JNICALL callUno_Fuse_Platform_SystemUI__keyboardListenerGet62(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
jobject JNICALL callUno_Fuse_Platform_SystemUI_layoutAttachedToGet61(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
jobject JNICALL callUno_Fuse_Platform_SystemUI_RootLayoutGet68(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
jobject JNICALL callUno_Fuse_Platform_SystemUI_SuperLayoutGet66(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
jobject JNICALL callUno_Neovisionaries_WebSocketClient__webSocketGet338(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Android_AppRoot_OnTouchEvent__298(JNIEnv *env,jclass clazz,jobject motionEvent,jlong motionEventPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_motionEvent = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(motionEvent, true);
...
void JNICALL callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar321(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange120(JNIEnv *env,jclass clazz,jobject jthis,jboolean hasFocus)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged180(JNIEnv *env,jclass clazz,jobject jthis,jdouble newProgress)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceChanged187(JNIEnv *env,jclass clazz,jobject jthis,jobject holder,jint f,jint w,jint h,jlong holderPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceCreated188(JNIEnv *env,jclass clazz,jobject jthis,jobject holder,jlong holderPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::Native::Android::SurfaceView* uno_jthis = uCast<::g::Fuse::Controls::Native::Android::SurfaceView*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::Native::Android::SurfaceView_typeof());
...
void JNICALL callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceDestroyed189(JNIEnv *env,jclass clazz,jobject jthis,jobject holder,jlong holderPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::Native::Android::SurfaceView* uno_jthis = uCast<::g::Fuse::Controls::Native::Android::SurfaceView*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::Native::Android::SurfaceView_typeof());
...
void JNICALL callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceRedrawNeeded186(JNIEnv *env,jclass clazz,jobject jthis,jobject holder,jlong holderPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::Native::Android::SurfaceView* uno_jthis = uCast<::g::Fuse::Controls::Native::Android::SurfaceView*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::Native::Android::SurfaceView_typeof());
...
void JNICALL callUno_Fuse_Controls_Native_Android_Switch_OnToggleChanged193(JNIEnv *env,jclass clazz,jobject jthis,jboolean value)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnBuffer256(JNIEnv *env,jclass clazz,jobject jthis,jint percent)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnCompletion254(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnError255(JNIEnv *env,jclass clazz,jobject jthis,jint what,jint extra)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnErrorOccurred268(JNIEnv *env,jclass clazz,jobject jthis,jobject msg)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnFrameAvailable259(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnPrepared253(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddAlias105(JNIEnv *env,jclass clazz,jobject name,jobject to,jint weight)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddFamily103(JNIEnv *env,jclass clazz,jobject name,jobject language,jobject variant)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_name = JniHelper::JavaToUnoString((jstring)name);
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddFont104(JNIEnv *env,jclass clazz,jobject path,jint index,jint weight,jboolean isItalic)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_ThrowUno106(JNIEnv *env,jclass clazz,jobject message)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI__keyboardListenerSet62(JNIEnv *env,jclass clazz,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI__systemUIStateSet75(JNIEnv *env,jclass clazz,jint setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet83(JNIEnv *env,jclass clazz,jint setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_setVal = (int)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_CompensateRootLayoutForSystemUI72(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_cppOnConfigChanged91(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_cppOnTopFrameChanged78(JNIEnv *env,jclass clazz,jint height)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_firstSizingSet99(JNIEnv *env,jclass clazz,jboolean setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet82(JNIEnv *env,jclass clazz,jboolean setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    bool uno_setVal = (bool)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_layoutAttachedToSet61(JNIEnv *env,jclass clazz,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_setVal = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(setVal, true);
...
void JNICALL callUno_Fuse_Platform_SystemUI_OnConfigChanged89(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_OnDestroy88(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_onHideKeyboard100(JNIEnv *env,jclass clazz,jint keyboardHeight,jboolean force)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_onShowKeyboard101(JNIEnv *env,jclass clazz,jint keyboardHeight,jboolean force)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_keyboardHeight = (int)keyboardHeight;
...
void JNICALL callUno_Fuse_Platform_SystemUI_realHeightSet65(JNIEnv *env,jclass clazz,jint setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_setVal = (int)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_realWidthSet64(JNIEnv *env,jclass clazz,jint setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_setVal = (int)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_ResendFrameSizes92(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_RootLayoutSet68(JNIEnv *env,jclass clazz,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_setVal = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(setVal, true);
...
void JNICALL callUno_Fuse_Platform_SystemUI_SuperLayoutSet66(JNIEnv *env,jclass clazz,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_setVal = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(setVal, true);
...
void JNICALL callUno_Fuse_Platform_SystemUI_UpdateStatusBar95(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Neovisionaries_WebSocketClient__webSocketSet338(JNIEnv *env,jclass clazz,jobject jthis,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Neovisionaries::WebSocketClient* uno_jthis = uCast<::g::Neovisionaries::WebSocketClient*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Neovisionaries::WebSocketClient_typeof());
...
void JNICALL callUno_Uno_Collections_List_lt_string_gt__Add56(JNIEnv *env,jclass clazz,jobject jthis,jobject item)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Uno_Platform_AndroidDisplay__initializedSet52(JNIEnv *env,jclass clazz,jboolean setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    bool uno_setVal = (bool)setVal;
...
void JNICALL callUno_Uno_Platform_AndroidDisplay_OnFrameCallback53(JNIEnv *env,jclass clazz,jobject jthis,jdouble currentTime,jdouble deltaTime)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\UnoCore\0.44.5\source\uno\compiler\exporttargetinterop\foreign\android\$.uno
// -------------------------------------------------------------------------------------------------------------------------------------
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Uno_Platform_AndroidDisplay__initializedGet52", (char* const)"()Z", (void *)&callUno_Uno_Platform_AndroidDisplay__initializedGet52},
    {(char* const)"callUno_Uno_Platform_AndroidDisplay__initializedSet52", (char* const)"(Z)V", (void *)&callUno_Uno_Platform_AndroidDisplay__initializedSet52},
    {(char* const)"callUno_Uno_Platform_AndroidDisplay_OnFrameCallback53", (char* const)"(Lcom/uno/UnoObject;DD)V", (void *)&callUno_Uno_Platform_AndroidDisplay_OnFrameCallback53},
    {(char* const)"callUno_Uno_Collections_List_lt_string_gt__Add56", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;)V", (void *)&callUno_Uno_Collections_List_lt_string_gt__Add56},
    {(char* const)"callUno_Fuse_Platform_SystemUI_layoutAttachedToGet61", (char* const)"()Ljava/lang/Object;", (void *)&callUno_Fuse_Platform_SystemUI_layoutAttachedToGet61},
    {(char* const)"callUno_Fuse_Platform_SystemUI_layoutAttachedToSet61", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Platform_SystemUI_layoutAttachedToSet61},
    {(char* const)"callUno_Fuse_Platform_SystemUI__keyboardListenerGet62", (char* const)"()Ljava/lang/Object;", (void *)&callUno_Fuse_Platform_SystemUI__keyboardListenerGet62},
    {(char* const)"callUno_Fuse_Platform_SystemUI_realWidthSet64", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI_realWidthSet64},
    {(char* const)"callUno_Fuse_Platform_SystemUI_realHeightSet65", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI_realHeightSet65},
    {(char* const)"callUno_Fuse_Platform_SystemUI_SuperLayoutGet66", (char* const)"()Ljava/lang/Object;", (void *)&callUno_Fuse_Platform_SystemUI_SuperLayoutGet66},
    {(char* const)"callUno_Fuse_Platform_SystemUI_realHeightGet65", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_realHeightGet65},
    {(char* const)"callUno_Fuse_Platform_SystemUI_realWidthGet64", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_realWidthGet64},
    {(char* const)"callUno_Fuse_Platform_SystemUI_SuperLayoutSet66", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Platform_SystemUI_SuperLayoutSet66},
    {(char* const)"callUno_Fuse_Platform_SystemUI_RootLayoutSet68", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Platform_SystemUI_RootLayoutSet68},
    {(char* const)"callUno_Fuse_Platform_SystemUI_RootLayoutGet68", (char* const)"()Ljava/lang/Object;", (void *)&callUno_Fuse_Platform_SystemUI_RootLayoutGet68},
    {(char* const)"callUno_Fuse_Platform_SystemUI_GetRealDisplayHeight71", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_GetRealDisplayHeight71},
    {(char* const)"callUno_Fuse_Platform_SystemUI_CompensateRootLayoutForSystemUI72", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_CompensateRootLayoutForSystemUI72},
    {(char* const)"callUno_Fuse_Platform_SystemUI__systemUIStateSet75", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI__systemUIStateSet75},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cppOnTopFrameChanged78", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI_cppOnTopFrameChanged78},
    {(char* const)"callUno_Fuse_Platform_SystemUI__systemUIStateGet75", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI__systemUIStateGet75},
    {(char* const)"callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet82", (char* const)"()Z", (void *)&callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet82},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet83", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet83},
    {(char* const)"callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet82", (char* const)"(Z)V", (void *)&callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet82},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet83", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet83},
    {(char* const)"callUno_Fuse_Platform_SystemUI_OnDestroy88", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_OnDestroy88},
    {(char* const)"callUno_Fuse_Platform_SystemUI_OnConfigChanged89", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_OnConfigChanged89},
    {(char* const)"callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth90", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth90},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cppOnConfigChanged91", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_cppOnConfigChanged91},
    {(char* const)"callUno_Fuse_Platform_SystemUI_ResendFrameSizes92", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_ResendFrameSizes92},
    {(char* const)"callUno_Fuse_Platform_SystemUI__keyboardListenerSet62", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Platform_SystemUI__keyboardListenerSet62},
    {(char* const)"callUno_Fuse_Platform_SystemUI_UpdateStatusBar95", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_UpdateStatusBar95},
    {(char* const)"callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet98", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet98},
    {(char* const)"callUno_Fuse_Platform_SystemUI_firstSizingGet99", (char* const)"()Z", (void *)&callUno_Fuse_Platform_SystemUI_firstSizingGet99},
    {(char* const)"callUno_Fuse_Platform_SystemUI_onHideKeyboard100", (char* const)"(IZ)V", (void *)&callUno_Fuse_Platform_SystemUI_onHideKeyboard100},
    {(char* const)"callUno_Fuse_Platform_SystemUI_onShowKeyboard101", (char* const)"(IZ)V", (void *)&callUno_Fuse_Platform_SystemUI_onShowKeyboard101},
    {(char* const)"callUno_Fuse_Platform_SystemUI_firstSizingSet99", (char* const)"(Z)V", (void *)&callUno_Fuse_Platform_SystemUI_firstSizingSet99},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddFamily103", (char* const)"(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddFamily103},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddFont104", (char* const)"(Ljava/lang/String;IIZ)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddFont104},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddAlias105", (char* const)"(Ljava/lang/String;Ljava/lang/String;I)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddAlias105},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_ThrowUno106", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_ThrowUno106},
    {(char* const)"callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange120", (char* const)"(Lcom/uno/UnoObject;Z)V", (void *)&callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange120},
    ...
    {(char* const)"callUno_Fuse_Controls_Native_Android_InputDispatch_OnTouch137", (char* const)"(Ljava/lang/Object;Ljava/lang/Object;JJ)Z", (void *)&callUno_Fuse_Controls_Native_Android_InputDispatch_OnTouch137},
    ...
    {(char* const)"callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged180", (char* const)"(Lcom/uno/UnoObject;D)V", (void *)&callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged180},
    {(char* const)"callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceRedrawNeeded186", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceRedrawNeeded186},
    {(char* const)"callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceChanged187", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;IIIJ)V", (void *)&callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceChanged187},
    {(char* const)"callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceCreated188", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceCreated188},
    {(char* const)"callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceDestroyed189", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceDestroyed189},
    {(char* const)"callUno_Fuse_Controls_Native_Android_Switch_OnToggleChanged193", (char* const)"(Lcom/uno/UnoObject;Z)V", (void *)&callUno_Fuse_Controls_Native_Android_Switch_OnToggleChanged193},
    ...
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnPrepared253", (char* const)"(Lcom/uno/UnoObject;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnPrepared253},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnCompletion254", (char* const)"(Lcom/uno/UnoObject;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnCompletion254},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnError255", (char* const)"(Lcom/uno/UnoObject;II)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnError255},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnBuffer256", (char* const)"(Lcom/uno/UnoObject;I)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnBuffer256},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnFrameAvailable259", (char* const)"(Lcom/uno/UnoObject;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnFrameAvailable259},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnErrorOccurred268", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnErrorOccurred268},
    ...
    {(char* const)"callUno_Fuse_Android_AppRoot_OnTouchEvent__298", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Android_AppRoot_OnTouchEvent__298},
    {(char* const)"callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar321", (char* const)"()V", (void *)&callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar321},
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketGet338", (char* const)"(Lcom/uno/UnoObject;)Ljava/lang/Object;", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketGet338},
    ...
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketSet338", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketSet338},
    };
    int funcCount = 117;
