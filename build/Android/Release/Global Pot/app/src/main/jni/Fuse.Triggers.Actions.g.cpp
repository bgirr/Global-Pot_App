...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\0.44.1\\$.uno");
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\0.44.1\\$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
