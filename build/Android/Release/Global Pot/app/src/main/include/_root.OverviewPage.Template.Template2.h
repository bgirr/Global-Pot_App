...
namespace g{struct OverviewPage__Template__Template2;}
...
struct OverviewPage__Template__Template2 : ::g::Uno::UX::Template
{
    ...
    static ::g::Uno::UX::Selector& __selector0() { return OverviewPage__Template__Template2_typeof()->Init(), __selector0_; }
    static ::g::Uno::UX::Selector __selector1_;
    static ::g::Uno::UX::Selector& __selector1() { return OverviewPage__Template__Template2_typeof()->Init(), __selector1_; }
    static ::g::Uno::UX::Selector __selector2_;
    static ::g::Uno::UX::Selector& __selector2() { return OverviewPage__Template__Template2_typeof()->Init(), __selector2_; }
    ...
    static OverviewPage__Template__Template2* New2(::g::OverviewPage__Template* parent, ::g::Fuse::Controls::StackPanel* parentInstance);
};
// }
