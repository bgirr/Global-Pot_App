...
public class AndroidDisplay
{
    ...
    public static void JavaEnableTicks51(final UnoObject _this)
    {
        final UnoObject display = _this;
                    if (ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay__initializedGet52()) return;
                    ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay__initializedSet52(true);
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= 16)
                    {
                        android.view.Choreographer.getInstance().postFrameCallback(new android.view.Choreographer.FrameCallback()
                        {
                            ...
                            {
                                if (ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay__initializedGet52())
                                ...
                                ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay_OnFrameCallback53((UnoObject)display,(double)currentTime,(double)deltaTime);
                    ...
                    else
                    {
                        ...
                        timeAnimator.setTimeListener(new android.animation.TimeAnimator.TimeListener()
                        {
                            ...
                            {
                                ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay_OnFrameCallback53((UnoObject)display,(double)totalTime / 1000.0,(double)deltaTime / 1000.0);
                            }
                        });
                        timeAnimator.start();
                    }
