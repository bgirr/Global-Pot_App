...
public class WebSocketClient
{
    ...
    {
        WebSocket webSocket = (WebSocket) ExternedBlockHost.callUno_Neovisionaries_WebSocketClient__webSocketGet338(_this);
        			webSocket.sendClose();
    }
    ...
    public static void Create340(final UnoObject _this, final String url,final com.uno.StringArray protocols,final com.foreign.Uno.Action open,final com.foreign.Uno.Action close,final com.foreign.Uno.Action_String error,final com.foreign.Uno.Action_String receiveMessageHandler,final com.foreign.Uno.Action_ByteArray receiveDataHandler)
    {
        try {
        				...
        				ExternedBlockHost.callUno_Neovisionaries_WebSocketClient__webSocketSet338(_this,webSocket,UnoHelper.GetUnoObjectRef(webSocket));
    ...
    {
        //WebSocketJava webSocket = (WebSocketJava) ExternedBlockHost.callUno_Neovisionaries_WebSocketClient__webSocketGet338(_this);
