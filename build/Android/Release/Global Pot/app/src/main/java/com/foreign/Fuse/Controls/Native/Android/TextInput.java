    ...
    public static void AddEditorActionListener204(final UnoObject _this, final Object handle)
    {
        ((android.widget.TextView)handle).setOnEditorActionListener(new android.widget.TextView.OnEditorActionListener() {
        				public boolean onEditorAction(android.widget.TextView v, int actionId, android.view.KeyEvent ke) { 
        					return ExternedBlockHost.callUno_Fuse_Controls_Native_Android_TextInput_OnEditorAction205((UnoObject)_this,(int)actionId);
        				}
        			});
    }
    ...
    public static void AddTextChangedListener206(final UnoObject _this, final Object handle)
    {
        ((android.widget.TextView)handle).addTextChangedListener(new android.text.TextWatcher() {
        				...
        				public void onTextChanged(java.lang.CharSequence cs, int start, int before, int count) {
        					...
        					ExternedBlockHost.callUno_Fuse_Controls_Native_Android_TextInput_OnTextChanged207((UnoObject)_this,(String)str);
        				}
        			});
    }
