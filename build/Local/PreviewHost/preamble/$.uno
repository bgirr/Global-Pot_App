...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("169.254.80.134"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.9"), 12124)}, "F:\\Global Pot_App\\Global Pot.unoproj", GetBundle, new string[] { ""})
{
