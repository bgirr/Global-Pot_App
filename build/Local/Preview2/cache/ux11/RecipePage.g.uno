...
public partial class RecipePage: Fuse.Controls.Page
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public override object New()
        {
            ...
            var temp4 = new Fuse.Reactive.DataBinding<string>(temp_Value_inst, "Rezept.recipeName");
            var temp5 = new Fuse.Drawing.StaticSolidColor(float4(0.2f, 0.2f, 0.2f, 1f));
            var __gen2 = new Template1(this, self);
            var temp6 = new Fuse.Reactive.DataBinding<object>(temp1_Items_inst, "Rezept.images");
    ...
    void InitializeUX()
    {
        ...
        var temp23 = new Fuse.Reactive.DataBinding<object>(temp_Items_inst, "Rezept");
        ...
        var temp28 = new Fuse.Reactive.DataBinding<string>(temp3_Value_inst, "Rezept.steps[0].usedIngs[0].ingredient[0].nameDe");
        var temp29 = new Template3(this, this);
        var middleRectangle1 = new Template4(this, this);
        var temp30 = new Fuse.Reactive.DataBinding<object>(temp4_Items_inst, "Rezept.steps");
        ...
        temp9.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../Recipes_API.js"));
        ...
        temp14.Text = "Back";
        global::Fuse.Gestures.Clicked.AddHandler(temp14, temp_eb3.OnEvent);
        temp14.Bindings.Add(temp_eb3);
        temp17.LineNumber = 8;
