...
public partial class CookingPage: Fuse.Controls.Page
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public partial class Template1: Uno.UX.Template
        {
            ...
            public override object New()
            {
                ...
                var temp2 = new Fuse.Reactive.DataBinding<string>(__gen3_Right_inst, "ingredient.iconUrl");
        ...
        public override object New()
        {
            ...
            var temp14 = new Template1(this, self);
            var temp15 = new Fuse.Reactive.DataBinding<object>(temp1_Items_inst, "usedIngs");
            var temp16 = new Template2(this, self);
            var temp17 = new Fuse.Reactive.DataBinding<object>(temp2_Items_inst, "usedResults");
            var temp18 = new Fuse.Controls.Panel();
            var temp19 = new Fuse.Reactive.DataBinding<string>(temp3_Value_inst, "procedure.nameDe");
            var temp20 = new Fuse.Drawing.StaticSolidColor(float4(0.6313726f, 0.8196079f, 0.9137255f, 1f));
            var notVisited = new Fuse.Controls.Image();
            var notVisitedOverlay = new Fuse.Controls.Image();
            var temp21 = new Fuse.Reactive.DataBinding<Uno.UX.FileSource>(temp4_File_inst, "imageKey");
            var temp22 = new Fuse.Controls.Panel();
            var temp23 = new Fuse.Drawing.StaticSolidColor(float4(0.9254902f, 0.9411765f, 0.9607843f, 1f));
            ...
            var temp29 = new Fuse.Physics.InForceFieldAnimation();
            var temp30 = new Fuse.Animations.Change<float>(visited_Opacity_inst);
            var temp31 = new Fuse.Animations.Change<float>(visitedOverlay_Opacity_inst);
            var temp32 = new Fuse.Physics.InForceFieldAnimation();
            var temp33 = new Fuse.Animations.Rotate();
            var temp34 = new Fuse.Physics.Draggable();
            var temp35 = new Fuse.Physics.WhileDragging();
            var temp36 = new Fuse.Triggers.Actions.BringToFront();
            var temp37 = new Fuse.Animations.Scale();
            var temp38 = new Fuse.Animations.Change<float>(shadow_Distance_inst);
            var temp39 = new Fuse.Animations.Change<float>(shadow_Size_inst);
            ...
            temp5.Children.Add(temp24);
            temp5.Children.Add(temp27);
            temp5.Children.Add(temp29);
            temp5.Children.Add(temp32);
            ...
            temp24.From = 0.1f;
            temp24.To = 0.3f;
            temp24.ForceField = __parent.visitedAttractor;
            ...
            temp29.From = 0.1f;
            temp29.To = 0.3f;
            temp29.ForceField = __parent.notVisitedAttractor;
    ...
    void InitializeUX()
    {
        ...
        var temp36 = new Fuse.Drawing.StaticSolidColor(float4(0.9254902f, 0.9411765f, 0.9607843f, 1f));
