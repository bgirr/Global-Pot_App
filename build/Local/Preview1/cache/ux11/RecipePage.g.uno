...
public partial class RecipePage: Fuse.Controls.Page
{
    ...
    public partial class Template1: Uno.UX.Template
    {
        ...
        public override object New()
        {
            ...
            var temp5 = new Fuse.Reactive.DataBinding<string>(__gen6_Right_inst, "selectedMeasuringUnit.nameDe");
    ...
    void InitializeUX()
    {
        ...
        temp_eb3 = new Fuse.Reactive.EventBinding("cooking_clicked");
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp37, temp_eb3.OnEvent);
        temp37.Children.Add(temp38);
        temp37.Children.Add(temp39);
        temp37.Bindings.Add(temp_eb3);
