...
struct InputDispatch : uObject
{
    ...
    static uSStrong< ::g::ObjC::Object*> _RootView_;
    static uSStrong< ::g::ObjC::Object*>& _RootView() { return InputDispatch_typeof()->Init(), _RootView_; }
    ...
    static void HandleEvent1(::g::ObjC::Object* viewHandle, ::g::Fuse::Visual* origin, ::g::ObjC::Object* uiEvent);
    static bool IsUIControl(::g::ObjC::Object* handle);
    static bool IsUIEvent(::g::ObjC::Object* handle);
