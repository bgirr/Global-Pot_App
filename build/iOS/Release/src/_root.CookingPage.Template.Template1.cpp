...
void CookingPage__Template__Template1__New1_fn(CookingPage__Template__Template1* __this, uObject** __retval)
{
    ...
    ::g::Fuse::Reactive::DataBinding* temp2 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[0/*Fuse.Reactive.DataBinding<string>*/], __this->__gen3_Right_inst1, ::STRINGS[4/*"ingredient....*/]);
