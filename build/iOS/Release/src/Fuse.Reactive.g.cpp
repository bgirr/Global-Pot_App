...
static uType* TYPES[51];

namespace g{
namespace Fuse{
namespace Reactive{

// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Reactive\0.44.1\subscription\$.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\FuseCore\0.44.1\reactive\$.uno
// ---------------------------------------------------------------------------------------
...
static void BindingTypes_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\FuseCore\\0.44.1\\reactive\\$.uno");
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Reactive\0.44.1\$.uno
// -----------------------------------------------------------------------------------
...
static void EventBinding__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive\\0.44.1\\$.uno");
...
void EventBinding__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[9/*"JavaScript ...*/], ex, this, ::STRINGS[10/*"C:\\Users\\...*/], 839, ::STRINGS[11/*"Call"*/]);
        }
        else throw __t;
    }
}
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Reactive\0.44.1\fusejs\$.uno
// ------------------------------------------------------------------------------------------
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[29] = uString::Const("unable to convert value");
...
void DataBinding__PushValue_fn(DataBinding* __this, uObject* newValue)
{
    ...
    else
    {
        ...
        if (newValue != NULL)
            __this->MarkFailed(::STRINGS[29/*"unable to c...*/]);
    }
}
...
bool DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if ((::g::Fuse::Scripting::Marshal__TryConvertTo1_fn(__types[1], newValue, &value, &ret2), ret2))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[10/*"C:\\Users\\...*/], 439, ::STRINGS[30/*"TryPushAsMa...*/]);
        }
...
static void Instantiator_build(uType* type)
{
    ...
    ::TYPES[38] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(3/*IndexOf<Fuse.Node>*/, ::TYPES[6/*Fuse.Node*/], NULL);
    ::TYPES[23] = ::g::Fuse::Scripting::Observable_typeof();
    ::TYPES[22] = ::g::Uno::IDisposable_typeof();
...
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[35/*"Template co...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 1465, ::STRINGS[36/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[37/*"Limit canno...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 1080, ::STRINGS[38/*"set_Limit"*/]);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"Offset cann...*/], this, ::STRINGS[10/*"C:\\Users\\...*/], 1032, ::STRINGS[40/*"set_Offset"*/]);
        value = 0;
    }
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[42/*"JavaScript ...*/], FileName()), ::STRINGS[43/*" fixed!"*/]), this, ::STRINGS[10/*"C:\\Users\\...*/], 1659, ::STRINGS[44/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[45/*"JavaScript ...*/], se, this, ::STRINGS[10/*"C:\\Users\\...*/], 1670, ::STRINGS[44/*"EvaluateMod...*/]);
...
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    while (nt != NULL)
    {
        ...
        {
            argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[47/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(e)));
...
{
    ::STRINGS[27] = uString::Const(".");
    ::STRINGS[48] = uString::Const("Cannot access disposed PathSubscription");
    ::STRINGS[49] = uString::Const("Data binding to '");
    ::STRINGS[50] = uString::Const("': expected single value, got array");
    ::STRINGS[51] = uString::Const("': expected single value, got array of length ");
    ::TYPES[22] = ::g::Uno::IDisposable_typeof();
    ::TYPES[23] = ::g::Fuse::Scripting::Observable_typeof();
    ::TYPES[34] = ::g::Fuse::Scripting::ObjectMirror_typeof();
    ::TYPES[4] = ::g::Uno::Action_typeof();
...
{
    if (_isDisposed)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[48/*"Cannot acce...*/]));
...
void SegmentObserver::OnAdd(uObject* addedValue)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[49/*"Data bindin...*/], _key), ::STRINGS[50/*"': expected...*/])));
}
...
void SegmentObserver::OnNewAll(::g::Fuse::Scripting::ListMirror* values)
{
    ...
    if (uPtr(values)->Length() > 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[49/*"Data bindin...*/], _key), ::STRINGS[51/*"': expected...*/]), uBox<int>(::TYPES[13/*int*/], uPtr(values)->Length()))));
}
...
{
    ::STRINGS[52] = uString::Const("Skipped Exception");
    ::STRINGS[10] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive\\0.44.1\\$.uno");
    ::STRINGS[53] = uString::Const("CheckAndThrow");
    ::STRINGS[54] = uString::Const("ThreadWorked failed");
    ::STRINGS[55] = uString::Const("Run");
    ::STRINGS[56] = uString::Const("Could not create script context");
    ...
    ::TYPES[49] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[50] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[26] = ::g::Uno::Exception_typeof();
    ::TYPES[4] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
...
void ThreadWorker::ctor_()
{
    ...
    _thread = ::g::Uno::Threading::Thread::New1(uDelegate::New(::TYPES[49/*Uno.Threading.ThreadStart*/], (void*)ThreadWorker__Run_fn, this));
    uPtr(_thread)->Start();
    uPtr(_ready)->WaitOne();
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[52/*"Skipped Exc...*/], next, this, ::STRINGS[10/*"C:\\Users\\...*/], 2334, ::STRINGS[53/*"CheckAndThrow"*/]);
...
{
    ::g::Fuse::Platform::Lifecycle::remove_Terminating(uDelegate::New(::TYPES[50/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[54/*"ThreadWorke...*/], e, this, ::STRINGS[10/*"C:\\Users\\...*/], 2210, ::STRINGS[55/*"Run"*/]);
...
void ThreadWorker::RunInner()
{
...

    {
...

        {
            ...
            if (ThreadWorker::_context_ == NULL)
            {
                ...
                if (ThreadWorker::_context_ == NULL)
                    U_THROW(::g::Uno::Exception::New2(::STRINGS[56/*"Could not c...*/]));
    ...
    while (true)
    {
        ...
        if (!_subscribedForClosing)
        {
            ...
            {
                ::g::Fuse::Platform::Lifecycle::add_Terminating(uDelegate::New(::TYPES[50/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
