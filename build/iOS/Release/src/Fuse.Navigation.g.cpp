...
void NavigateToggle__Perform1_fn(NavigateToggle* __this, uObject* ctx, ::g::Fuse::Node* n)
{
    ...
    if (page != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"No Page was...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4169, ::STRINGS[2/*"Perform"*/]);
}
...
uObject* Navigation::TryFindBaseNavigation1(::g::Fuse::Node* node, ::g::Fuse::Visual** parent)
{
    ...
    *parent = NULL;
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"TryFindBase...*/], node, ::STRINGS[1/*"C:\\Users\\...*/], 851, ::STRINGS[12/*"TryFindBase...*/]);
        return NULL;
    }
...
::g::Fuse::Visual* Navigation::TryFindPage(::g::Fuse::Node* node, uObject** nav, ::g::Fuse::Visual** pageBind)
{
    ...
    *pageBind = NULL;
    ...
    if (!uPtr(node)->IsRootingStarted())
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[13/*"TryFindPage...*/], node, ::STRINGS[1/*"C:\\Users\\...*/], 912, ::STRINGS[14/*"TryFindPage"*/]);
        return NULL;
    }
                ...
                *pageBind = v;
                ...
                if (uPtr(p)->IsRootingStarted())
                {
                    *nav = Navigation::TryFind(p);
                    ...
                    if (*nav == NULL)
                    {
                        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[15/*"`Page` set ...*/], p, ::STRINGS[1/*"C:\\Users\\...*/], 933, ::STRINGS[14/*"TryFindPage"*/]);
                        return NULL;
                    }
                }
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Got an unde...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1063, ::STRINGS[17/*"OnPageRooti...*/]);
        return;
    }
...
void NavigationPageProxy::Rooted(::g::Fuse::Visual* source)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Attempting ...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1026, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
    ...
    if (Page() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"Unable to l...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1033, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[21/*"Something w...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1050, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
...
void NavigationTriggerAction__Perform_fn(NavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (ctx == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"No navigati...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4065, ::STRINGS[2/*"Perform"*/]);
        return;
    }
...
Route* Route::SubDepth(int count)
{
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[27/*"count can't...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1883, ::STRINGS[28/*"SubDepth"*/]);
        return NULL;
    }
...
static void Router_build(uType* type)
{
    ...
    ::STRINGS[66] = uString::Const("style");
    ::STRINGS[67] = uString::Const("Cannot pop() - history is empty");
    ::STRINGS[68] = uString::Const("Pop");
    ::STRINGS[69] = uString::Const("Invalid outlet depth in prepare progress");
    ::STRINGS[70] = uString::Const("SetPrepareProgress");
    ::STRINGS[71] = uString::Const("Unable to navigate to route: ");
    ::STRINGS[72] = uString::Const("SetRoute");
    ::STRINGS[73] = uString::Const("No router outlet found to handle route: ");
    ::STRINGS[74] = uString::Const("SetRouteImpl");
    ::STRINGS[75] = uString::Const("SubRoute requested but outlet has no active path: ");
    ::STRINGS[76] = uString::Const("Route parameter must be serializeable, it contains reference loops or is too large");
    ::STRINGS[77] = uString::Const("ValidateParameter");
    ::STRINGS[78] = uString::Const("Route parameter must be serializeable, cannot contain Observables.");
    ::STRINGS[79] = uString::Const("Route parameter must be serializeable, cannot contain functions.");
    ...
    type->SetFields(13,
        ...
        ::TYPES[37/*string*/], offsetof(::g::Fuse::Navigation::Router, _prepareOperationStyle), 0,
...
void Router::CancelNavigation()
{
    if (_prepareOutlet != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[46/*"No active n...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2779, ::STRINGS[47/*"CancelNavig...*/]);
}
...
void Router::Modify(int how, ::g::Fuse::Navigation::Route* route, int mode, uString* operationStyle)
{
    ...
    switch (how)
    {
        ...
        {
            if (route != NULL)
                ::g::Fuse::Diagnostics::UserWarning(::STRINGS[58/*"PrepareBack...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2599, ::STRINGS[59/*"Modify"*/]);

            if (uPtr(_history)->Count() == 0)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[60/*"There is no...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2603, ::STRINGS[59/*"Modify"*/]);
                return;
            }
...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"Cannot pop(...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2681, ::STRINGS[68/*"Pop"*/]);
        return;
    }
...
void Router::SetPrepareProgress(double value)
{
    ...
    if ((pc == NULL) || (pn == NULL))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[69/*"Invalid out...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2760, ::STRINGS[70/*"SetPrepareP...*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, uString* operationStyle, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        uString* msg = ::g::Uno::String::op_Addition2(::STRINGS[71/*"Unable to n...*/], uPtr(r)->Format());

        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"C:\\Users\\...*/], 2797, ::STRINGS[72/*"SetRoute"*/]);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"C:\\Users\\...*/], 2799, ::STRINGS[72/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation, uString* operationStyle, uObject** majorChange)
{
    *majorChange = NULL;
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[73/*"No router o...*/], r), this, ::STRINGS[1/*"C:\\Users\\...*/], 2818, ::STRINGS[74/*"SetRouteImpl"*/]);
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[75/*"SubRoute re...*/], r), this, ::STRINGS[1/*"C:\\Users\\...*/], 2844, ::STRINGS[74/*"SetRouteImpl"*/]);
            return NULL;
        }
        else
        {
...
void Router::Bookmark(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[37/*"`Router.boo...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2180, ::STRINGS[38/*"Bookmark"*/]);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"`Router.boo...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2187, ::STRINGS[38/*"Bookmark"*/]);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[40/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[41/*"Could not f...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2211, ::STRINGS[38/*"Bookmark"*/]);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[42/*"path"*/]))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"`path` shou...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2220, ::STRINGS[38/*"Bookmark"*/]);
                return;
            }
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[44/*"Unrecognize...*/], p), r, ::STRINGS[1/*"C:\\Users\\...*/], 2228, ::STRINGS[38/*"Bookmark"*/]);
            return;
        }
    }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"A `name` is...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2241, ::STRINGS[38/*"Bookmark"*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::GetRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[48/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 1998, ::STRINGS[49/*"GetRelative"*/]);
        return NULL;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[50/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2006, ::STRINGS[49/*"GetRelative"*/]);
        return NULL;
    }
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"Router.getR...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2333, ::STRINGS[52/*"GetRoute"*/]);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[53/*"Router.getR...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2339, ::STRINGS[52/*"GetRoute"*/]);
        return;
    }
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Router.goBa...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2053, ::STRINGS[55/*"GoBack"*/]);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 1945, ::STRINGS[57/*"Goto"*/]);
}
...
void Router::Modify1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[42/*"path"*/]))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"`path` shou...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2125, ::STRINGS[59/*"Modify"*/]);
                return;
            }
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[40/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[41/*"Could not f...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2137, ::STRINGS[59/*"Modify"*/]);
                return;
            }
        }
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[29/*"bookmark"*/]))
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[65/*"Unknown boo...*/], bk), r, ::STRINGS[1/*"C:\\Users\\...*/], 2150, ::STRINGS[59/*"Modify"*/]);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[66/*"style"*/]))
            style = (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[29/*Fuse.Scripting.Marshal.ToType<string>*/], o, &ret10), ret10);
        else
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[44/*"Unrecognize...*/], p), r, ::STRINGS[1/*"C:\\Users\\...*/], 2160, ::STRINGS[59/*"Modify"*/]);
            return;
        }
    }
...
bool Router::ValidateParameter(::g::Fuse::Scripting::Context* c, uObject* arg, int depth)
{
    ...
    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[76/*"Route param...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2252, ::STRINGS[77/*"ValidatePar...*/]);
        return false;
    }
    ...
    if (uIs(arg, ::TYPES[28/*Fuse.Scripting.Object*/]))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[78/*"Route param...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2261, ::STRINGS[77/*"ValidatePar...*/]);
            return false;
        }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[79/*"Route param...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2284, ::STRINGS[77/*"ValidatePar...*/]);
        return false;
    }
...
{
    ::STRINGS[80] = uString::Const("Router not set and none could be found");
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.44.1\\$.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetFields(8,
...
void RouterCancelNavigation__Perform_fn(RouterCancelNavigation* __this, ::g::Fuse::Node* n)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[80/*"Router not ...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 3013, ::STRINGS[2/*"Perform"*/]);
        return;
    }
...
void RouterModify__Perform_fn(RouterModify* __this, ::g::Fuse::Node* n)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[80/*"Router not ...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 3065, ::STRINGS[2/*"Perform"*/]);
        return;
    }
    ...
    if (::g::Uno::String::op_Inequality(__this->Bookmark(), NULL))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[65/*"Unknown boo...*/], __this->Bookmark()), __this, ::STRINGS[1/*"C:\\Users\\...*/], 3075, ::STRINGS[2/*"Perform"*/]);
            return;
        }
    }
...
{
    ::STRINGS[81] = uString::Const("Seek being called on an unrooted navigation");
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.44.1\\$.uno");
    ::STRINGS[82] = uString::Const("Fuse.Navigation.ISeekableNavigation.Seek");
    ::STRINGS[83] = uString::Const("Attempting to navigate to element with different parent");
    ::STRINGS[84] = uString::Const("GotoImpl");
    ::STRINGS[85] = uString::Const("Updated called without a region");
    ::STRINGS[86] = uString::Const("OnUpdated");
    ::STRINGS[87] = uString::Const("Motion should not be changed post-rooting");
    ::STRINGS[88] = uString::Const("set_Motion");
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[81/*"Seek being ...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 3494, ::STRINGS[82/*"Fuse.Naviga...*/]);
        return;
    }
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[83/*"Attempting ...*/], element, ::STRINGS[1/*"C:\\Users\\...*/], 3203, ::STRINGS[84/*"GotoImpl"*/]);
        SetActive(NULL);
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[87/*"Motion shou...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3130, ::STRINGS[88/*"set_Motion"*/]);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[85/*"Updated cal...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3294, ::STRINGS[86/*"OnUpdated"*/]);
        return;
    }
...
{
    VisualNavigation::ActiveIndexName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[89/*"ActiveIndex"*/]);
...
{
    ::STRINGS[89] = uString::Const("ActiveIndex");
    ::STRINGS[32] = uString::Const("goto");
    ::STRINGS[90] = uString::Const("Navigation.goto() : Argument must be a node object");
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.44.1\\$.uno");
    ::STRINGS[91] = uString::Const("gotoNode");
    ::TYPES[22] = ::g::Uno::Type_typeof();
    ::TYPES[23] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[90/*"Navigation....*/], nav, ::STRINGS[1/*"C:\\Users\\...*/], 4301, ::STRINGS[91/*"gotoNode"*/]);
}
// }
...
{
    ::STRINGS[92] = uString::Const("WhileNavigating requires a Navigation context");
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.44.1\\$.uno");
    ::STRINGS[6] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[57] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
...
void WhileNavigating__OnRooted_fn(WhileNavigating* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[92/*"WhileNaviga...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4653, ::STRINGS[6/*"OnRooted"*/]);
        return;
    }
