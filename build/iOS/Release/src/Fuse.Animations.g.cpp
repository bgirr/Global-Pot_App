...
static void Attractor_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Animations\\0.44.1\\$.uno");
...
void Attractor::Motion(::g::Fuse::Motion::DestinationMotion* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"Motion shou...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 201, ::STRINGS[2/*"set_Motion"*/]);
}
...
void MasterBase::Register(::g::Fuse::Animations::MixerHandle* handle)
{
    ...
    if (_inactive)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"Attempt to ...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1615, ::STRINGS[6/*"Register"*/]);
        return;
    }
...
void MasterProperty::GiveOriginSetterWarning()
{
    ...
    {
        _warningGiven = true;
        ::g::Fuse::Diagnostics::UserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[7/*"The property "*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(Property)->Name())), ::STRINGS[8/*" of "*/]), uPtr(Property)->Object()), ::STRINGS[9/*" cannot be ...*/]), this, ::STRINGS[1/*"C:\\Users\\...*/], 1772, ::STRINGS[10/*"GiveOriginS...*/]);
    }
}
// }
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Resize star...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2725, ::STRINGS[13/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Resize star...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2733, ::STRINGS[13/*".ctor"*/]);
        _valid = false;
        return;
    }
