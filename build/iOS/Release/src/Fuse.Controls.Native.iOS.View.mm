...
// public abstract extern class View :3502
// {
static void View_build(uType* type)
{
    ::STRINGS[0] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Native\\0.44.1\\ios\\$.uno");
...
// public virtual void set_Transform(float4x4 value) :3547
...
// public void set_Background(Fuse.Drawing.Brush value) [instance] :3560
void View::Background(::g::Fuse::Drawing::Brush* value)
{
    ...
    if (value != NULL)
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::g::Uno::Object::ToString(this), value, ::STRINGS[0/*"C:\\Users\\...*/], 3573, ::STRINGS[1/*"set_Backgro...*/]);
    }

    View::SetBackground(Handle(), c.X, c.Y, c.Z, c.W);
}

// public void set_ClipToBounds(bool value) [instance] :3535
void View::ClipToBounds(bool value)
{
    View::SetClipToBounds(Handle(), value);
}

// public ObjC.Object get_Handle() [instance] :3504
::g::ObjC::Object* View::Handle()
{
    return _handle;
}

// public void Hide() [instance] :3601
void View::Hide()
{
    View::Hide1(Handle());
}

// public void set_HitTestEnabled(bool value) [instance] :3647
...
// public void set_Opacity(float value) [instance] :3641
void View::Opacity(float value)
{
    View::SetAlpha(Handle(), value);
}

// internal Fuse.Controls.Native.iOS.ViewParent get_Parent() [instance] :3509
::g::Fuse::Controls::Native::iOS::ViewParent* View::Parent()
{
    return _parent;
}

// internal void set_Parent(Fuse.Controls.Native.iOS.ViewParent value) [instance] :3510
...
// public void Show() [instance] :3596
void View::Show()
{
    View::Show1(Handle());
}

// private bool get_UserInteractionEnabled() [instance] :3666
bool View::UserInteractionEnabled()
{
    return _isEnabled ? _hitTestEnabled : _isEnabled;
}

// public static void Hide(ObjC.Object handle) [static] :3616
...
// private static void SetAlpha(ObjC.Object handle, float a) [static] :3677
...
// public static void SetAnchorPoint(ObjC.Object handle) [static] :3527
...
// private static void SetBackground(ObjC.Object handle, float r, float g, float b, float a) [static] :3734
...
// public static void SetBounds(ObjC.Object handle, float x, float y, float w, float h) [static] :3694
...
// private static void SetClipToBounds(ObjC.Object handle, bool clipToBounds) [static] :3539
...
// private static void SetSize(ObjC.Object handle, float w, float h) [static] :3684
...
// public static void SetTransform(ObjC.Object handle, float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44) [static] :3717
...
// public static void SetTransform(ObjC.Object handle, float4x4 t) [static] :3707
...
// private static void SetUserInteractionEnabled(ObjC.Object handle, bool enabled) [static] :3670
...
// public static void Show(ObjC.Object handle) [static] :3608
