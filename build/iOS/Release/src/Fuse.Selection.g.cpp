...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Selection\0.44.1\$.uno
// ------------------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\0.44.1\\$.uno");
...
static void Selection_build(uType* type)
{
    ...
    ::TYPES[7] = ::g::Fuse::Scripting::IObserver_typeof();
    ...
    type->SetInterfaces(
        ...
        ::TYPES[7/*Fuse.Scripting.IObserver*/], offsetof(Selection_type, interface4));
    type->SetFields(13,
        ...
        ::TYPES[12/*Uno.EventHandler*/], offsetof(::g::Fuse::Selection::Selection, SelectionChanged1), 0,
...
{
    ::g::Fuse::Scripting::IObserver::OnClear(uInterface(uPtr(uAs<uObject*>(__this, ::TYPES[7/*Fuse.Scripting.IObserver*/])), ::TYPES[7/*Fuse.Scripting.IObserver*/]));
    ::g::Fuse::Diagnostics::InternalError(message, __this, ::STRINGS[5/*"C:\\Users\\...*/], 890, ::STRINGS[21/*"Fuse.Script...*/]);
}
...
void Selection__FuseScriptingIObserverOnInsertAt_fn(Selection* __this, int* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 880, ::STRINGS[23/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnNewAt_fn(Selection* __this, int* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 845, ::STRINGS[24/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnRemoveAt_fn(Selection* __this, int* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 869, ::STRINGS[25/*"Fuse.Script...*/]);
        return;
    }
...
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[28/*"MaxCount mu...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 553, ::STRINGS[29/*"set_MaxCount"*/]);
        return;
    }
...
void Selection::remove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[26/*"remove requ...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 360, ::STRINGS[2/*"remove"*/]);
        return;
    }
...
void Selection::toggle(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[27/*"toggle requ...*/], s, ::STRINGS[5/*"C:\\Users\\...*/], 404, ::STRINGS[3/*"toggle"*/]);
        return;
    }
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[30/*"Unable to l...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 954, ::STRINGS[31/*"Perform"*/]);
        return;
    }
