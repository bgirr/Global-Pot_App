...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\0.44.1\\$.uno");
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[3/*"Element"*/], __this->Parent(), __this, ::STRINGS[4/*"C:\\Users\\...*/], 1019, ::STRINGS[5/*"OnRooted"*/]);
        return;
    }
...
{
    ::TYPES[22] = ::g::Fuse::Input::PointerPressedArgs_typeof();
    ::TYPES[2] = ::g::Fuse::Gestures::ClickerEventHandler_typeof();
    ::TYPES[23] = ::g::Fuse::Input::PointerEnteredHandler_typeof();
    ::TYPES[24] = ::g::Fuse::Input::PointerLeftHandler_typeof();
    ::TYPES[5] = ::g::Fuse::Input::PointerPressedHandler_typeof();
    ::TYPES[6] = ::g::Fuse::Input::PointerReleasedHandler_typeof();
...
void WhilePressed__OnRooted_fn(WhilePressed* __this)
{
    ...
    {
        ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Entered()), __this->Parent(), uDelegate::New(::TYPES[23/*Fuse.Input.PointerEnteredHandler*/], (void*)WhilePressed__OnPointerEntered_fn, __this));
        ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Left()), __this->Parent(), uDelegate::New(::TYPES[24/*Fuse.Input.PointerLeftHandler*/], (void*)WhilePressed__OnPointerLeft_fn, __this));
...
void WhilePressed__OnUnrooted_fn(WhilePressed* __this)
{
    ...
    {
        ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Entered()), __this->Parent(), uDelegate::New(::TYPES[23/*Fuse.Input.PointerEnteredHandler*/], (void*)WhilePressed__OnPointerEntered_fn, __this));
        ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Left()), __this->Parent(), uDelegate::New(::TYPES[24/*Fuse.Input.PointerLeftHandler*/], (void*)WhilePressed__OnPointerLeft_fn, __this));
...
{
    ::g::Fuse::Input::PointerPressedArgs* ppa = uAs< ::g::Fuse::Input::PointerPressedArgs*>(a, ::TYPES[22/*Fuse.Input.PointerPressedArgs*/]);
