...
{
    ::STRINGS[4] = uString::Const("GraphicsAppearance");
    ::STRINGS[5] = uString::Const("iOSAppearance");
    ::TYPES[3] = ::g::Fuse::Visual_typeof();
...
void Control__CreateNativeView_fn(Control* __this, uObject** __retval)
{
    if (__this->iOSTemplate() != NULL)
        return *__retval = uAs<uObject*>(uPtr(__this->iOSTemplate())->New1(), ::TYPES[6/*Fuse.Controls.Native.IView*/]), void();
...
// private Uno.UX.Template get_iOSTemplate() :233
...
{
    return FindTemplate(::STRINGS[4/*"GraphicsApp...*/]);
}
...
// private Uno.UX.Template get_iOSTemplate() [instance] :233
::g::Uno::UX::Template* Control::iOSTemplate()
{
    return FindTemplate(::STRINGS[5/*"iOSAppearance"*/]);
}
...
static void Shape_build(uType* type)
{
    ...
    ::TYPES[78] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(8/*ToArray<Fuse.Drawing.Brush>*/, ::TYPES[76/*Fuse.Drawing.Brush*/], NULL);
    ::TYPES[79] = ::TYPES[76/*Fuse.Drawing.Brush*/]->Array();
    ::TYPES[80] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(8/*ToArray<Fuse.Drawing.Stroke>*/, ::TYPES[77/*Fuse.Drawing.Stroke*/], NULL);
...
static void ToggleControl_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Triggers::Actions::IToggleable_typeof(), offsetof(ToggleControl_type, interface14));
    type->SetFields(99,
...
ToggleControl_type* ToggleControl_typeof()
{
    ...
    type->interface14.fp_Toggle = (void(*)(uObject*))ToggleControl__Toggle_fn;
    type->interface8.fp_Show = (void(*)(uObject*))::g::Fuse::Elements::Element__FuseTriggersActionsIShowShow_fn;
    type->interface10.fp_Collapse = (void(*)(uObject*))::g::Fuse::Elements::Element__FuseTriggersActionsICollapseCollapse_fn;
    type->interface9.fp_Hide = (void(*)(uObject*))::g::Fuse::Elements::Element__FuseTriggersActionsIHideHide_fn;
    type->interface12.fp_SetSize = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::Elements::Element__FuseAnimationsIResizeSetSize_fn;
