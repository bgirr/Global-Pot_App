...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\FuseCore\\0.44.1\\$.uno");
...
// private static extern ObjC.Object CreateContext() :2886
...
// private static extern void SetCurrentContext(ObjC.Object context) :2892
...
// private static extern ObjC.Object CreateContext() [static] :2886
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            catch (const uThrowable& __t)
            {
                ...
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[1/*"GraphicsWor...*/], e, a, ::STRINGS[2/*"C:\\Users\\...*/], 2951, ::STRINGS[3/*"Run"*/]);
...
// private static extern void SetCurrentContext(ObjC.Object context) [static] :2892
...
void GraphicsWorker::Start()
{
    ...
    GraphicsWorker::_thread() = ::g::Uno::Threading::Thread::New1(uDelegate::New(::TYPES[5/*Uno.Threading.ThreadStart*/], (void*)GraphicsWorker__Run_fn));
