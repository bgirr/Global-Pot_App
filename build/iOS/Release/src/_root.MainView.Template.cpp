...
{
    MainView__Template::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"LoginPage"*/]);
}
...
{
    ::g::LoginPage* self = ::g::LoginPage::New5(uPtr(__this->__parent1)->MainRouter);
...
{
    ctor_(::STRINGS[0/*"LoginPage"*/], false);
    __parent1 = parent;
