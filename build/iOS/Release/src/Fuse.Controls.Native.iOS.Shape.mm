...
static void Shape_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Native\\0.44.1\\ios\\$.uno");
...
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int layer, ::g::ObjC::Object* path, bool isLine, float strokeWidth)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"C:\\Users\\...*/], 2214, ::STRINGS[2/*"SetBrush"*/]);
