// This file was generated based on C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.WebSockets\0.44.1\ios\jetfire\$.uno.
...
::g::ObjC::Object* WebSocketClient::Create1(uString* url, uArray* protocols, uDelegate* eventHandler, uDelegate* receiveMessageHandler, uDelegate* receiveDataHandler)
{
    @autoreleasepool
    {
        return ::g::ObjC::Object::New1([] (::NSString* url, id<UnoArray> protocols, ::uObjC::Function<void, ::NSString*, ::NSString*> eventHandler, ::uObjC::Function<void, ::NSString*> receiveMessageHandler, ::uObjC::Function<void, id<UnoArray>> receiveDataHandler) -> ::id
        {
        ...
        {
            return [[^ void (::NSString* arg1, ::NSString* arg2)
            {
