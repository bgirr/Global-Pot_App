// This file was generated based on C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\FuseCore\0.44.1\internal\$.uno.
    ...
    @autoreleasepool
    {
        return uCast<uArray*>(([] (::NSString* fileName) -> id<UnoArray>
        {
            NSURL* url = [NSURL fileURLWithPath:fileName];
            			...
            			id<UnoArray> result = [&]() -> id<UnoArray> { ::uForeignPool __foreignPool; return [::StrongUnoArray strongUnoArrayWithUnoArray: uArray::New(::g::ObjC::Object_typeof()->Array(), [descriptors count]) getAt: ^ id (::uArray* arr, int i) { return ::g::ObjC::Object::GetHandle(arr->Strong< ::g::ObjC::Object*>(i)); } setAt: ^ (::uArray* arr, int i, id obj) { arr->Strong< ::g::ObjC::Object*>(i) = ::g::ObjC::Object::New1(obj); }]; }();
            			{
            				int i = 0;
            				for (UIFontDescriptor* descriptor in descriptors)
            				{
            					uCast<uArray*>((result).unoArray, ::g::ObjC::Object_typeof()->Array())->Strong< ::g::ObjC::Object*>(i) = ::g::ObjC::Object::New1(descriptor);
            					++i;
            				}
            			}
    ...
    @autoreleasepool
    {
        return uCast<uArray*>(([] (::id rawDescriptor) -> id<UnoArray>
        {
            UIFontDescriptor* descriptor = (UIFontDescriptor*)rawDescriptor;
            			...
            			id<UnoArray> result = [&]() -> id<UnoArray> { ::uForeignPool __foreignPool; return [::StrongUnoArray strongUnoArrayWithUnoArray: uArray::New(::g::ObjC::Object_typeof()->Array(), count + 1) getAt: ^ id (::uArray* arr, int i) { return ::g::ObjC::Object::GetHandle(arr->Strong< ::g::ObjC::Object*>(i)); } setAt: ^ (::uArray* arr, int i, id obj) { arr->Strong< ::g::ObjC::Object*>(i) = ::g::ObjC::Object::New1(obj); }]; }();
            			// Includes the argument descriptor for convenience
            			uCast<uArray*>((result).unoArray, ::g::ObjC::Object_typeof()->Array())->Strong< ::g::ObjC::Object*>(0) = ::g::ObjC::Object::New1(descriptor);
            			for (int i = 0; i < count; ++i)
            			{
            				...
            				uCast<uArray*>((result).unoArray, ::g::ObjC::Object_typeof()->Array())->Strong< ::g::ObjC::Object*>(i + 1) = ::g::ObjC::Object::New1(uiCascadeDescriptor);
            			}
...
::g::ObjC::Object* iOSSystemFont::GetMatchingFontDescriptor(uString* family, bool isItalic, uString* weight)
{
    ...
    @autoreleasepool
    {
        return ::g::ObjC::Object::New1([] (::NSString* family, bool isItalic, ::NSString* weight) -> ::id
        {
