...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"RecipePage"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("RecipePage");
    type->SetFields(2,
...
{
    ::g::RecipePage* self = ::g::RecipePage::New5(uPtr(__this->__parent1)->MainRouter);
...
{
    ctor_(::STRINGS[0/*"RecipePage"*/], false);
    __parent1 = parent;
