...
// public sealed extern class TextRenderer :747
// {
// static TextRenderer() :747
...
// public TextRenderer(Fuse.Controls.TextControl control) :762
void TextRenderer__ctor__fn(TextRenderer* __this, ::g::Fuse::Controls::TextControl* control)
{
    __this->ctor_(control);
}

// public void Arrange(float2 position, float2 size) :856
void TextRenderer__Arrange_fn(TextRenderer* __this, ::g::Uno::Float2* position, ::g::Uno::Float2* size)
{
    __this->Arrange(*position, *size);
}

// private static Fuse.iOS.Bindings.CGContextRef CGBitmapContextCreate(Uno.IntPtr textureBuffer, int width, int height, Fuse.iOS.Bindings.CGColorSpaceRef colorSpace) :828
...
// private static Fuse.iOS.Bindings.CGColorSpaceRef CGColorSpaceCreateDeviceRGB() :751
...
// private static void CGContextRelease(Fuse.iOS.Bindings.CGContextRef context) :834
void TextRenderer__CGContextRelease_fn(::CGContextRef* context)
{
    TextRenderer::CGContextRelease(*context);
}

// internal static Fuse.Controls.ITextRenderer Create(Fuse.Controls.TextControl control) :753
void TextRenderer__Create_fn(::g::Fuse::Controls::TextControl* control, uObject** __retval)
{
    *__retval = TextRenderer::Create(control);
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) :783
void TextRenderer__Draw_fn(TextRenderer* __this, ::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* where)
{
    __this->Draw(dc, where);
}

// private static void DrawGlyphs(Fuse.iOS.Bindings.CGContextRef context, float x, float y, int width, int height, ObjC.Object layoutManager, ObjC.Object textContainer) :837
...
// public float2 GetContentSize(Fuse.LayoutParams lp) :767
...
// public TextRenderer(Fuse.Controls.TextControl control) [instance] :762
...
// public void Arrange(float2 position, float2 size) [instance] :856
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) [instance] :783
...
// public float2 GetContentSize(Fuse.LayoutParams lp) [instance] :767
...
// public Uno.Rect GetRenderBounds() [instance] :888
...
// public void Invalidate() [instance] :866
...
// private void InvalidateTexture() [instance] :879
...
// public void SoftDispose() [instance] :874
void TextRenderer::SoftDispose()
{
    InvalidateTexture();
}

// private static Fuse.iOS.Bindings.CGContextRef CGBitmapContextCreate(Uno.IntPtr textureBuffer, int width, int height, Fuse.iOS.Bindings.CGColorSpaceRef colorSpace) [static] :828
...
// private static Fuse.iOS.Bindings.CGColorSpaceRef CGColorSpaceCreateDeviceRGB() [static] :751
...
// private static void CGContextRelease(Fuse.iOS.Bindings.CGContextRef context) [static] :834
...
// internal static Fuse.Controls.ITextRenderer Create(Fuse.Controls.TextControl control) [static] :753
...
// private static void DrawGlyphs(Fuse.iOS.Bindings.CGContextRef context, float x, float y, int width, int height, ObjC.Object layoutManager, ObjC.Object textContainer) [static] :837
...
// public TextRenderer New(Fuse.Controls.TextControl control) [static] :762
