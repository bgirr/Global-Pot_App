...
// protected override sealed void DisableTicks() :160
...
// protected override sealed void EnableTicks() :135
        ...
        [] (id<UnoObject> _this) -> void
        {
            CADisplayLink* displayLink = [&]() -> ::id { ::uForeignPool __foreignPool; return ::g::ObjC::Object::GetHandle(uCast<iOSDisplay*>((_this).unoObject, iOSDisplay_typeof())->_displayLink); }();
                        ...
                        if (!displayLink)
                        {
                            ...
                            uCast<iOSDisplay*>((_this).unoObject, iOSDisplay_typeof())->_displayLink = ::g::ObjC::Object::New1(displayLink);
...
// private static double GetDensityOfScreen(ObjC.Object screen) :88
void iOSDisplay__GetDensityOfScreen_fn(::g::ObjC::Object* screen, double* __retval)
{
    *__retval = iOSDisplay::GetDensityOfScreen(screen);
}

// private static double GetDensityOfScreenFromWindow(ObjC.Object window) :80
...
// protected override sealed void SetTicksPerSecond(uint fps) :99
...
// internal static Uno.Platform.Display WrapMainDisplay() :69
...
// private static double GetDensityOfScreen(ObjC.Object screen) [static] :88
...
// private static double GetDensityOfScreenFromWindow(ObjC.Object window) [static] :80
    ...
    @autoreleasepool
    {
        return [] (::id window) -> double
        {
            UIWindow* _window = (UIWindow*)window;
                        ...
                        return [&]() -> double { ::uForeignPool __foreignPool; return iOSDisplay::GetDensityOfScreen(::g::ObjC::Object::New1(screen)); }();
...
// internal static Uno.Platform.Display WrapMainDisplay() [static] :69
    ...
    @autoreleasepool
    {
        return uCast<::g::Uno::Platform::Display*>(([] () -> id<UnoObject>
        {
            CGRect screenBounds = [UIScreen mainScreen].bounds;
                        ...
                        return [&]() -> id<UnoObject> { ::uForeignPool __foreignPool; return [::StrongUnoObject strongUnoObjectWithUnoObject: iOSDisplay::New1(::g::ObjC::Object::New1(window))]; }();
