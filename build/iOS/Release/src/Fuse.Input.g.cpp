...
static void FocusPrediction_build(uType* type)
{
    ...
    ::TYPES[9] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(3/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
...
static void Pointer_build(uType* type)
{
    ...
    ::TYPES[21] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1/*First<Fuse.Input.Capturer>*/, ::g::Fuse::Input::Capturer_typeof(), NULL);
