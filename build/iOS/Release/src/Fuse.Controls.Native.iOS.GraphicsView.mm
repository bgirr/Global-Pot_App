...
void GraphicsView::OnTouch(::g::ObjC::Object* sender, ::g::ObjC::Object* uiEvent)
{
    if (_visual != NULL)
...
::g::ObjC::Object* GraphicsView::Create()
{
    @autoreleasepool
    {
...
void GraphicsView::SetCallback(::g::ObjC::Object* handle, uDelegate* callback)
{
    @autoreleasepool
    {
        ...
        } (::g::ObjC::Object::GetHandle(handle), [] (id<UnoObject> __delegateRef) -> ::uObjC::Function<void, ::id, ::id>
        {
            return [[^ void (::id arg1, ::id arg2)
            {
                ::uForeignPool __foreignPool;
                uDelegate* __unoDelegate = (uDelegate*)__delegateRef.unoObject;
                __unoDelegate->Invoke(2, ::g::ObjC::Object::New1(arg1), ::g::ObjC::Object::New1(arg2));
