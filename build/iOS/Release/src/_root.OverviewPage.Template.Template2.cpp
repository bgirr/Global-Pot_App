...
static void OverviewPage__Template__Template2__cctor__fn(uType* __type)
{
    ...
    OverviewPage__Template__Template2::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"__gen6"*/]);
}
...
static void OverviewPage__Template__Template2_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("__gen6");
    ...
    type->SetFields(2,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::OverviewPage__Template__Template2, __gen7_Right_inst1), 0,
...
void OverviewPage__Template__Template2__New1_fn(OverviewPage__Template__Template2* __this, uObject** __retval)
{
    ...
    ::g::Uno::UX::StringConcatOperator* __gen71 = ::g::Uno::UX::StringConcatOperator::New2();
    __this->__gen7_Right_inst1 = ::g::GlobalPot_UnoUXStringConcatOperator_Right_Property::New1(__gen71, OverviewPage__Template__Template2::__selector1());
    ...
    ::g::Fuse::Reactive::DataBinding* temp3 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[0/*Fuse.Reactive.DataBinding<string>*/], __this->__gen7_Right_inst1, ::STRINGS[3/*"imageUrl"*/]);
    ...
    temp2->Width(1.0f);
    __gen71->Left(::STRINGS[4/*"http://cook...*/]);
    __gen71->Target(__this->self_Url_inst);
