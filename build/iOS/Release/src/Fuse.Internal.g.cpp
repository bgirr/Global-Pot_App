...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\FuseCore\0.44.1\internal\$.uno
// ---------------------------------------------------------------------------------------
...
// internal static class DrawManager :1253
// {
...
// public static void EndDraw(Fuse.DrawContext dc) :1266
void DrawManager__EndDraw_fn(::g::Fuse::DrawContext* dc)
{
    DrawManager::EndDraw(dc);
}

// public static generated void add_Prepared(Uno.Action<Fuse.DrawContext> value) :1255
void DrawManager__add_Prepared_fn(uDelegate* value)
{
    DrawManager::add_Prepared(value);
}

// public static generated void remove_Prepared(Uno.Action<Fuse.DrawContext> value) :1255
void DrawManager__remove_Prepared_fn(uDelegate* value)
{
    DrawManager::remove_Prepared(value);
}

// public static void PrepareDraw(Fuse.DrawContext dc) :1257
...
// public static void EndDraw(Fuse.DrawContext dc) [static] :1266
void DrawManager::EndDraw(::g::Fuse::DrawContext* dc)
{
    uPtr(dc)->ReleaseRootbuffer();
}

// public static void PrepareDraw(Fuse.DrawContext dc) [static] :1257
...
// public static generated void add_Prepared(Uno.Action<Fuse.DrawContext> value) [static] :1255
...
// public static generated void remove_Prepared(Uno.Action<Fuse.DrawContext> value) [static] :1255
...
static void MiniList__Enumerator_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[5/*Fuse.Internal.MiniList`1*/]->MakeType(type->T(1), NULL), offsetof(::g::Fuse::Internal::MiniList__Enumerator, _source), 0,
...
{
    ::TYPES[6] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[7] = ::g::Uno::String_typeof()->Array();
    ::TYPES[8] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*SequenceEqual<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::Int_typeof();
    ::TYPES[10] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[11] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[12] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[13] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(0/*All<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[14] = ::g::Uno::Predicate_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::UX::FileSource_typeof(), offsetof(::g::Fuse::Internal::FontFaceDescriptor, FileSource), 0,
        ::TYPES[9/*int*/], offsetof(::g::Fuse::Internal::FontFaceDescriptor, Index), 0,
        ::TYPES[10/*Uno.Collections.IEnumerable<string>*/], offsetof(::g::Fuse::Internal::FontFaceDescriptor, Styles), 0);
}
...
void FontFaceDescriptor__Equals_fn(FontFaceDescriptor* __this, uObject* o, bool* __retval)
{
    ...
    return *__retval = (((f != NULL) && ::g::Uno::String::op_Equality(uPtr(__this->FileSource)->Name, uPtr(uPtr(f)->FileSource)->Name)) && (__this->Index == uPtr(f)->Index)) && ::g::Uno::Collections::EnumerableExtensions::SequenceEqual(::TYPES[8/*Uno.Collections.EnumerableExtensions.SequenceEqual<string>*/], __this->Styles, uPtr(f)->Styles), void();
}
...
void FontFaceDescriptor__GetHashCode_fn(FontFaceDescriptor* __this, int* __retval)
{
    ...
    hash = (hash * 23) + ::g::Uno::Int::GetHashCode((ind1 = __this->Index, ind1), ::TYPES[9/*int*/]);

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Styles), ::TYPES[10/*Uno.Collections.IEnumerable<string>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[11/*Uno.Collections.IEnumerator*/])); )
    {
        uString* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[12/*Uno.Collections.IEnumerator<string>*/]), &ret5), ret5);
...
void FontFaceDescriptor::ctor_(::g::Uno::UX::FileSource* fileSource, int index)
{
    ...
    Index = index;
    Styles = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[6/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], uArray::New(::TYPES[7/*string[]*/], 0)));
}
...
{
    return ::g::Uno::Collections::EnumerableExtensions::All(::TYPES[13/*Uno.Collections.EnumerableExtensions.All<string>*/], Styles, uDelegate::New(::TYPES[14/*Uno.Predicate<string>*/], (void*)::g::Uno::String__Contains_fn, uPtr(styleString)));
}
...
// C:\Users\EliteBook-User\AppData\Local\Fusetools\Packages\Fuse.Elements\0.44.1\internal\$.uno
// --------------------------------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\EliteBook-User\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\0.44.1\\internal\\$.uno");
    ::STRINGS[3] = uString::Const("set_ResampleMode");
    ::TYPES[11] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[15] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ::TYPES[16] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ::TYPES[17] = ::g::Fuse::Internal::IImageContainerOwner_typeof();
    ...
    ::TYPES[25] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ::TYPES[26] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::Float_typeof(), offsetof(::g::Fuse::Internal::ImageContainer, _density), 0,
        ::TYPES[26/*Uno.Collections.ObservableList<Uno.UX.FileSource>*/], offsetof(::g::Fuse::Internal::ImageContainer, _files), 0,
        ...
        ::TYPES[17/*Fuse.Internal.IImageContainerOwner*/], offsetof(::g::Fuse::Internal::ImageContainer, _owner), uFieldFlagsWeak,
...
void ImageContainer::CreateMultiDensitySource()
{
    ...
    for (uObject* enum5 = (uObject*)uPtr(_files)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum5), ::TYPES[11/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::UX::FileSource* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::TYPES[15/*Uno.Collections.IEnumerator<Uno.UX.FileSource>*/]), &ret16), ret16);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(s)->Sources()), ::TYPES[16/*Uno.Collections.ICollection<Fuse.Resources.ImageSource>*/]), (collection6 = ::g::Fuse::Resources::FileImageSource::New3(f), ind11 = Density(), uPtr(collection6)->Density(ind11), ind11, ind12 = MemoryPolicy(), uPtr(collection6)->DefaultPolicy(ind12), ind12, collection6));
    }
...
void ImageContainer::File(::g::Uno::UX::FileSource* value)
{
    ...
    {
        _files = NULL;
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Files()), ::TYPES[25/*Uno.Collections.ICollection<Uno.UX.FileSource>*/]), value);
    }
}
...
{
    if (_files == NULL)
        _files = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[26/*Uno.Collections.ObservableList<Uno.UX.FileSource>*/], uDelegate::New(::TYPES[27/*Uno.Action<Uno.UX.FileSource>*/], (void*)ImageContainer__OnFileAdded_fn, this), uDelegate::New(::TYPES[27/*Uno.Action<Uno.UX.FileSource>*/], (void*)ImageContainer__OnFileRemoved_fn, this)));
...
void ImageContainer::OnParamChanged()
{
    ...
    if (_owner != NULL)
        ::g::Fuse::Internal::IImageContainerOwner::OnParamChanged(uInterface(uPtr(_owner), ::TYPES[17/*Fuse.Internal.IImageContainerOwner*/]));
}
...
void ImageContainer::OnSizingChanged()
{
    ...
    if (_owner != NULL)
        ::g::Fuse::Internal::IImageContainerOwner::OnSizingChanged(uInterface(uPtr(_owner), ::TYPES[17/*Fuse.Internal.IImageContainerOwner*/]));
}
...
void ImageContainer::OnSourceChanged(uObject* s, uObject* a)
{
    ...
    if (_owner != NULL)
        ::g::Fuse::Internal::IImageContainerOwner::OnSourceChanged(uInterface(uPtr(_owner), ::TYPES[17/*Fuse.Internal.IImageContainerOwner*/]));
}
...
void ImageContainer::ReapplyOptions(::g::Fuse::Resources::ImageSource* src)
{
    ...
    ::g::Fuse::Resources::MultiDensityImageSource* mf = uAs< ::g::Fuse::Resources::MultiDensityImageSource*>(Source(), ::TYPES[20/*Fuse.Resources.MultiDensityImageSource*/]);

    if (mf != NULL)

        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(mf)->Sources()), ::TYPES[21/*Uno.Collections.IEnumerable<Fuse.Resources.ImageSource>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[11/*Uno.Collections.IEnumerator*/])); )
        {
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[1/*"ResampleMod...*/], this, ::STRINGS[2/*"C:\\Users\\...*/], 255, ::STRINGS[3/*"set_Resampl...*/]);
...
{
    ::g::Fuse::Resources::HttpImageSource* http = uAs< ::g::Fuse::Resources::HttpImageSource*>(Source(), ::TYPES[19/*Fuse.Resources.HttpImageSource*/]);
...
static void MiniList_build(uType* type)
{
    ...
    ::TYPES[28] = ::g::Uno::Collections::List_typeof();
    ::TYPES[29] = MiniList__Enumerator_typeof();
    type->SetPrecalc(
...
// internal sealed class SizingContainer :356
// {
...
// public generated SizingContainer() :356
void SizingContainer__ctor__fn(SizingContainer* __this)
{
    __this->ctor_();
}

// public float4 CalcClip(float2 availableSize, float2& origin, float2& contentActualSize) :580
...
// public float2 CalcContentSize(float2 size, int2 pixelSize) :408
...
// public float2 CalcOrigin(float2 availableSize, float2 contentActualSize) :538
...
// public float2 CalcScale(float2 availableSize, float2 desiredSize) :403
...
// private float2 CalcScale(float2 availableSize, float2 desiredSize, bool autoWidth, bool autoHeight) :454
...
// public float2 ExpandFillSize(float2 size, Fuse.LayoutParams lp) :625
...
// public generated SizingContainer() [instance] :356
...
// public float4 CalcClip(float2 availableSize, float2& origin, float2& contentActualSize) [instance] :580
...
// public float2 CalcContentSize(float2 size, int2 pixelSize) [instance] :408
...
// public float2 CalcOrigin(float2 availableSize, float2 contentActualSize) [instance] :538
...
// public float2 CalcScale(float2 availableSize, float2 desiredSize) [instance] :403
...
// private float2 CalcScale(float2 availableSize, float2 desiredSize, bool autoWidth, bool autoHeight) [instance] :454
...
// public float2 ExpandFillSize(float2 size, Fuse.LayoutParams lp) [instance] :625
...
// private float get_PaddingHeight() [instance] :401
float SizingContainer::PaddingHeight()
{
    return padding.Item(1) + padding.Item(3);
}

// private float get_PaddingWidth() [instance] :400
float SizingContainer::PaddingWidth()
{
    return padding.Item(0) + padding.Item(2);
}

// public bool SetAlignment(Fuse.Elements.Alignment a) [instance] :379
...
// public bool SetStretchDirection(Fuse.Elements.StretchDirection dir) [instance] :371
...
// public bool SetStretchMode(Fuse.Elements.StretchMode mode) [instance] :363
...
// public bool SetStretchSizing(Fuse.Elements.StretchSizing ss) [instance] :387
...
// private float2 SnapSize(float2 sz) [instance] :449
...
// public generated SizingContainer New() [static] :356
